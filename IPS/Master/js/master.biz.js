    ...
    ready: function () {
        ...
        function successSession(data) {
            ...
            var args = {
                request: "PAGE",
                url: "../Service/svc_Data_Retrieve_JSONs.aspx" +
                        "?QRY_ID=" + (v_Session.USER_TP == "SUPP" ? "w_srm_notice" : "w_plm_notice") +
        ...
        //----------
        function click_btn2ndSRM() {

            //----------
            var url = "http://srm.wonikholdings.kr/SRM.aspx?user_id=" + v_Session.USR_ID;
    ...
    buildTab: function (argTab) {
        ...
        $(argTab).tabs({
            show: function (event, ui) {
                ...
                //    input: [
                //        { name: "obj_id", value: "", type: "nvarchar" },
                //        { name: "obj_title", value: "", type: "nvarchar" },
                //        { name: "pobj_id", value: "", type: "nvarchar" },
