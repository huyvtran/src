...
<asp:Content ID="objManagerHead" ContentPlaceHolderID="objMasterHead" runat="Server">
    <script src="js/intro.srm.js" type="text/javascript"></script>
            ...
            <div class="rowElem">
                <table border="0" width="100%" style="margin: 0;">
                    <tr>
                        ...
                        <td width="170px">
                            <input type="text" id="frmAuth_login_id" name="login_id" size="15" maxlength="10"
                        ...
                        <td width="150px">
                            <input type="password" id="frmAuth_login_pw" name="login_pw" size="15" maxlength="10"
                                title="패스워드" value="" />
                        </td>
                    </tr>
                    <tr style="height: 45px;">
                        ...
                        <td width="170px" align="left" valign="middle" style="padding-top: 10px; font-family: verdana;
                            font-weight: bold;">
