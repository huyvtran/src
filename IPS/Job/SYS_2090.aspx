<%@ Page Title="" Language="C#" MasterPageFile="~/Master/Page_7.master" AutoEventWireup="true"
    CodeFile="SYS_2090.aspx.cs" Inherits="JOB_SYS_2090" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="objContentHead" runat="Server">
    ...
    <script src="js/SYS.2090.js" type="text/javascript"></script>
                ...
                <form id="frmServer" runat="server">
                    <div id="lyrControl" style="margin-left:2px;margin-right:4px">
                        <dx:ASPxHtmlEditor ID="ASPxctlHTML" runat="server" Width="100%" ClientInstanceName="ctlHTML"
                            ClientVisible="False" Height="450px" EnableTheming="True" Font-Names="굴림체" 
                            Font-Size="9pt">
                            ...
                            <SettingsImageUpload UploadImageFolder="~/Files/EMAIL_TEMP/Image">
