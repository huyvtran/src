<%@ Page Language="C#" MasterPageFile="~/Master/Page_7.master" AutoEventWireup="true"
    CodeFile="DLG_ExcelImport.aspx.cs" Inherits="Job_DLG_ExcelImport" Title="" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="objContentHead" runat="Server">
    ...
    <script src="js/DLG.ExcelImport.js" type="text/javascript"></script>
...
<asp:Content ID="Content6" ContentPlaceHolderID="objContentData" runat="Server">
    ...
    <div style="margin-top: 4px; margin-left: 10px; margin-bottom: 10px; text-decoration: underline;">
        * 확장자가 XLS (엑셀 2007 이전 버전)인 파일만 가능합니다.
    </div>
    <div id="grdData_List">
    </div>
</asp:Content>
