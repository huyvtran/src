<%@ Page Title="" Language="C#" MasterPageFile="~/Master/Control_10.master" AutoEventWireup="true"
    CodeFile="ECCB_5010.aspx.cs" Inherits="JOB_ECCB_5010" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="objContentHead" runat="Server">
    ...
    <script src="js/ECCB.5010.js" type="text/javascript"></script>
...
<asp:Content ID="Content6" ContentPlaceHolderID="objContentControl" runat="Server">
    <div id="lyrChart_현황" align="center">
        <dxchartsui:WebChartControl ID="ctlChart_1" runat="server" Height="300px" Width="1100px"
