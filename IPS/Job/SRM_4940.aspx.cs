        ...
        try
        {
            ...
            try
            {
                ...
                else
                {
                    ...
                    dsBarcode.Tables["dt_barcode"].Load(objDr);
                    objDr.Close();

                    ReportViewer rptBarcode = new ReportViewer();
                    rptBarcode.LocalReport.ReportPath = HttpContext.Current.Server.MapPath("rpt_barcode.rdlc");
                    //ReportViewer1.LocalReport.ReportPath = HttpContext.Current.Server.MapPath("Report.rdlc");

                    ReportDataSource rds = new ReportDataSource();
                    rds.Name = "DataSet1";
                    rds.Value = dsBarcode.Tables["dt_barcode"];
