        ...
        <tr>
            <td>
                <div id="lyrChart_불량통계_1">
                    <dxchartsui:WebChartControl ID="ctlChart_1" runat="server" Height="240px" Width="600px"
                        ...
                        ClientVisible="False" SeriesDataMember="series" SeriesSorting="Ascending">
                        <diagramserializable>
                <cc1:XYDiagram>
                    ...
                    <axisy visibleinpanesserializable="-1">
                        ...
                        <seriestemplate argumentdatamember="category" synchronizepointoptions="False" valuedatamembersserializable="value">
                <ViewSerializable>
                ...
                <cc1:SideBySideBarSeriesLabel LineVisible="True" Font="Tahoma, 8.25pt"><fillstyle><optionsserializable><cc1:SolidFillOptions />
                    </optionsserializable>
                    </fillstyle>
            ...
            <td>
                ...
                <cc1:Series ArgumentDataMember="category" Name="Series 1" 
                    ...
                    <labelserializable>
                        <cc1:Pie3DSeriesLabel Font="Tahoma, 8.25pt" LineVisible="True">
                            <fillstyle>
                                <optionsserializable>
