<%@ Page Language="C#" MasterPageFile="~/Master/Page_7.master" AutoEventWireup="true"
    CodeFile="w_upload_spcncr.aspx.cs" Inherits="Job_w_upload_spcncr" Title="" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="objContentHead" runat="Server">
    ...
    <script src="js/w.upload.spcncr.js" type="text/javascript"></script>
...
<asp:Content ID="Content6" ContentPlaceHolderID="objContentData" runat="Server">
    ...
    <div id="lyrServer" class="form_3">
        <dx:ASPxUploadControl ID="ctlUpload" runat="server" ClientInstanceName="ctlUpload"
            ...
            <ValidationSettings FileDoesNotExistErrorText="파일이 존재하지 않습니다." GeneralErrorText="파일 업로드 중에 에러가 발생하였습니다."
                MaxFileSize="153600000" MaxFileSizeErrorText="파일 크기는 150M Byte를 넘을 수 없습니다." 
    ...
    <div style="margin-top: 10px; margin-left: 10px;">
        * 파일 크기는 150M Byte를 넘을 수 없습니다.<br />
        &nbsp;&nbsp;(150M Byte를 넘을 경우 장시간 로딩 후 에러가 발생할 수 있으니 꼭 확인하시기 바랍니다.)
    </div>
</asp:Content>
