...
public partial class Job_w_hcem1050 : System.Web.UI.Page
{
                        ...
                        if (iKey == 0)
                        {
                            try
                            {
                                objUpdate.objDr = (new cDBQuery(
                                                        ruleQuery.INLINE,
                                                        "SELECT CAST(ISNULL(MAX(item_seq), 0) + 1 AS varchar) FROM EM_MODEL_ITEM" +
                                                        " WHERE cust_cd = '" + DATA.getValue(iAry, iRow, "cust_cd") + "'" +
                                                        " AND model_class1 = '" + DATA.getValue(iAry, iRow, "model_class1") + "'" +
                                                        " AND model_class2 = '" + DATA.getValue(iAry, iRow, "model_class2") + "'" +
                                                        " AND model_class3 = '" + DATA.getValue(iAry, iRow, "model_class3") + "'" +
