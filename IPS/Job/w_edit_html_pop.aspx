<%@ Page Language="C#" MasterPageFile="~/Master/Page_7.master" AutoEventWireup="true"
    CodeFile="w_edit_html_pop.aspx.cs" Inherits="Job_w_edit_html_pop" Title="" %>
...
<asp:Content ID="Content6" ContentPlaceHolderID="objContentData" runat="Server">
    ...
    <div id="lyrControl">
        <dx:ASPxHtmlEditor ID="ASPxctlHTML" runat="server" Width="100%" ClientInstanceName="ctlHTML"
            ClientVisible="False" Height="440px" EnableTheming="True" Font-Names="굴림체" 
            Font-Size="9pt">

<ClientSideEvents HtmlChanged="gw_com_DX.event_htmlchanged"></ClientSideEvents>

            <SettingsHtmlEditing AllowScripts="True" EnterMode="BR" />

            <ClientSideEvents HtmlChanged="gw_com_DX.event_htmlchanged" />
            <stylesbutton enabledefaultappearance="False">
            </stylesbutton>
...
<SettingsHtmlEditing AllowScripts="True" EnterMode="BR"></SettingsHtmlEditing>
            ...
            <SettingsImageUpload UploadImageFolder="~/Files/POP/Image">
