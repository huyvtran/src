<%@ Page Title="" Language="C#" MasterPageFile="~/Master/Page_9b.master" AutoEventWireup="true"
    CodeFile="SPC_1012.aspx.cs" Inherits="JOB_SPC_1012" %>

<asp:Content ID="Content1" ContentPlaceHolderID="objContentHead" runat="Server">
    <link id="style_theme" href="" rel="stylesheet" type="text/css" />
    <script src="js/SPC.1012.js" type="text/javascript"></script>
...
<asp:Content ID="Content5" ContentPlaceHolderID="objContentData_3" runat="Server">
