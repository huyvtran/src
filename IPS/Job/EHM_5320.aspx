<%@ Page Title="" Language="C#" MasterPageFile="~/Master/Control_12.master" AutoEventWireup="true"
    CodeFile="EHM_5320.aspx.cs" Inherits="JOB_EHM_5320" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="objContentHead" runat="Server">
    ...
    <script src="js/EHM.5320.js" type="text/javascript"></script>
        ...
        <dxchartsui:WebChartControl ID="ctlChart_1" runat="server" Height="250px" Width="340px"
            ...
            <seriesserializable>
                <cc1:Series ArgumentDataMember="category" Name="Series 1" 
                    ValueDataMembersSerializable="rate" SynchronizePointOptions="False">
                </cc1:Series>
            </seriesserializable>
...
<asp:Content ID="Content11" ContentPlaceHolderID="objContentControl_3" runat="Server">
    <div id="lyrChart_분류3">
        <dxchartsui:WebChartControl ID="ctlChart_3" runat="server" Height="250px" Width="340px"
...
<asp:Content ID="Content12" ContentPlaceHolderID="objContentControl_4" runat="Server">
    <div id="lyrChart_분류4">
        <dxchartsui:WebChartControl ID="ctlChart_4" runat="server" Height="250px" Width="340px"
