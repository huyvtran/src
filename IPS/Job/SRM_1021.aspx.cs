...
public partial class Job_SRM_1021 : System.Web.UI.Page
{
            ...
            try
            {
                ...
                foreach (string strQmiKey in DATA.getOption("QMI_KEY").Split(','))
                {
                    ...
                    while (objDr.Read())
                    {
                        ...
                        objWorkSheet.Cells[6, 16] = Convert.ToDecimal(objDr["pur_price"]);                                                          // 구입가격
                    ...
                    while (objDr.Read())
                    {
                        ...
                        objWorkSheet.Cells[iRow, 15] = objDr["chk_date"].ToString();        // 유효기간
