                    ...
                    { 
                      element: [
                        ...
                        { name: "supp_cd", label: { title: "협력사 :" },
                            editable: { type: "select", size: 7, maxlength: 20
                            	, data: { memory: "협력사", unshift: [{ title: "전체", value: ""}] } }
                        }
				      ] 
				    },
                    { 
...
//                            	, data: { memory: "QCITEM_SUPP", unshift: [ { title: "전체", value: "" } ] } }
        ...
        //==== Grid : Main ====
        var args = { targetid: "grdData_메뉴", query: "SPC_2020_M_1", title: "검사 내역",
...
//                    },
                    ...
                    { element: [
                            ...
                            { name: "supp_cd"
                            , editable: { type: "select", validate: { rule: "required", message: "협력사" }
                                , data: { memory: "협력사" }
...
//        gw_com_module.eventBind(args);
        ...
        gw_com_module.eventBind(args);
        //----------
        var args = { targetid: "grdData_권한", grid: true, event: "itemchanged", handler: itemchanged_grdData_권한 };
        gw_com_module.eventBind(args);
        //----------
        function itemchanged_grdData_권한(ui) {
...
//	    gw_com_api.setValue("frmData_상세", 1, "supp_cd", "", false);
