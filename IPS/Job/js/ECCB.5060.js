...
var gw_job_process = {
    ...
    UI: function () {
        ...
        //=====================================================================================
        var args = { targetid: "grdData_분류1", query: "ECCB_5020_M_1", title: "적용 모델별",
        ...
        //=====================================================================================
        var args = { targetid: "grdData_분류2", query: "ECCB_5020_S_1", title: "적용 영역별",
            caption: true, width: 325, height: 299, pager: true, show: true,
            group: [ { element: "grouptext", show: false, summary: false } ],
            element: [
				{ header: "상세분류", name: "category", width: 175, align: "center" },
        ...
        gw_com_module.gridCreate(args);
        //=====================================================================================
        var args = { targetid: "grdData_분류3", query: "ECCB_5020_S_2", title: "적용 모듈별",
            caption: true, width: 325, height: 299, pager: true, show: true,
            group: [ { element: "grouptext", show: false, summary: false } ],
            element: [
				{ header: "상세분류", name: "category", width: 175, align: "center" },
        ...
        gw_com_module.gridCreate(args);
        //=====================================================================================
        var args = { targetid: "grdData_분류4", query: "ECCB_5020_S_3", title: "MP 분류별",
            caption: true, width: 325, height: 299, pager: true, show: true,
            group: [ { element: "grouptext", show: false, summary: false } ],
            element: [
				{ header: "상세분류", name: "category", width: 175, align: "center" },
        ...
        gw_com_module.gridCreate(args);
        //=====================================================================================
        var args = { targetid: "lyrChart_분류1", query: "ECCB_5020_M_1",
            show: true,
            format: {
        ...
        //=====================================================================================
        var args = { targetid: "lyrChart_분류2", query: "ECCB_5020_S_1",
            show: true,
            format: {
        ...
        gw_com_module.chartCreate(args);
        //=====================================================================================
        var args = { targetid: "lyrChart_분류3", query: "ECCB_5020_S_2",
            show: true,
    ...
    procedure: function () {
            ...
            var args = {
                ...
                data: {
                    ...
                    param: [
                        ...
                        { name: "prod_type", value: gw_com_api.getValue("grdData_분류1", "selected", "rcode", true) }
                    ]
                }
            };
        ...
        function rowdblclick_grdData_분류2(ui) {
            ...
            var args = {
                ID: gw_com_api.v_Stream.msg_linkPage,
                to: { type: "MAIN" },
                data: { page: "ECCB_2030", title: "ECR 내역",
                    param: [
                        { name: "ymd_fr", value: gw_com_api.getValue("grdData_분류1", "selected", "ymd_fr", true) },
                        { name: "ymd_to", value: gw_com_api.getValue("grdData_분류1", "selected", "ymd_to", true) },
                        { name: "dept_area", value: gw_com_api.getValue("grdData_분류1", "selected", "dept_area", true) },
                        { name: "prod_type", value: gw_com_api.getValue("grdData_분류1", "selected", "rcode", true) },
                        { name: "act_region", value: gw_com_api.getValue("grdData_분류2", "selected", "rcode", true) }
                    ]
                }
            };
            gw_com_module.streamInterface(args);
            ...
            var args = {
                ...
                data: { page: "ECCB_2030", title: "ECR 내역",
                    param: [
                        ...
                        { name: "prod_type", value: gw_com_api.getValue("grdData_분류1", "selected", "rcode", true) },
                        { name: "act_region", value: gw_com_api.getValue("grdData_분류2", "selected", "rcode", true) },
                        { name: "act_module", value: gw_com_api.getValue("grdData_분류3", "selected", "rcode", true) }
                    ]
                }
            };
            gw_com_module.streamInterface(args);
            ...
            var args = {
                ...
                data: { page: "ECCB_2030", title: "ECR 내역",
                    param: [
                        ...
                        { name: "act_region", value: gw_com_api.getValue("grdData_분류2", "selected", "rcode", true) },
                        { name: "act_module", value: gw_com_api.getValue("grdData_분류3", "selected", "rcode", true) },
                        { name: "mp_class", value: gw_com_api.getValue("grdData_분류4", "selected", "rcode", true) }
                    ]
                }
            };
            gw_com_module.streamInterface(args);
