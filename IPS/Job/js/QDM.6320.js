...
var gw_job_process = {
    ...
    procedure: function () {
        ...
        gw_com_module.eventBind(args);
        function click_lyrMenu_Main_반려(ui) { processSend2(ui); }
        //----------
                ...
                row: [
	                ...
	                },
	                {
	                    element: [
	                        ...
	                        { name: "act_dt", mask: "date-ymd", editable: { type: "hidden", width: 500 } },
