    ...
    ready: function () {
        ...
        var args = {
            request: [
				...
				{ type: "PAGE", name: "조치분류", query: "DDDW_CM_CODED_A",
				    param: [ { argument: "arg_hcode", value: "IEHM24" } ]
				},
				{ type: "PAGE", name: "조치구분", query: "DDDW_CM_CODED_A",
    ...
    UI: function () {
        ...
        var args = { targetid: "frmOption", type: "FREE", title: "조회 조건",
            ...
            content: { row: [
                    ...
                    {
                        element: [
				            { name: "work_tp1", label: { title: "조치분류 :" },
				                editable: { type: "select",
				                    data: { memory: "조치분류", unshift: [ { title: "전체", value: "%" } ] },
				                    change: [{ name: "work_tp2", memory: "조치구분", key: ["work_tp1"]}]
				                }
				            },
				            { name: "work_tp2", label: { title: "조치구분 :" },
				                editable: { type: "select",
				                    data: { memory: "조치구분", unshift: [ { title: "전체", value: "%" } ], key: [ "work_tp1" ] }
				                }
				            },
				            { name: "rmk_text", label: { title: "조치내용 :" },
        ...
        //=====================================================================================
        var args = { targetid: "grdData_현황", query: "EHM_2034_M_1", title: "문제 조치 내역",
    ...
    var args = {
        source: { type: "FORM", id: "frmOption", hide: true,
            element: [
				...
				{ name: "work_tp1", argument: "arg_work_tp1" },
				{ name: "work_tp2", argument: "arg_work_tp2" },
