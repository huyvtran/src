...
var gw_job_process = {
    ...
    UI: function () {
                    ...
                    },
                    {
                        element: [
				            ...
				            },
				            {
				                ...
				                editable: { type: "text", size: 18, maxlength: 20 }
				            },
                        ]
                    },
                    {
        ...
        var args = {
            ...
            height: 250, show: true, selectable: true, dynamic: true,
            element: [
                ...
                { header: "Project No.", name: "projkey", width: 80, align: "center" },
   				...
   				{ header: "출력일시", name: "print_dt", width: 160, align: "center", mask: "date-ymd" },
        ...
        var args = {
            ...
            height: 160, pager: false, show: true, selectable: true,
            editable: { multi: true, bind: "select", focus: "req_date", validate: true },
            element: [
   				{ header: "품목코드", name: "item_cd", width: 80, align: "center", mask: "search" },
