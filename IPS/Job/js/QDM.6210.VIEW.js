...
var gw_job_process = {
    ...
    UI: function () {
                ...
                row: [
                        ...
                        },
                        {
                            element: [
                                ...
                                {
                                    name: "astat1", label: { title: "접수구분 :" }, //value: "발생",
                                    editable: {
                                        type: "select", size: 7, maxlength: 20,
                                ...
                                {
                                    name: "astat2", label: { title: "발행구분 :" }, //value: "미발행",
                                    editable: {
                                        type: "select", size: 7, maxlength: 20,
        ...
        //==== Main Grid : 발생 내역
        var args = { targetid: "grdData_현황", query: "QDM_6210_M_2", title: "NCR 발행 내역",
            height: 400, show: true, selectable: true, // number: true, multi: true, checkrow: true,
            element: [
				...
				{ header: "처리계획일자", name: "plan_dt", width: 70, align: "center", mask: "date-ymd" },
                ...
                //{ header: "참원인", name: "plan_rmk", width: 350 },
                //{ header: "재발방지대책수립", name: "act_rmk", width: 350 },
                //{ header: "실시결과", name: "chk_rmk", width: 250 },
                { header: "실시결과", name: "astat3", width: 60, align: "center" },
                { header: "확인자", name: "astat_user3", width: 60, align: "center" },
				...
				{ header: "발생구분", name: "issue_tp_nm", width: 80, align: "center" },
				{ header: "현상분류", name: "status_tp1", width: 80 },
				{ header: "귀책분류", name: "duty_tp1", width: 80 },
				{ header: "교체부품명", name: "bpart_nm", width: 150 },
                { header: "C/S표준유무", name: "standard_yn", width: 60, align: "center" },
                { header: "C/S표준준수여부", name: "follow_yn", width: 60, align: "center" },
                { header: "표준번호", name: "standard_no", width: 100, align: "center" },
                { header: "제조테스트유무", name: "ptest_yn", width: 60, align: "center" },
                { header: "1차원인선택", name: "factor_tp", width: 100, align: "center" },
                { header: "근거", name: "basis_rmk", width: 200 },
    ...
    var args = { key: param.key,
        source: {
            ...
            element: [
                ...
                { name: "astat1", argument: "arg_astat" },
                { name: "astat2", argument: "arg_d1_astat" },
                { name: "astat3", argument: "arg_d2_astat" },
