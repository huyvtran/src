...
var gw_job_process = {
    ...
    ready: function () {
            ...
            request: [
                ...
                },
                {
                    ...
                    data: [
						{ title: "수입신고일", value: "A" },
						{ title: "수출신고일", value: "B" },
						{ title: "재수출이행일", value: "C" }
                    ]
                },
                {
                    type: "INLINE", name: "조회구분",
                    data: [
						{ title: "수입면장번호", value: "A" },
						{ title: "수입B/L No.", value: "B" },
						{ title: "수입Invoice No.", value: "C" },
						{ title: "수출면장번호", value: "D" },
						{ title: "수출Invoice No.", value: "E" }
                    ]
                }
            ],
            starter: start
        ...
        function start() {
            ...
            gw_com_api.setValue("frmOption", 1, "pstat", "6");
            //----------
    ...
    UI: function () {
                ...
                row: [
                        {
                            element: [
                                ...
                                },
                                {
                                    ...
                                    editable: { type: "checkbox", value: "6", offval: "%" }
                                }
                            ]
                        },
                        {
                        ...
                        {
                            element: [
                                { name: "date_gb", editable: { type: "select", data: { memory: "날짜구분" } } },
				                {
				                    name: "ymd", label: { title: "" }, mask: "date-ymd",
				                    editable: { type: "text", size: 7, maxlength: 10 }
				                },
                                { name: "search_gb", editable: { type: "select", data: { memory: "조회구분" } } },
				                { name: "search", label: { title: "" }, editable: { type: "text", size: 10 } }
                            ]
                        },
                        {
                            align: "right",
        ...
        //=====================================================================================
        var args = {
            targetid: "grdData_Main", query: "EHM_2145_1", title: "자재반입요청목록",
            height: 450, show: true, selectable: true, number: true, //dynamic: true,
            editable: { master: true, bind: "select", focus: "imp_inf03", validate: true },
            element: [
    ...
    var args = {
        source: {
            ...
            element: [
                ...
                { name: "search_gb", argument: "arg_search_gb" },
                { name: "search", argument: "arg_search" },
                { name: "rqst_no", argument: "arg_rqst_no" }
            ],
            argument: [
                { name: "arg_stock_status", value: "050" },
            ...
            remark: [
                ...
                { element: [{ name: "ymd" }], label: gw_com_api.getText("frmOption", 1, "date_gb") + " :" },
                { element: [{ name: "search" }], label: gw_com_api.getText("frmOption", 1, "search_gb") + " :" }
            ]
        },
        target: [
...
function processItemChanged(param) {
    ...
    switch (param.object) {
        case "grdData_Main":
            gw_com_api.setValue(param.object, param.row, "stock_status_nm", "060", (param.type == "GRID" ? true : false));
            gw_com_api.setValue(param.object, param.row, "stock_status", "060", (param.type == "GRID" ? true : false));
            break;
    }
}
//----------
