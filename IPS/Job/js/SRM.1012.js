...
function processSave(param) {
    ...
    // 기간 체크
    if (gw_com_api.getValue("frmData_PER", 1, "open_date") + gw_com_api.getValue("frmData_PER", 1, "open_time") > gw_com_api.getValue("frmData_PER", 1, "close_date") + gw_com_api.getValue("frmData_PER", 1, "close_time")) {
        gw_com_api.setError(true, "frmData_PER", 1, "open_date");
        gw_com_api.setError(true, "frmData_PER", 1, "open_time");
        gw_com_api.setError(true, "frmData_PER", 1, "close_date");
        gw_com_api.setError(true, "frmData_PER", 1, "close_time");
        gw_com_api.messageBox([{ text: "접수시작일이 마감일보다 큽니다." }]);
        return false;
    }
    gw_com_api.setError(false, "frmData_PER", 1, "open_date");
    gw_com_api.setError(false, "frmData_PER", 1, "open_time");
    gw_com_api.setError(false, "frmData_PER", 1, "close_date");
    gw_com_api.setError(false, "frmData_PER", 1, "close_time");
