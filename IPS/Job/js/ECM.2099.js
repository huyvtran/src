...
function processRetrieve(param) {
    ...
    if ($("#img_ecm_sign").attr("src") == undefined) {
        var html = "<img id='img_ecm_sign' src='/Files/ECM_FILES/SIGN_FILES/" + v_global.logic.data.rgst_no + ".png' />";
        var args = {
            targetid: "frmImage",
            data: [
        ...
        var d = new Date();
        $("#img_ecm_sign").attr("src", "/Files/ECM_FILES/SIGN_FILES/" + v_global.logic.data.rgst_no + ".png?" + d.getTime());
    }
