...
var gw_job_process = {
    ...
    UI: function () {
                    ...
                    { element: [
                            {
                                name: "user_nm",
                                label: { title: "사용자 :" },
                                editable: { type: "text", size: 7, maxlength: 5 }
                            }
                    ]
                    },
                    {
        ...
        //=====================================================================================
        var args = { targetid: "grdData_목록", query: "DEV_9999",
            height: 442, show: true, selectable: true,
            element: [
                { header: "사용자명", name: "user_nm", width: 70, align: "center" },
                { header: "ID", name: "user_id", width: 100, align: "center" }
			]
        };
        //----------
