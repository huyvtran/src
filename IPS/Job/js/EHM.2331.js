...
var gw_job_process = {
    ...
    ready: function () {
        ...
        var args = { request: [
				...
				{ type: "INLINE", name: "통계유형",
				    data: [
						{ title: "Line별", value: "LINE" }
					  , { title: "공정별", value: "공정" }
					  , { title: "현상별", value: "현상" }
					  , { title: "등록자별", value: "USER" }
					]
				},
				{
    ...
    UI: function () {
        ...
        //==== Main Grid : 고분보 분류별현황 ====
        var args = {
            targetid: "grdData_Main", query: "EHM_2331_C_1", title: "고분보 분류별 현황",
            ...
            element: [
				...
				{ name: "rate", header: "비율", width: 50, align: "center" },
        ...
        //==== Main Chart : 고분보 분류별현황 ====
        var args = {
            targetid: "lyrChart_Main", query: "EHM_2331_C_1", title: "고분보 분류별 현황", show: true,
        ...
        //==== Sub Grid : 상세현황 ====
        var args = {
            targetid: "grdData_Sub", query: "EHM_2331_S_1", title: "상세 내역", 
            caption: true, show: true, height: 240, width: 1000, pager: true, dynamic: true,
            element: [
