...
function processPreview(param) {
    ...
    var args = {
        ...
        param: [
            ...
            { name: "dlv_date", value: gw_com_api.getValue("grdData_현황", "selected", "dlv_date", true) }
        ],
        target: {
            type: "TAB",
            id: "lyrTab",
...
function processExport() {
    ...
    var key = gw_com_api.getValue("grdData_현황", "selected", "dlv_date", true);
    var args = {
        query: "w_srm1041_2",
        source: {
            type: "GRID",
            ...
            element: [
                ...
                { name: "dlv_date", argument: "arg_ymd_fr" },
                { name: "dlv_date", argument: "arg_ymd_to" },
        ...
        option: [
            ...
            { name: "USER", value: gw_com_api.getValue("grdData_현황", "selected", "supp_cd", true) },
            { name: "KEY", value: key },
            { name: "SAVE", value: 1 }
        ],
        target: {
