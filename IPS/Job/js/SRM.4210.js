    ...
    UI: function () {
            ...
            content: { row: [
                    ...
                    },
                    {
                        element: [
                            ...
                            {
                                name: "chk_yn", label: { title: "검수여부 :" }, value: "0",
                                editable: {
                                    type: "select",
                                    data: { memory: "검수여부" }
                                }
        ...
        var args = {
            ...
            element: [
                ...
                {
                    header: "수량합계", name: "item_qty", width: 50, align: "right",
                ...
                {
                    header: "선택", name: "check_0_qty", width: 50, align: "right",
                    fix: { mask: "numeric-int", margin: 1 }
                },
                {
                    header: "검사", name: "chk_1_qty", width: 50, align: "right",
                    fix: { mask: "numeric-int", margin: 1 }
                },
                {
                    header: "미검사", name: "chk_0_qty", width: 50, align: "right",
                    fix: { mask: "numeric-int", margin: 1 }
                },
                {
                    header: "합격", name: "chk_result_1_qty", width: 50, align: "right",
                    fix: { mask: "numeric-int", margin: 1 }
                },
                {
                    header: "불합격", name: "chk_result_0_qty", width: 50, align: "right",
                    fix: { mask: "numeric-int", margin: 1 }
                },
        ...
        var args = {
            ...
            element: [
                ...
                { header: "유형", name: "check_yn_nm", width: 40, align: "center" },
                {
                    ...
                    format: { type: "select", data: { memory: "검수여부" } }
                },
        ...
        switch (param.element) {
            case "date_tp":
                ...
                for (var i = 0; i < obj.length; i++) {
                    var label = obj[i];
                    if (label.innerHTML == "납품일자 :" || label.innerHTML == "검수일자 :") {
