...
var gw_job_process = {
    ...
    UI: function () {
        ...
        var args = {
            ...
            height: 306, show: true, selectable: true, dynamic: true,
            element: [
				{ header: "고객사", name: "cust_cd", width: 60, align: "center" },
        ...
        var args = {
            ...
            caption: true, height: 80, pager: false, show: true, selectable: true, key: true, dynamic: true,
            element: [
				{ header: "고객사", name: "cust_cd", width: 60, align: "center" },
				{ header: "Line", name: "cust_dept", width: 80, align: "center" },
				{ header: "Process", name: "cust_proc", width: 60, align: "center" },
    ...
    procedure: function () {
        ...
        function rowdblclick_grdData_현황(ui) {
            ...
            var args = { type: "PAGE", page: "w_ehm1030", title: "A/S 장비 관리",
                width: 750, height: 450, open: true, control: true
            };
            if (gw_com_module.dialoguePrepare(args) == false) {
