...
var gw_job_process = {
    ...
    UI: function () {
                    ...
                    },
                    {
                        element: [
                            { header: true, value: "적용시점", format: { type: "label" } },
                            {
                                ...
                                format: { width: 628 },
                                editable: { type: "text", width: 626, validate: { rule: "required", message: "적용시점" } }
                            },
        ...
        //=====================================================================================
        //var args = {
        //    targetid: "frmData_메모A", query: "w_eccb4010_S_2_1", type: "TABLE", title: "BEFORE (변경 전)",
        ...
        ////=====================================================================================
        //var args = {
        //    targetid: "frmData_메모B", query: "w_eccb4010_S_2_2", type: "TABLE", title: "AFTER (변경 후)",
        //    caption: true, show: true, fixed: true, selectable: true,
        //    editable: { bind: "select", validate: true },
        //    content: {
        //        width: { field: "100%" }, height: 370,
        ...
        //=====================================================================================
        var args = {
            targetid: "grdData_PART", query: "w_eccb4010_S_7", title: "단종 PART",
            caption: true, height: "100%", pager: false, show: true, selectable: true, number: true,
            editable: { multi: true, bind: "select", focus: "apart_cd", validate: true },
            element: [
                {
                    header: "단종부품코드", name: "apart_cd", width: 100, align: "center", mask: "search",
                    editable: { type: "text", validate: { rule: "required", message: "단종부품코드" } }
                },
                {
                    header: "단종부품명", name: "apart_nm", width: 200,
                    editable: { type: "hidden" }
                },
                {
                    header: "단종부품규격", name: "apart_spec", width: 300,
                    editable: { type: "hidden" }
                },
                {
                    header: "교체부품코드", name: "bpart_cd", width: 100, align: "center", mask: "search",
                    editable: { type: "text", validate: { rule: "required", message: "교체부품코드" } }
                },
                {
                    header: "교체부품명", name: "bpart_nm", width: 200,
                    editable: { type: "hidden" }
                },
                {
                    header: "교체부품규격", name: "bpart_spec", width: 300,
                    editable: { type: "hidden" }
                },
                { name: "eco_no", hidden: true, editable: { type: "hidden" } },
        ...
        //----------
        gw_com_module.gridCreate(args);
        //$("#grdData_PART_data").parents('div.ui-jqgrid-bdiv').css("max-height", "200px");
        //=====================================================================================
        var args = {
            targetid: "grdData_첨부", query: "w_eccb4010_S_4", title: "첨부 문서",
            caption: true, height: "100%", pager: false, show: true, number: true, selectable: true,
    ...
    procedure: function () {
        ...
        gw_com_module.eventBind(args);
        //----------
        var args = { targetid: "lyrMenu_5", element: "조회", event: "click", handler: click_lyrMenu_5_재고현황 };
        gw_com_module.eventBind(args);
        //=====================================================================================
        ...
        gw_com_module.eventBind(args);
        //=====================================================================================
        var args = { targetid: "grdData_PART", grid: true, event: "itemdblclick", handler: itemdblclick_grdData_PART };
        gw_com_module.eventBind(args);
        //----------
        var args = { targetid: "grdData_PART", grid: true, event: "itemkeyenter", handler: itemdblclick_grdData_PART };
        gw_com_module.eventBind(args);
        //=====================================================================================
        ...
        function click_lyrMenu_5_삭제(ui) {
            ...
            if (!checkManipulate({})) return;
            var args = { targetid: "grdData_PART", row: "selected", select: true }
            gw_com_module.gridDelete(args);

        }
        //----------
        function click_lyrMenu_5_재고현황(ui) {

            if (!checkManipulate({})) return;
            if (!checkUpdatable({ check: true })) return false;
            if (gw_com_api.getRowCount("grdData_PART") < 1) return;
            var args = {
        ...
        //----------
        function itemdblclick_grdData_PART(ui) {
...
function processRetrieve(param) {
    ...
    if (param.target == undefined || param.target == "%") {
        ...
        //args.target[args.target.length] = { type: "FORM", id: "frmData_메모A" };
        //args.target[args.target.length] = { type: "FORM", id: "frmData_메모B" };
        ...
        args.target[args.target.length] = { type: "GRID", id: "grdData_PART" };
...
function processMemo(param) {
    ...
    if (param.html) {
        var args = {
            type: "PAGE", page: "w_edit_html_eccb", title: "개선 사항",
            width: 1000,
            height: 570,
...
function processPopup(param) {
    ...
    switch (param.element) {
        ...
        case "bpart_cd":
            {
                v_global.event.name = param.element.replace("_cd", "_nm");
                v_global.event.data = {
                    tab: 1,
                    prod_key: "",
                    prod_nm: ""
                ...
                var args = {
                    type: "PAGE", page: "w_find_part_ehm", title: "부품 선택",
        ...
        case gw_com_api.v_Stream.msg_selectedPart_EHM:
            {
                if (v_global.event.row == undefined || v_global.event.row == null) {
                    var args = {
                        targetid: "grdData_PART",edit: true,
                        data: [
                            { name: "eco_no", value: gw_com_api.getValue("frmData_내역", 1, "eco_no") },
                ...
                gw_com_api.setValue(v_global.event.object, v_global.event.row, v_global.event.element.replace("_cd", "_spec"), param.data.part_spec, (v_global.event.type == "GRID") ? true : false, true);
