...
var gw_job_process = {
    ...
    UI: function () {
        ...
        //=====================================================================================
        var args = {
            targetid: "grdData_MAIN", query: "EHM_2180_2", title: "코드 내역",
            caption: true, height: 442, show: true, selectable: true, key: true,
            editable: { multi: true, bind: "select", focus: "dcode", validate: true },
            element: [
				{ header: "분류코드", name: "hcode", width: 60, align: "center", editable: { type: "hidden", maxlength: 10 }, hidden: true },
				{
				    header: "코드", name: "dcode", width: 80, align: "center",
				    editable: { bind: "create", type: "text", validate: { rule: "required", message: "코드" }, maxlength: 40 }
				},
				{
				    header: "명칭", name: "dname", width: 350,
				...
				{
				    header: "담당부서", name: "dept_nm", width: 150,
				    editable: { type: "text" }, mask: "search"
				},
				{
				    header: "담당부서", name: "fcode1", width: 100,
