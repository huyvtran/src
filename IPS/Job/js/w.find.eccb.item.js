...
var gw_job_process = {
    ...
    UI: function () {
        ...
        //=====================================================================================
        var args = {
            targetid: "grdData_현황", query: "w_find_eccb_item_M_1", title: "ECCB 심의 대상",
            ...
            element: [
				...
				{ header: "CIP시행", name: "cip_dt", width: 160, align: "center" },
...
function informResult(param) {
    ...
    $.each(ids, function () {
        rows.push({
            ...
            ecr_tp: gw_com_api.getCellValue("GRID", "grdData_현황", this, "ecr_tp"),
            ecr_tp_nm: gw_com_api.getCellValue("GRID", "grdData_현황", this, "ecr_tp_nm")
        });
    });
    var args = {
