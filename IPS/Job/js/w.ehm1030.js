...
function processItemchanged(param) {
    ...
    switch (param.element) {
        case "prod_sno":
            {
                gw_com_api.setValue("frmOption", 1, "prod_sno", param.value.current);
            }
            break;
        case "change_tp":
            {
                ...
                },
                {
                    element: [
                        { header: true, value: "비고", format: { type: "label" } },
                        {
                            ...
                            format: { type: "textarea", rows: 5, width: 582 },
                            editable: { type: "textarea", rows: 5, width: 580 }
                        }
                    ]
                }
            ]
