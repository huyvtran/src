...
var gw_job_process = {
        ...
        var args = {
            request: [
                ...
                },
                {
                    ...
                    param: [
                        { argument: "arg_hcode", value: "ISCM41" }
                    ]
                },
                {
    ...
    UI: function () {
        ...
        var args = {
            ...
            element: [
                { name: "프로젝트의뢰", value: "프로젝트의뢰", icon: "기타" },
                    ...
                    },
                    {
                        element: [
				            ...
				            },
				            {
				                ...
				                editable: {
				                    type: "select",
				                    data: { memory: "영업구분", unshift: [{ title: "전체", value: "%" }] },
				                    remark: { title: "영업구분 :" }
				                }
				            },
				            {
        ...
        //=====================================================================================
        var args = { targetid: "grdData_현황", query: "w_iscm1070_M_1", title: "생산 의뢰 현황",
            height: 150,
            //caption: true,
            show: true,
            selectable: true,
        ...
        //=====================================================================================
        var args = { targetid: "frmData_상세", query: "w_iscm1070_S_1", type: "TABLE", title: "생산 의뢰서",
            ...
            content: { width: { label: 80, field: 200 }, height: 25,
                row: [
                    ...
                    {
                        element: [
                            { header: true, type: "label", value: "사업부", format: { type: "label" } },
                    ...
                    },
                    {
                        element: [
                            ...
                            { name: "prod_nm", editable: { type: "text", validate: { rule: "required", message: "제품명" } }, style: { colfloat: "float" } },
                            {
                                ...
                                editable: { type: "text", width: 66, validate: { rule: "required", message: "호기" } }, style: { colfloat: "floating" }
                            },
                    ...
                    },
                    {
                        element: [
                            { header: true, type: "label", value: "작성자", format: { type: "label" } },
                            {
                                name: "reg_emp",
                                editable: {
                                    type: "select", data: { memory: "사원" },
                                    validate: { rule: "required", message: "작성자" }
                                }
                            },
                            { header: true, type: "label", value: "작성부서", format: { type: "label" } },
                            {
                                name: "reg_dept",
                                editable: {
                                    type: "select", data: { memory: "부서" },
                                    validate: { rule: "required", message: "작성부서" }
                                }
                            },
        ...
        var args = {
            ...
            height: 150, show: true,
            selectable: true,
            color: { row: true },
            element: [
				{ header: "Module", name: "module_nm", width: 100, align: "left" },
				{ header: "Option", name: "option_nm", width: 100, align: "left" },
				{
				    header: " ", name: "item1_yn", width: 15, align: "center",
				    format: { type: "checkbox", title: "", value: "1", offval: "0" }
				},
				{
				    header: "항목1", name: "item1_nm", width: 100, align: "center",
				    format: { type: "text" }
				},
                {
                    header: " ", name: "item2_yn", width: 15, align: "center",
                    format: { type: "checkbox", title: "", value: "1", offval: "0" }
                },
				{
				    header: "항목2", name: "item2_nm", width: 100, align: "center",
				    format: { type: "text" }
				},
                {
                    header: " ", name: "item3_yn", width: 15, align: "center",
                    format: { type: "checkbox", title: "", value: "1", offval: "0" }
                },
				{
				    header: "항목3", name: "item3_nm", width: 100, align: "center",
				    format: { type: "text" }
				},
                {
                    header: " ", name: "item4_yn", width: 15, align: "center",
                    format: { type: "checkbox", title: "", value: "1", offval: "0" }
                },
				{
				    header: "항목4", name: "item4_nm", width: 100, align: "center",
				    format: { type: "text" }
				},
                {
                    header: " ", name: "item5_yn", width: 15, align: "center",
                    format: { type: "checkbox", title: "", value: "1", offval: "0" }
                },
				{
				    header: "항목5", name: "item5_nm", width: 100, align: "center",
				    format: { type: "text" }
				},
        ...
        var args = {
            ...
            element: [
                {
                    header: "순번", name: "sub_seq", width: 50, align: "center",
                    format: { type: "text", mask: "numeric-int" },
                    editable: { type: "text" }
                },
				{
				...
				},
				{
				    ...
				    editable: { type: "select", data: { memory: "사원", unshift: [{ title: "", value: "" }] } }
				},
    ...
    procedure: function () {
        ...
        //----------
        var args = { targetid: "lyrMenu_1", element: "프로젝트의뢰", event: "click", handler: processCallApp };
        ...
        gw_com_api.setValue("frmOption", 1, "ymd_to", gw_com_api.getDate("", { day: +90 }));
        //----------
...
function successApproval(response, param) {
    ...
    var params = [
        { name: "form_id", value: (param.modify) ? 9 : 8 },
        { name: "cmpid", value: 2 },
...
//----------
function chkRowCnt(param) {
    var chkyn = true;
    var rowcnt = gw_com_api.getRowCount("grdData_계획");
    if (rowcnt < 1)
        chkyn = false;
    return chkyn;
}
...
function processCallApp(param) {
    ...
    if (!checkUpdatable({ check: true })) return false;
    if (!chkRowCnt({})){
        gw_com_api.messageBox([{ text: "일정 계획을 입력하세요." }], 320);
        return false;
    }
        
    var row = gw_com_api.getSelectedRow("grdData_현황");
    if (row > 0) {
        var args = "p2=" + gw_com_api.getValue("grdData_현황", row, "proj_no", true);
        var url = "/App_Setup/MBOM_A/IpsMesMbomA.application?p1=MbomB&" + args;
