    ...
    UI: function () {
        ...
        var args = {
            ...
            element: [
                ...
                { header: "계약이행<br/>보증보험증권", name: "file1_link", format: { type: "link" }, width: 80, align: "center" },
                { header: "선급금이행<br/>보증보험증권", name: "file2_link", format: { type: "link" }, width: 80, align: "center" },
                { header: "하자이행<br/>보증보험증권", name: "file3_link", format: { type: "link" }, width: 80, align: "center" },
...
function processButton(param) {
    ...
    switch (param.element) {
        ...
        case "삭제":
            {
                var args = { object: "grdData_FILE", element: "file_id" };
        ...
        case "gw_doc_no2":
            {
                ...
                if (!(doc_id == undefined || doc_id == "undefined" || doc_id == ""))
                    url = "http://gw.ips.co.kr/Linkage/Approval_TM_View.aspx?param1=" + doc_id;
            }
            break;
        case "doc_no":
            {
