            ...
            request: [
                {
                    type: "INLINE", name: "분류",
                    data: [
						{ title: "진행상태", value: "EM-PROCESS" },
						{ title: "수주결과", value: "EM-RESULT" }
					]
                },
                {
                    type: "INLINE", name: "구분",
                ...
                case "EM-PROCESS":
                    {
                        args.data.param.push(
                            { name: "est_stat", value: gw_com_api.getValue("grdData_현황", "selected", "rcode", true) }
                        );
                    }
                    break;
                case "EM-RESULT":
        ...
        function rowdblclick_grdData_현황상세(ui) {
            ...
            switch (chart) {
                case "2":
                    {
                        args.data.param.push(
                            { name: "submit_empnm", value: gw_com_api.getValue("grdData_현황상세", "selected", "category", true) }
                        );
                    }
                    break;
                case "3":
                    {
                        args.data.param.push(
                            { name: "cust_cd", value: gw_com_api.getValue("grdData_현황상세", "selected", "rcode", true) }
                        );
                    }
                    break;
            }
