...
var gw_job_process = {
    ...
    UI: function () {
        ...
        gw_com_module.buttonMenu(args);
        //=====================================================================================
        var args = { targetid: "frmData_내역", query: "w_eccb4050_M_1", type: "TABLE", title: "ECA 내역",
                ...
                row: [
                    ...
                    },
                    {
                        element: [
                            ...
                            {
                                style: { colspan: 3, colfloat: "float" }, name: "act_time_sel",
                                format: { width: 0 }, display: true,
                                editable: { type: "select", data: { memory: "적용시점" }, width: 155 }
                            },
                            { style: { colfloat: "floating" }, name: "act_time_text", format: { width: 430 } },
                            {
                                style: { colfloat: "floated" }, name: "act_time_etc",
                                format: { width: 0 }, display: true,
                                editable: { type: "text", width: 468 }
                    ...
                    },
                    {
                        element: [
                            ...
                            {
                                style: { colspan: 5, colfloat: "float" }, name: "act_region1",
                                format: { width: 0 },
                    ...
                    {
                        element: [
                            { header: true, value: "도면조치", format: { type: "label" } },
                            {
                                style: { colspan: 5, colfloat: "float" }, name: "dwg_proc_sel", format: { width: 0 },
                                editable: { type: "select", data: { memory: "도면조치" }, width: 155 }, display: true
                            },
                            { style: { colfloat: "floating" }, name: "dwg_proc_text", format: { width: 500 } },
                            {
                                style: { colfloat: "floated" }, name: "dwg_proc_etc", format: { width: 0 },
                                editable: { type: "text", width: 537 }, display: true
                            },
                            { name: "dwg_proc", hidden: true, editable: { type: "hidden" } }
                        ]
                    },
                    {
                        element: [
                            { header: true, value: "적용JOB 및<br>고객사", format: { type: "label" } },
                            {
                                style: { colspan: 3 }, name: "act_job", format: { type: "textarea", rows: 6, width: 630 },
                                editable: { type: "textarea", rows: 6, width: 628 }
                            },
                            { header: true, value: "접수부서", format: { type: "label" } },
                            {
                                style: { colfloat: "div" }, name: "notify_dept1",
                                format: { type: "select", data: { memory: "부서" } },
                                editable: { type: "select", data: { memory: "부서" } }
                            },
                            {
                                style: { colfloat: "diving" }, name: "notify_dept2",
                                format: { type: "select", data: { memory: "부서" } },
                                editable: { type: "select", data: { memory: "부서" } }
                            },
                            {
                                style: { colfloat: "diving" }, name: "notify_dept3",
                                format: { type: "select", data: { memory: "부서" } },
                                editable: { type: "select", data: { memory: "부서" } }
                            },
                            {
                                style: { colfloat: "divided" }, name: "notify_dept4",
                                format: { type: "select", data: { memory: "부서" } },
                                editable: { type: "select", data: { memory: "부서" } }
                            }
                        ]
                    ...
                    {
                        element: [
                            { header: true, value: "전개비용", format: { type: "label" } },
                            {
                                style: { colspan: 3 }, name: "act_amt_note",
                                format: { type: "textarea", rows: 3, width: 630 },
                                editable: { type: "textarea", rows: 3, width: 628 }
                            },
                            { header: true, value: "합계", format: { type: "label" } },
                            { name: "act_amt", mask: "currency-ko", editable: { type: "text" } }
                        ]
                    },
                    {
                        element: [
                            { header: true, value: "비고", format: { type: "label" } },
                            {
                                ...
                                format: { type: "textarea", rows: 5, width: 1018 },
                                editable: { type: "textarea", rows: 5, width: 1016 }
                            }
                        ]
                    }
                ]
        ...
        //=====================================================================================
        var args = { targetid: "grdData_모델", query: "w_eccb4050_S_1", title: "적용 모델",
        ...
        //=====================================================================================
        var args = { targetid: "frmData_메모A", query: "w_eccb4050_S_2_1", type: "TABLE", title: "BEFORE (변경 전)",
        ...
        gw_com_module.formCreate(args);
        //=====================================================================================
        var args = { targetid: "frmData_메모B", query: "w_eccb4050_S_2_2", type: "TABLE", title: "AFTER (변경 후)",
            caption: true, show: true, fixed: true, selectable: true,
            editable: { bind: "select", validate: true },
            content: {
                width: { field: "100%" }, height: 370,
        ...
        gw_com_module.formCreate(args);
        //=====================================================================================
        var args = { targetid: "grdData_도면", query: "w_eccb4050_S_3", title: "설변 도면",
        ...
        //=====================================================================================
        var args = {
            targetid: "grdData_평가", query: "w_eccb4050_S_5", title: "제안평가",
        ...
        gw_com_module.gridCreate(args);
        //=====================================================================================
        var args = { targetid: "grdData_첨부", query: "w_eccb4010_S_4", title: "첨부 문서",
            caption: true, height: "100%", pager: false, show: true, number: true, selectable: true,
    ...
    procedure: function () {
        ...
        //----------
        var args = { targetid: "lyrMenu_1", element: "통보", event: "click", handler: processSendmail };
        gw_com_module.eventBind(args);
        //----------
        ...
        gw_com_module.eventBind(args);
        //----------
        var args = { targetid: "lyrMenu_evl", element: "평가", event: "click", handler: click_lyrMenu_평가 };
        gw_com_module.eventBind(args);
        //----------
    ...
    if (param.sub) {
        var args = {
            ...
            target: [
                ...
                { type: "FORM", id: "frmData_메모A", query: "w_eccb4010_I_2_1", crud: "insert" },
                { type: "FORM", id: "frmData_메모B", query: "w_eccb4010_I_2_2", crud: "insert" }
            ],
            key: param.key
        };
        gw_com_module.objRetrieve(args);
...
function successApproval(response, param) {
    ...
    var FormId = 11;
    if (DeptArea == "DP") FormId = 28;
    else if (DeptArea == "SOLAR") FormId = 29;
    else FormId = 11;
...
function setReqDoc(param) {
    ...
    gw_com_module.callRequest(args);
    function successRequest(data) {
        v_global.logic.req_doc.code = data[0].DATA[0];
        v_global.logic.req_doc.name = data[0].DATA[1];
    }
    //----------
    $.ajaxSetup({ async: true });
    //=================== async : true ========================
