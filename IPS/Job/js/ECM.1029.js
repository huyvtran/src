    ...
    UI: function () {
        ...
        var args = {
            ...
            element: [
				...
				{ header: "지분율", name: "cr_rate", width: 100, align: "right", mask: "numeric-float" },
                    ...
                    },
                    {
                        element: [
                            { header: true, value: "계약서 핵심사항", format: { type: "label" } },
                            {
                                ...
                                editable: { type: "textarea", rows: 8, width: 1044 }
                            }
                        ]
                    },
                    {
        ...
        case "상신":
            {
                ...
                //gw_com_api.showMessage("테스트 기간 동안 그룹웨어 연동 없이 체결 품의 결재완료 상태로  바로 변경됩니다.");
                //var stat = "APPR_C";    //"APPR_A";
                //var proc = {
                //    url: "COM",
                //    nomessage: true,
                ...
                //        { name: "pstat", value: stat, type: "varchar" },
...
function processApprove(param) {
    ...
    var proc = {
        url: "COM",
        nomessage: true,
        procedure: "PROC_APPROVAL_ECM01",
        input: [
            { name: "doc_id", value: v_global.logic.doc_id, type: "varchar" },
            { name: "remark1", value: gw_com_api.getValue("frmData_MAIN2", 1, "remark1"), type: "varchar" },
            { name: "remark4", value: gw_com_api.getValue("frmData_MAIN2", 1, "remark4"), type: "varchar" },
            { name: "remark5", value: gw_com_api.getValue("frmData_MAIN2", 1, "remark5"), type: "varchar" },
...
function successBatch(response, param) {
    ...
    if (response.VALUE[2] == "") {
        ...
        var params = [
            { name: "form_id", value: 233 },
            { name: "cmpid", value: 2 },
            { name: "inter_id", value: "I" },
            { name: "sysid", value: "ECM01" },
