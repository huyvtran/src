    ...
    UI: function () {
        ...
        var args = {
            ...
            element: [
				...
				{
				    header: "품번", name: "item_cd", width: 60, align: "left", mask: "search",
				    editable: { bind: "create", type: "text", validate: { rule: "requied" }, width: 110 }
				},
                ...
                { header: "단위", name: "item_unit", width: 40, align: "center" },
                {
                    ...
                    editable: {
                        type: "select", data: { memory: "검수유형" }, width: 110
