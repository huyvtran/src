    ...
    UI: function () {
        ...
        var args = {
            ...
            editable: {
                master: true,
                bind: "select",
                focus: "stats_class_cd1",
                validate: true
            },
            element: [
				{
				    header: "코드",
				    name: "stats_class_cd1",
				    width: 60,
				    align: "center",
				    editable: {
				        bind: "create",
    ...
    procedure: function () {
        ...
        function click_lyrMenu_3_추가(ui) {
            ...
            var args = {
                ...
                edit: true,
                data: [
                    { name: "stats_class_cd1", value: gw_com_api.getValue("grdData_중분류", "selected", "stats_class_cd1", true) },
                    { name: "stats_class_cd2", value: gw_com_api.getValue("grdData_중분류", "selected", "stats_class_cd2", true) }
                ]
            };
        ...
        function itemchanged_grdData_대분류(ui) {
            ...
            switch (ui.element) {
                case "stats_class_cd1":
                    {
                        var ids = gw_com_api.getRowIDs("grdData_중분류");
                        $.each(ids, function () {
                            if (ui.value.prev
                                == gw_com_api.getValue("grdData_중분류", this, "stats_class_cd1", true))
                                gw_com_api.setValue("grdData_중분류", this, "stats_class_cd1", ui.value.current, true);
                        });
                        ids = gw_com_api.getRowIDs("grdData_소분류");
                        $.each(ids, function () {
                            if (ui.value.prev
                                == gw_com_api.getValue("grdData_소분류", this, "stats_class_cd1", true))
                                gw_com_api.setValue("grdData_소분류", this, "stats_class_cd1", ui.value.current, true);
                        });
                    }
                    break;
                case "div_nm":
        ...
        function itemchanged_grdData_중분류(ui) {
            ...
            switch (ui.element) {
                case "stats_class_cd2":
                    {
                        ids = gw_com_api.getRowIDs("grdData_소분류");
                        $.each(ids, function () {
                            if (ui.value.prev
                                == gw_com_api.getValue("grdData_소분류", this, "stats_class_cd2", true))
                                gw_com_api.setValue("grdData_소분류", this, "stats_class_cd2", ui.value.current, true);
                        });
                    }
                    break;
                case "div_nm":
                    {
                        gw_com_api.setCellValue(
                            ...
                            ui.row,
                            "div_tnm",
                            gw_com_api.getValue("grdData_대분류", "selected", "div_nm", true) + " : " +
                            ui.value.current
                        );
                    }
                    break;
                ...
                case "div_nm":
                    {
                        gw_com_api.setValue(
                            ...
                            "div_tnm",
                            gw_com_api.getValue("grdData_대분류", "selected", "div_nm", true) + " : " +
                            gw_com_api.getValue("grdData_중분류", "selected", "div_nm", true) + " : " +
                            ui.value.current,
                            true,
                            true
                        );
        ...
        args = {
            source: {
                ...
                element: [
		            {
		                name: "stats_class_cd1",
		                argument: "argStats_class_cd1"
		            },
                    {
                        name: "stats_class_cd2",
                        argument: "argStats_class_cd2"
                    }
	            ]
            },
            target: [
...
function processInsert(param) {
    ...
    if (param.sub) {
        args = {
            ...
            updatable: true,
            data: [
                { name: "stats_class_cd1", value: gw_com_api.getValue("grdData_대분류", "selected", "stats_class_cd1", true) },
                { name: "stats_class_cd3", value: "00" }
            ],
            clear: [
                {
                    type: "GRID",
...
function processRemove(param) {
    ...
    var args = {
        url: "COM",
        procedure: "PROC_STATS_DIV_DELETE",
        nomessage: true,
        input: [
            { name: "stats_class1", value: gw_com_api.getValue(target, "selected", "stats_class_cd1", true), type: "varchar" },
            { name: "stats_class2", value: gw_com_api.getValue(target, "selected", "stats_class_cd2", true), type: "varchar" },
            { name: "stats_class3", value: gw_com_api.getValue(target, "selected", "stats_class_cd3", true), type: "varchar" },
