...
var gw_job_process = {
    ...
    UI: function () {
        ...
        //=====================================================================================
        var args = {
            targetid: "frmData_내역_1", query: "w_eccb1010_M_1", type: "TABLE", title: "제안 내역",
        ...
        //=====================================================================================
        var args = {
            targetid: "frmData_내역_2", query: "w_info_eccb_item_M_2", type: "TABLE", title: "CIP 내역",
            caption: false, show: true, selectable: true,
            content: {
                ...
                row: [
                    ...
                    },
                    {
                        element: [
                            ...
                            { style: { colspan: 3 }, name: "cip_desc", format: { width: 500 } },
                            { header: true, value: "Level", format: { type: "label" } },
                            { name: "crm_tp_nm" }
                        ]
                    },
            ...
            content: {
                ...
                row: [
                    ...
                    },
                    {
                        element: [
                            { header: true, value: "제목", format: { type: "label" } },
                            { style: { colspan: 3 }, name: "eco_title", format: { width: 500 } },
                            { header: true, value: "구분", format: { type: "label" } },
                            { name: "ecr_tp_nm" }
                        ]
                    },
                    {
                        element: [
                            { header: true, value: "개요", format: { type: "label" } },
                            { style: { colspan: 3 }, name: "eco_desc", format: { width: 500 } },
                            { header: true, value: "Level", format: { type: "label" } },
                            { name: "crm_tp_nm" }
                        ]
                    },
        ...
        var args = {
            ...
            element: [
                ...
                { header: "Line", name: "cust_dept", width: 90, align: "center" },
    ...
    procedure: function () {
        ...
        //----------
        gw_com_api.setValue("frmOption", 1, "ecr_no", gw_com_api.getPageParameter("data_key"));
        gw_com_api.setValue("frmOption", 1, "cip_no", gw_com_api.getPageParameter("cip_no"));
        gw_com_api.setValue("frmOption", 1, "eco_no", gw_com_api.getPageParameter("eco_no"));
...
function processRetrieve(param) {
    ...
    var args = {
        ...
        target: [
            ...
            //{ type: "FORM", id: "frmData_메모A_1" },
            //{ type: "FORM", id: "frmData_메모B_1" },
            { type: "FORM", id: "frmData_메모F_1" },
            //{ type: "FORM", id: "frmData_메모A_2" },
            //{ type: "FORM", id: "frmData_메모B_2" },
