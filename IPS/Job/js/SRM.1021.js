...
var gw_job_process = {
    ...
    UI: function () {
        ...
        //=====================================================================================
        var args = {
            targetid: "grdList_PER_SUPP", query: "SRM_1021_1", title: "의뢰 현황",
        ...
        var args = {
            ...
            caption: true, height: 50, pager: false, show: true, number: true, selectable: true, key: true,
            element: [
...
var Query = {
    ...
    getPSTAT2: function (param) {
        ...
        function successRequest(data) {
            rtn = {
                pstat: data[0].DATA[0],
                pstat_nm: data[0].DATA[1],
                sysdate: data[0].DATA[2],
                dt_yn: data[0].DATA[3],
                per_pstat: data[0].DATA[4],
                per_pstat_nm: data[0].DATA[5]
            };
        }
        //----------
        $.ajaxSetup({ async: true });
