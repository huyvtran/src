...
var gw_job_process = {
    ...
    UI: function () {
        ...
        //=====================================================================================
        var args = {
            targetid: "grdList_MAIN", query: "SRM_4150_1", title: "집계",caption : true,
            height: 100, show: true, selectable: true, number: true,
            element: [
				{ header: "사업부", name: "plant_nm", width: 150, align: "center" },
				{ header: "구분", name: "proj_tp", width: 150, align: "center" }//,
				//{ header: "금액", name: "io_amt", width: 200, align: "right", mask: "numeric-int" },
        ...
        var args = {
            ...
            element: [
				{ header: "사업부", name: "plant_nm", width: 50, align: "center" },
...
function processRetrieve(param) {
    ...
    //Fgw_com_module.objRetrieve(args);
