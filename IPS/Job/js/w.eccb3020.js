...
var gw_job_process = {
    ...
    UI: function () {
        ...
        gw_com_module.buttonMenu(args);
        //=====================================================================================
        var args = { targetid: "frmData_내역", query: "w_eccb3020_M_1", type: "TABLE", title: "CIP 완료 정보",
                ...
                row: [
                    ...
                    { element: [
                            ...
                            { name: "mp_class1_sel", style: { colfloat: "floating" }, format: { width: 0 },
                                editable: {  type: "select", width: 155, display: true,
                    ...
                    },
                    {
                        element: [
                            ...
                            {
                                style: { colfloat: "floating" },
                                name: "act_region3_text", format: {
                                    width: 200
                                }
                            },
                            {
                                style: { colfloat: "floating" },
                                name: "act_module3_text", format: {
                                    width: 300
                                }
                            },
                            {
                    ...
                    },
                    {
                        element: [
                            ...
                            { name: "act_emp", hidden: true,
                                editable: {  type: "hidden"
                                }
                            },
                            { name: "sub_emp1", hidden: true,
                                editable: {  type: "hidden"
                                }
                            },
                            { name: "sub_emp2", hidden: true,
                                editable: {  type: "hidden"
                                }
                            },
                            { name: "sub_emp3", hidden: true,
                                editable: {  type: "hidden"
                                }
                            }
                        ]
                    },
                    {
                        element: [
                            { header: true, value: "예상소요경비", format: {  type: "label" }  },
                            {
                                ...
                                name: "plan_cost_note", format: {  type: "textarea",
                                    rows: 5,
                                    width: 500
                                }
                            },
                    ...
                    },
                    {
                        element: [
                            { header: true, value: "실제소요경비", format: {  type: "label" }  },
                            {
                                ...
                                name: "act_cost_note", format: {  type: "textarea",
                                    rows: 5,
                                    width: 500
                                },
                    ...
                    },
                    {
                        element: [
                            { header: true, value: "횡전개 시<br>총 예상비용", format: {  type: "label" }  },
                            {
                                ...
                                name: "act_amt_note", format: {  type: "textarea",
                                    rows: 5,
                                    width: 800
                                },
                                editable: {  type: "textarea",
        ...
        //=====================================================================================
        var args = { targetid: "frmData_메모A", query: "w_eccb3010_S_2_1", type: "TABLE", title: "TEST 내용",
            caption: true,
            show: true,
            fixed: true,
            selectable: true,
            ...
            content: {
                ...
                row: [
                    {
                        element: [
                            { name: "memo_html", format: {  type: "html",
                                    height: 370,
                                    top: 5
                                }
                            },
...
function processInsert(param) {
    ...
    if (param.sub) {
        ...
        var args = { targetid: "frmData_메모A", edit: true, updatable: true,
            data: [
        ...
        gw_com_module.formInsert(args);
        var args = { targetid: "frmData_메모B", edit: true, updatable: true,
            data: [
                { name: "root_no", value: param.data.cip_no },
                { name: "root_seq", value: "2" },
        ...
        var args = { type: "PAGE", page: "w_find_cip", title: "CIP 선택",
...
function processMemo(param) {
    ...
    if (param.html) {
        var args = { type: "PAGE", page: "w_edit_html_eccb", title: "상세 내용",
            width: 800, height: 570, locate: ["center", "bottom"], open: true
        };
        if (gw_com_module.dialoguePrepare(args) == false) {
...
function successApproval(response, param) {
    ...
    var FormId = 78;
    if (DeptArea == "DP") FormId = 90;
    else if (DeptArea == "SOLAR") FormId = 92;
    else FormId = 78;
