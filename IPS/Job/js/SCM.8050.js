...
var gw_job_process = {
    ...
    UI: function () {
        ...
        //=====================================================================================
        var args = {
            targetid: "grdData_자재", query: "SCM_8050_1", title: "BOM 진행률",
            ...
            element: [
				{ header: "영업진행상태", name: "item_nm", width: 70, align: "center" },
                { header: "BOM Ver", name: "c1_qty", width: 60, align: "center", mask: "numeric-int" },
                { header: "수정중", name: "c1_str", width: 30, align: "center" },
				{ header: "수정자", name: "c2_str", width: 60, align: "center" },
				{ header: "수정시작일시", name: "c3_str", width: 80, align: "center" },
				{ header: "품목수", name: "c2_qty", width: 50, align: "center", mask: "numeric-int" },
				{ header: "기구 진행률(%)", name: "c3_qty", width: 50, align: "center" },
                { header: "제어 진행률(%)", name: "c5_qty", width: 50, align: "center" },
				{ header: "발주율(%)", name: "c4_qty", width: 50, align: "center" }
            ]
        };
        //----------
        ...
        //=====================================================================================
        var args = {
            targetid: "grdData_미진행", query: "SCM_8050_2", title: "BOM 내역",
            height: "100%", pager: false, show: true, selectable: true, caption:true,
            element: [
				{ header: "Section", name: "c1_str", width: 40, align: "left" },
                { header: "Module", name: "c2_str", width: 40, align: "left" },
                { header: "Assembly", name: "c3_str", width: 80, align: "left" },
				{ header: "품목코드", name: "item_no", width: 50, align: "center" },
				{ header: "품명", name: "item_nm", width: 130, align: "left" },
				{ header: "규격", name: "item_spec", width: 170, align: "left" },
				{ header: "수량", name: "bom_qty", width: 30, align: "center", mask: "numeric-int" }
			]
        };
        //----------
        gw_com_module.gridCreate(args);
