...
var gw_job_process = {
    ...
    UI: function () {
        ...
        var args = { targetid: "lyrMenu", type: "FREE",
            element: [
				...
				{ name: "추가", value: "고분보 추가/수정", icon: "추가" },
				{ name: "닫기", value: "닫기" }
			]
        };
        ...
        //==== Main Grid : 발생 내역
        var args = { targetid: "grdData_현황", query: "QDM_6310_M_1", title: "NCR 처리 내역",
            ...
            element: [
				...
				{ header: "관리번호", name: "issue_no", width: 75, align: "center" },
				{ header: "발행번호", name: "rqst_no", width: 75, align: "center" },
				{ header: "고장분석번호", name: "tar_rqst_no", width: 75, align: "center" },
    ...
    procedure: function () {
        ...
        gw_com_module.eventBind(args);
        function click_lyrMenu_추가(ui) { processTAR(ui); }
        //----------
...
function processTAR(param) {
    ...
    var RqstNo = gw_com_api.getValue("grdData_현황", row, "tar_rqst_no", true);
    var IssueNo = gw_com_api.getValue("grdData_현황", row, "issue_no", true);
    ...
    if (view) {
        if (RqstNo > "" && RqstNo != "undefined") {
            args.data.param.push({ name: "AUTH", value: "R" });
        } else {
            return false;
        }
    }
