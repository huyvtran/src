...
var gw_job_process = {
    ...
    UI: function () {
        ...
        //=====================================================================================
        var args = {
            targetid: "grdList_1", query: "EHM_2151_1", title: "부품별 분석/수리 진행 현황",
            height: 440, caption: false, show: true, selectable: true, number: true, pager: false, footer: true,
            element: [
                { header: "품목명", name: "data_nm", width: 350 },
                { header: "반출소요기간", name: "dat01", width: 150, align: "right", mask: "numeric-float", summary: { type: "avg", title: "평균" } },
                { header: "작업시작소요기간", name: "dat02", width: 150, align: "right", mask: "numeric-float", summary: { type: "avg", title: "평균" } },
                { header: "작업소요기간", name: "dat03", width: 150, align: "right", mask: "numeric-float", summary: { type: "avg", title: "평균" } },
        ...
        //----------
        $("#grdList_1_data").jqGrid("footerData", "set", { data_nm: "평균" });
        ...
        //=====================================================================================
        var args = {
            targetid: "grdList_2", query: "EHM_2151_2", title: "부품별 분석/수리 진행 현황",
            show: false,
            element: [
                { header: "품목명", name: "data_nm", width: 350 },
                { header: "반출소요기간", name: "dat01", width: 150, align: "right", mask: "numeric-float" },
                { header: "작업시작소요기간", name: "dat02", width: 150, align: "right", mask: "numeric-float" },
                { header: "작업소요기간", name: "dat03", width: 150, align: "right", mask: "numeric-float" },
                { name: "data_cd", hidden: true }
            ]
        };
        //----------
...
function processRetrieve(param) {
    ...
    var args = {
        source: {
            ...
            argument: [
                { name: "arg_rpt_sub_tp", value: "PART" }
            ],
            remark: [
...
function processPopup(param) {
    ...
    v_global.event.search = {
        ...
        rpt_tp: gw_com_api.getValue("frmOption", 1, "rpt_tp"),
        dept_cd: "",
        part_cd: data_cd
    };
    var args = {
        type: "PAGE", page: "EHM_2153", title: "현황",
