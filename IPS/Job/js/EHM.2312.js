                ...
                row: [
                    {
                        element: [
                            ...
                            { name: "rqst_dt", mask: "date-ymd", editable: { type: "text", validate: { rule: "required" } } },
                    ...
                    },
                    {
                        element: [
                            ...
                            {
                                name: "rqst_title", format: { type: "text", width: 1022 },
                                editable: { type: "text", width: 1022 }, style: { colspan: 7 }
                            }
                        ]
                    },
                    {
                        element: [
                            ...
                            { name: "issue_cnt", editable: { type: "text" } },
                    ...
                    },
                    {
                        element: [
                            ...
                            { name: "man_cnt", editable: { type: "text" } },
        ...
        var args = { targetid: "grdData_Sub", query: "EHM_2312_S_1", title: "담당 부서",
            ...
            element: [
				...
				},
				{
				    ...
				    editable: {
				        type: "select", data: { memory: "재발방지" }, validate: { rule: "required" }
