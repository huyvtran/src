...
var gw_job_process = {
    ...
    UI: function () {
        ...
        //==== Grid : Main ====
        var args = { targetid: "grdData_Main", query: "SPC_5010_M_1", title: "업체별 공정능력 현황",
            ...
            element: [
				{ header: "협력사", name: "supp_nm", width: 120, align: "left"},
				{ header: "품목분류", name: "part_grp_nm", width: 100, align: "center" },
				{ header: "입고수량", name: "part_qty", width: 46, align: "center", mask: "numeric-int" },
				{ header: "Best", name: "grade1_cnt", width: 44, align: "center" },
				{ header: "Acceptable", name: "grade2_cnt", width: 46, align: "center" },
				{ header: "Enough", name: "grade3_cnt", width: 44, align: "center" },
				{ header: "Poor", name: "grade4_cnt", width: 44, align: "center" },
				{ header: "Bad", name: "grade5_cnt", width: 44, align: "center" },
        ...
        //==== Grid : Sub ====
        var args = { targetid: "grdData_Sub", query: "SPC_5010_S_1", title: "항목별 상세",
            caption: true, height: 200, show: true, selectable: true, dynamic: true,
            color: { row: true }, pager: false,
            element: [
				{ header: "품목", name: "part_nm", width: 150, align: "left"},
				{ header: "검사항목", name: "qcitem_nm", width: 100, align: "center" },
				{ header: "공정능력판정", name: "qcgrade_nm", width: 60, align: "center" },
				{ header: "불량확률(%)", name: "summary01", width: 70, align: "center" },
				{ header: "Cpk", name: "summary02", width: 50, align: "center" },
				{ header: "평균", name: "summary03", width: 50, align: "center" },
				{ header: "표준편차", name: "summary04", width: 60, align: "center" },
				{ header: "규격상한", name: "summary05", width: 60, align: "center" },
				{ header: "규격하한", name: "summary06", width: 60, align: "center" },
				{ name: "ymd_fr", hidden: true },
				{ name: "ymd_to", hidden: true },
				{ name: "supp_cd", hidden: true },
				{ name: "part_grp", hidden: true },
        ...
        //==== Grid : Detail ====
        var args = { targetid: "grdData_Detail1", query: "SPC_5010_D_1", title: "판정기준",
        ...
        //==== Grid : Detail2 입고현황  ====
        var args = { targetid: "grdData_Detail2", query: "SPC_5010_D_2", title: "입고 현황",
            ...
            element: [
				...
				{ header: "Part No.", name: "part_no", width: 80, align: "left"}
			]
        };
        gw_com_module.gridCreate(args);
