    ...
    UI: function () {
            ...
            content: {
                row: [
                        ...
                        },
                        {
                            element: [
                                {
                                    name: "qc_dept", label: { title: "담당부서 :" },
                                    editable: { type: "text", size: 12 }
                                },
                                {
                                    name: "qc_usr", label: { title: "담당자/업체 :" },
                                    editable: { type: "text", size: 12 }
                                },
                                {
        ...
        var args = {
            ...
            element: [
                ...
                //},
                { header: "처리유형", name: "rqst_tp_nm", width: 90, align: "center" },
                ...
                {
                    header: "처분자", name: "disp_usr_nm", width: 60, align: "center",
                ...
                {
                    header: "처분비고", name: "disp_rmk", width: 300,
                ...
                {
                    header: "출고유형", name: "recarry_tp", width: 60, align: "center",
                ...
                { header: "담당부서", name: "qc_dept_nm", width: 100, align: "center" },
                { header: "담당자<br/>/ 업체", name: "qc_usr_nm", width: 60, align: "center" },
                { header: "분석<br/>진행일", name: "qc_dt", width: 70, align: "center", mask: "date-ymd" },
                { header: "처리구분", name: "qc_tp_nm", width: 60, align: "center" },
                { header: "귀책구분", name: "duty_tp_nm", width: 60, align: "center" },
                { header: "처리비고", name: "qc_rmk", width: 300 },
        ...
        var args = {
            ...
            element: [
                ...
                { header: "처분일", name: "disp_dt", width: 100, align: "center", mask: "date-ymd" },
                { header: "처분자", name: "disp_usr_nm", width: 60 },
                { header: "처분유형", name: "disp_tp_nm", width: 60, align: "center" },
                { header: "처분비고", name: "disp_rmk", width: 300 },
                { header: "담당부서", name: "qc_dept_nm", width: 100, align: "center" },
                { header: "담당자/업체", name: "qc_usr_nm", width: 60, align: "center" },
                { header: "분석진행일", name: "qc_dt", width: 70, align: "center", mask: "date-ymd" },
                { header: "처리구분", name: "qc_tp_nm", width: 60, align: "center" },
                { header: "귀책구분", name: "duty_tp_nm", width: 60, align: "center" },
                { header: "처분비고", name: "qc_rmk", width: 180 },
...
function processKeyup(param) {
    ...
    if (param.object == "grdData_Main") {
        if (param.element == "disp_usr_nm" || param.element == "restock_usr_nm") {
            if (event.keyCode == 46) {
