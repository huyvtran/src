...
var gw_job_process = {
    ...
    UI: function () {
                            ...
                            element: [
                                ...
                                },
                                {
                                    ...
                                    editable: { type: "select", 
                                        data: { memory: "설비모듈", unshift: [{ title: "전체", value: "%" }] } }
                                }                                
                            ]
                        },
                        {
        ...
        //==== Main Grid
        var args = {
            targetid: "grdData_Main", query: "EOM_5170_M_1", title: "설비별 가동율",
            caption: true, width: "100%", height: "250", pager: false, show: true,
            element: [
				{ header: "설비", name: "eq_cd", width: 50, align: "center" },
                { header: "모듈", name: "eq_module", width: 50, align: "center" },
				{ header: "Run(hr)", name: "run_time", width: 50, align: "center" },
                { header: "Run(%)", name: "run_time_per", width: 50, align: "center" },
				{ header: "H/W Modify(hr)", name: "modify_time", width: 50, align: "center" },
                { header: "H/W Modify(%)", name: "modify_time_per", width: 50, align: "center" },
				{ header: "계측(hr)", name: "measure_time", width: 50, align: "center" },
                { header: "계측(%)", name: "measure_time_per", width: 50, align: "center" },
				{ header: "Down(hr)", name: "down_time", width: 50, align: "center" },
                { header: "Down(%)", name: "down_time_per", width: 50, align: "center" },
				{ header: "Idle(hr)", name: "idle_time", width: 50, align: "center" },
                { header: "Idle(%)", name: "idle_time_per", width: 50, align: "center" },
        ...
        //==== Main Chart
        var args = {
            targetid: "lyrChart_Main", query: "EOM_5170_C_1", title: "설비별 가동율", show: true,
        ...
        //==== Sub Grid
        var args = {
            targetid: "grdData_Sub", query: "EOM_5170_M_2", title: "모듈별 가동율",
            caption: true, width: "100%", height: "100%", pager: false, show: true,
            element: [
				{ header: "모듈", name: "eq_module", width: 80, align: "center" },
				{ header: "Run(hr)", name: "run_time", width: 80, align: "center" },
                { header: "Run(%)", name: "run_time_per", width: 80, align: "center" },
				{ header: "H/W Modify(hr)", name: "modify_time", width: 80, align: "center" },
                { header: "H/W Modify(%)", name: "modify_time_per", width: 80, align: "center" },
				{ header: "계측(hr)", name: "measure_time", width: 80, align: "center" },
                { header: "계측(%)", name: "measure_time_per", width: 80, align: "center" },
				{ header: "Down(hr)", name: "down_time", width: 80, align: "center" },
                { header: "Down(%)", name: "down_time_per", width: 80, align: "center" },
				{ header: "Idle(hr)", name: "idle_time", width: 50, align: "center" },
                { header: "Idle(%)", name: "idle_time_per", width: 50, align: "center" },
				{ name: "ymd_fr", hidden: true },
				{ name: "ymd_to", hidden: true },
        ...
        //==== Sub Chart
        var args = {
            targetid: "lyrChart_Sub", query: "EOM_5170_C_2", title: "모듈별 가동율", show: true,
        ...
        var args = {
            target: [
				{ type: "GRID", id: "grdData_Main", offset: 2, min: true },
				{ type: "GRID", id: "grdData_Sub", offset: 2, min: true },
				{ type: "LAYER", id: "lyrChart_Main", offset: 2, min: true },
				{ type: "LAYER", id: "lyrChart_Sub", offset: 2, min: true }
			]
        };
     ...
     var args = {
        source: { type: "FORM", id: "frmOption", hide: true,
            ...
            remark: [
		        ...
		        { element: [{ name: "chart" }] }, { element: [{ name: "eq_cd" }] }
            ]
        },
        target: [
