...
var gw_job_process = {
    ...
    ready: function () {
        ...
        function start() {
            ...
            gw_com_api.setValue("frmOption", 1, "pstat", "3");
    ...
    UI: function () {
        ...
        var args = {
            ...
            element: [
                ...
                { name: "rep_dept", editable: { type: "hidden" }, hidden: true }
            ]
        };
...
function processKeyup(param) {
    ...
    if (param.object == "grdData_Main") {
        if (param.element == "qc_dept_nm" || param.element == "qc_usr_nm" || param.element == "rep_dept_nm") {
            if (event.keyCode == 46) {
...
function processSendMail(param) {
    ...
    var args = {
        type: "PAGE", page: "EHM_2110_MAIL", title: "담당자 지정 통보",
