...
var gw_job_process = {
    ...
    UI: function () {
        ...
        //=====================================================================================
        var args = {
            targetid: "grdData_AS_점검결과", query: "DLG_ISSUE_S_9", title: "추정요인 및 점검결과",
            caption: true, height: "100%", pager: false, show: true, selectable: true, number: true,
            element: [
				{ header: "순번", name: "issue_seq", width: 30, align: "center", hidden: true },
				{ header: "점검일자", name: "chk_dt", width: 70, align: "center", mask: "date-ymd" },
				{ header: "추정요인 OR 점검항목", name: "chk_rmk1", width: 200 },
				{ header: "기준", name: "chk_rmk2", width: 150 },
        ...
        //=====================================================================================
        var args = {
            targetid: "grdData_PO_점검결과", query: "DLG_ISSUE_S_9", title: "추정요인 및 점검결과",
        ...
        //=====================================================================================
        var args = {
            targetid: "grdData_QD_점검결과", query: "DLG_ISSUE_S_9", title: "추정요인 및 점검결과",
            caption: true, height: "100%", pager: false, show: false, selectable: true, number: true,
            element: [
				{ header: "순번", name: "issue_seq", width: 30, align: "center", hidden: true },
				{ header: "점검일자", name: "chk_dt", width: 70, align: "center", mask: "date-ymd" },
        ...
        //=====================================================================================
        var args = {
            targetid: "grdData_AS_교체내역", query: "DLG_ISSUE_S_5", title: "교체 내역",
            ...
            element: [
				...
				{ header: "부품상태", name: "part_stat", width: 80, align: "center" },
				...
				{ header: "OUT Ser. No(기장착부품)", name: "apart_sno", width: 150, align: "center" },
				...
				{ header: "구매요청", name: "charge_cs", width: 70, align: "center", format: { type: "checkbox", title: "", value: 1, offval: 0 } },
				...
				{ header: "성적표 파일", name: "file_nm", width: 200, align: "left", hidden: true },
				//{ header: "순번", name: "issue_seq", width: 35, align: "center" },
				////{ header: "교체구분", name: "change_tp", width: 70, align: "center" },
				//{ header: "부품상태", name: "part_stat", width: 60, align: "center" },
				//{ header: "교체일자", name: "change_dt", width: 80, align: "center", mask: "date-ymd" },
				//{ header: "수급시간", name: "change_time", width: 60, align: "center" },
				//{ header: "수량", name: "change_qty", width: 50, align: "center", mask: "numeric-int" },
				//{ header: "기장착부품군(OUT)", name: "apart_tp", width: 110, align: "center" },
				//{ header: "기장착부품(OUT)", name: "apart_cd", width: 120, align: "center" },
				//{ header: "기장착부품명(OUT)", name: "apart_nm", width: 200, align: "left" },
				//{ header: "제조사", name: "apart_supp", width: 100, align: "center" },
				//{ header: "모델", name: "apart_model", width: 150, align: "center" },
				//{ header: "규격(REV)", name: "apart_rev", width: 150, align: "center" },
				//{ header: "비고(REV)", name: "apart_rmk", width: 300, align: "left" },
				//{ header: "OUT Ser. No(기장착부품)", name: "apart_sno", width: 150, align: "center" },
				//{ header: "교체부품군(IN)", name: "bpart_tp", width: 110, align: "center" },
				//{ header: "교체부품(IN)", name: "bpart_cd", width: 120, align: "center" },
				//{ header: "교체부품명(IN)", name: "bpart_nm", width: 200, align: "left" },
				//{ header: "제조사", name: "bpart_supp", width: 100, align: "center" },
				//{ header: "모델", name: "bpart_model", width: 150, align: "center" },
				//{ header: "규격(REV)", name: "bpart_rev", width: 150, align: "center" },
				//{ header: "비고(REV)", name: "bpart_rmk", width: 300, align: "left" },
				//{ header: "IN Ser. No(교체부품)", name: "bpart_sno", width: 150, align: "center" },
...
function toggleObject(param) {
        ...
        case "AS":
            {
                ...
                gw_com_api.hide("grdData_PO_점검결과");
                ...
                gw_com_api.hide("grdData_QD_점검결과");
        ...
        case "PO":
            {
                ...
                gw_com_api.hide("grdData_AS_점검결과");
    ...
    if (tp == "AS") {
        gw_com_api.show("grdData_" + tp + "_점검결과");
    }
