...
var gw_job_process = {
    ...
    UI: function () {
        ...
        var args = { targetid: "grdData_현황", query: "ECCB_5050_M_1", title: "진행 Status",
            caption: true, width: 500, height: 450, pager: true, show: true,
            element: [
				{ header: "업체명", name: "series", width: 90, align: "center" },
				{ header: "module", name: "category", width: 90, align: "center" },
                { header: "제조요청일", name: "", width: 90, align: "center", mask: "date-ymd" },
                { header: "완료예정일", name: "", width: 90, align: "center", mask: "date-ymd" }
			]
        };
        //----------
