...
var gw_job_process = {
    ...
    UI: function () {
        ...
        //=====================================================================================
        var args = {
            targetid: "grdData_목록", query: "w_sys1050_S_1", title: "코드선택",
            height: "160", show: true, key: true,
            element: [
        ...
        //=====================================================================================
        var args = {
            targetid: "grdData_목록2", query: "w_sys1050_S_1", title: "코드선택",
            height: "160", show: true, key: true, multi: true, checkrow: true,
            element: [
				{ header: "코드", name: "dcode", width: 50, align: "center" },
...
function informResult(param) {
    ...
    if (v_global.logic.multi) {
        ...
        args.data = {
            ...
            pos_nm: gw_com_api.getValue("grdData_목록", "selected", "pos_nm", true),
            user_id: gw_com_api.getValue("grdData_목록", "selected", "user_id", true),
            user_nm: gw_com_api.getValue("grdData_목록", "selected", "dname", true)
        };
    }
    gw_com_module.streamInterface(args);
        ...
        case gw_com_api.v_Stream.msg_openedDialogue:
            {
                ...
                if (param.data != undefined) {
                    ...
                    if (param.data.dcode
                        != gw_com_api.getValue("frmOption", 1, "dcode")) {
                        gw_com_api.setValue("frmOption", 1, "dcode", param.data.dcode);
                        retrieve = true;
                    }
                    if (param.data.dname
                        != gw_com_api.getValue("frmOption", 1, "dname")) {
                        gw_com_api.setValue("frmOption", 1, "dname", param.data.dname);
                        retrieve = true;
                    }
                    if (param.data.multi) {
