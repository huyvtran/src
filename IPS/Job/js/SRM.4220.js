                ...
                row: [
                    ...
                    },
                    {
                        element: [
                            ...
                            { name: "rmk", editable: { type: "text", width: 1020 }, style: { colspan: 11 } }
                        ]
                    }
                ]
            }
        ...
        var args = {
            ...
            element: [
				...
				{ header: "규격", name: "item_spec", width: 120, align: "left"
					, editable: { type: "hidden" } },
				{ header: "Tracking", name: "track_no", width: 60, align: "center"
					, editable: { type: "hidden" } },
				...
				{ header: "검수결과", name: "chk_result", width: 40, align: "center"
					, format: { type: "select", data: { memory: "검수결과" } }
					, editable: { type: "select", data: { memory: "검수결과" }, width: 55
