...
var gw_job_process = {
    ...
    UI: function () {
                ...
                row: [
                    {
                        element: [
                            ...
                            {
                                name: "ymd_fr", label: { title: "PO일자 :" }, mask: "date-ymd", style: { colfloat: "floating" },
        ...
        var args = {
            ...
            caption: true, height: 248, pager: true, show: true, selectable: true, number: true, dynamic: true,
            element: [
        ...
        var args = {
            ...
            editable: { multi: true, bind: "select", focus: "file_desc2", validate: true },
            element: [
                {
