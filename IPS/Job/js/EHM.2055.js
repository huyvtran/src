...
var gw_job_process = {
    ...
    UI: function () {
        ...
        var args = { targetid: "grdData_현황", query: "EHM_2054_M_1", title: "DOWNTIME 지표",
            ...
            element: [
				...
				{ header: "Warranty", name: "wrnt_io", width: 50, align: "center" },
				...
				{ header: "발생번호", name: "issue_no", width: 100, align: "center", hidden: true },
				{ header: "발생번호 1", name: "issue_no1", width: 100, align: "center", hidden: true },
				{ header: "발생번호 2", name: "issue_no2", width: 100, align: "center", hidden: true },
				{ header: "발생번호 3", name: "issue_no3", width: 100, align: "center", hidden: true },
				{ header: "발생번호 4", name: "issue_no4", width: 100, align: "center", hidden: true },
				{ header: "발생번호 5", name: "issue_no5", width: 100, align: "center", hidden: true },
				{ header: "발생번호 6", name: "issue_no6", width: 100, align: "center", hidden: true },
				{ header: "발생번호 7", name: "issue_no7", width: 100, align: "center", hidden: true },
    ...
    procedure: function () {
        ...
        function rowdblclick_grdData_현황(ui) {
            ...
            if (v_global.event.element == "status1" && gw_com_api.getValue("grdData_현황", "selected", "issue_no1", true) > " ") {
        ...
        gw_com_api.setValue("frmOption", 1, "prod_subtp", "SINGLE");
        //----------
