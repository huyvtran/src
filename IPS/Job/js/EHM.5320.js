...
var gw_job_process = {
    ...
    UI: function () {
        ...
        var args = {
            targetid: "grdData_분류2", query: "EHM_5320_S_1", title: "라인별",
            caption: true, width: 216, height: 200, pager: false, show: true,
            element: [
        ...
        var args = {
            targetid: "grdData_분류3", query: "EHM_5320_S_2", title: "호기별",
            caption: true, width: 216, height: 200, pager: false, show: true,
            element: [
        ...
        var args = {
            targetid: "grdData_분류4", query: "EHM_5320_S_3", title: "현상별",
            caption: true, width: 216, height: 200, pager: false, show: true,
            element: [
        ...
        var args = {
            targetid: "lyrChart_분류1", query: "EHM_5320_M_1", show: true,
        ...
        var args = {
            targetid: "lyrChart_분류2", query: "EHM_5320_S_1", show: true,
        ...
        var args = {
            targetid: "lyrChart_분류3", query: "EHM_5320_S_2", show: true,
            format: { view: "1", rotate: "0", reverse: "1" },
        ...
        var args = {
            targetid: "lyrChart_분류4", query: "EHM_5320_S_3", show: true,
            format: { view: "1", rotate: "0", reverse: "0" },
