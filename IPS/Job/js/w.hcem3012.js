...
var gw_job_process = {
    ...
    UI: function () {
		...
		//=====================================================================================
        var args = {
            targetid: "grdData_국내비율",
            query: "w_hcem3010_S_2_2",
            title: "비율 내역",
            height: "100%",
            pager: false,
            show: true,
...
function getObject(param) {
    ...
    switch (param.name) {
		...
		case "비율":
            return ((use == "1") ? "grdData_해외비율" : "grdData_국내비율");
    }
    return "";
