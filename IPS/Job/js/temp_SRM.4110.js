...
var gw_job_process = {
    ...
    UI: function () {
        ...
        //==== Search Option : 
        var args = {
            targetid: "frmOption", type: "TABLE", title: "조회 조건"//, trans: true
            , border: true,caption:false,selectable:true,
            show: true,// remark: "lyrRemark",
            editable: { focus: "ymd_fr", validate: true },
            content: { width: { label: 80, field: 50 },
                row: [
                        {
                            element: [
                                { header: true, value: "납품일자", format: { type: "label" } },
                                { name: "ymd_fr", editable: { type: "text" }, mask: "date-ymd" },
                                { header: true, value: " ~ ", format: { type: "label" } },
                                { name: "ymd_to", editable: { type: "text" }, mask: "date-ymd" },
                        ...
                        {
                            element: [
                                { header: true, value: "납품서 번호", format: { type: "label" } },
                                {
                                    name: "div_no", editable: { type: "text", width: 500 }, format: { width: 500 },
                                    style:{colspan:3}
                                },
                                { header: true, value: "발주번호", format: { type: "label" } },
                                { name: "pur_no", editable: { type: "text",tidth:500 } },
                                /*
                                {
        ...
        var args = {
            ...
            caption: true, height: "100%", pager: true, show: true, key: true, number: true, multi: true, checkrow: true,
            element: [
        ...
        var args = {
            target: [
                ...
                { type: "FORM", id: "frmOption", offset: 8 }
