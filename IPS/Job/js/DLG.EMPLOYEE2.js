                        ...
                        element: [
                            {
                                ...
                                editable: { type: "select", data: { memory: "구분" } }, hidden: true
                            },
				            {
...
function processResult(param) {
    ...
    $.each(ids, function () {
        data.emp_no += (data.emp_no == "" ? "" : "^") + gw_com_api.getValue("grdList_RECEIVER", this, "emp_no", true);
        data.emp_nm += (data.emp_nm == "" ? "" : "^") + gw_com_api.getValue("grdList_RECEIVER", this, "emp_nm", true);
        data.dp_nm += (data.dp_nm == "" ? "" : ", ") + gw_com_api.getValue("grdList_RECEIVER", this, "dp_nm", true);
    });
    var args = {
        ID: gw_com_api.v_Stream.msg_closeDialogue,
        data: data
