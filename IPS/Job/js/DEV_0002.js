...
var gw_job_process = {
    ...
    UI: function () {
        ...
        //=====================================================================================
        var args = { targetid: "grdData_목록", query: "DEV_0002_1", title: "DEV_0002_1",
            height: 442, show: true, selectable: true, dynamic: true, key: true,
            editable: { multi: true, bind: "select", focus: "role_id", validate: true },
            element: [
                { header:"USER_ID", name: "USER_ID", width: 70, align: "center" },
                { header:"USER_NM" ,name: "USER_NM", width: 70, align: "center" },
                { header: "USER_TP", name: "USER_TP", width: 70, align: "center" },
                { header: "USER_PW", name: "USER_PW", width: 70, align: "center" },
                { header: "LOGIN_ID", name: "LOGIN_ID", width: 70, align: "center" },
                { header: "EMP_NO", name: "EMP_NO", width: 70, align: "center" },
                { header: "ROLE_ID", name: "ROLE_ID", width: 70, align: "center" },
                { header: "USE_YM", name: "USE_YM", width: 70, align: "center" },
                { header: "SYSTEM_ID", name: "SYSTEM_ID", width: 70, align: "center" },
                { header: "KNAME", name: "KNAME", width: 70, align: "center" },
                { header: "NODE_CODE", name: "NODE_CODE", width: 70, align: "center" },
                { header: "SNO", name: "SNO", width: 70, align: "center" },
                { header: "NODE_SHARE", name: "NODE_SHARE", width: 70, align: "center" },
                { header: "DEPT_CODE", name: "DEPT_CODE", width: 70, align: "center" },
                { header: "DEPT_NAME", name: "DEPT_NAME", width: 70, align: "center" },
                { header: "CUST_CODE", name: "CUST_CODE", width: 70, align: "center" },
                { header: "PASSWD", name: "PASSWD", width: 70, align: "center" },
                { header: "ON_FLAG", name: "ON_FLAG", width: 70, align: "center" },
                { header: "ON_DATE", name: "ON_DATE", width: 70, align: "center" },
                { header: "ON_TIME", name: "ON_TIME", width: 70, align: "center" },
                { header: "PFF_DATE", name: "OFF_DATE", width: 70, align: "center" },
                { header: "OFF_TIME", name: "OFF_TIME", width: 70, align: "center" },
                { header: "GROUP_ID", name: "GROUP_ID", width: 70, align: "center" },
                { header: "REMARK", name: "REMARK", width: 70, align: "center" },
                { header: "WSNO", name: "WSNO", width: 70, align: "center" },
                { header: "WDATE", name: "WDATE", width: 70, align: "center" },
                { header: "WTIME", name: "WTIME", width: 70, align: "center" },
                { header: "USNO", name: "USNO", width: 70, align: "center" },
                { header: "UPDATE", name: "UPDATE", width: 70, align: "center" },
                { header: "UTIME", name: "UTIME", width: 70, align: "center" },
                { header: "CUST_POSITION1", name: "CUST_POSITION1", width: 70, align: "center" },
                { header: "MAIL_YN", name: "MAIL_YN", width: 70, align: "center" },
                { header: "USERID", name: "USERID", width: 70, align: "center" },
                { header: "SUP", name: "SUP", width: 70, align: "center" },
                { header: "POS_NAME", name: "POS_NAME", width: 70, align: "center" },
                { header: "SCM_YN", name: "SCM_YN", width: 70, align: "center" }
                ]
				...
				{ header: "사업부", name: "node_code", width: 80, align: "center",
				    format: { type: "select",
				...
				{ header: "사업부 권한", name: "node_share", width: 100, align: "center",
				    format: { type: "select",
