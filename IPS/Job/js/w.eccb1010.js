                ...
                row: [
                        ...
                        element: [
                              ...
                              { header: true, value: "사업부", format: { type: "label" } },
                              {
                                  ...
                                  editable: {
                                      ...
                                      change: [{ name: "act_module1_sel", memory: "분류2", key: ["dept_area"] }
                    ...
                    },
                    {
                        element: [
                            ...
                            {
                                name: "ecr_tp",
                                editable: { type: "select", data: { memory: "ECR구분", unshift: [{ title: "-", value: "" }] }, validate: { rule: "required" } }
                            }
                        ]
                    },
                    {
                        element: [
                            ...
                            { header: true, value: "작성자/부서", format: { type: "label" } },
                            {
                                ...
                                name: "ecr_emp", display: true,
                                editable: { type: "select", data: { memory: "사원" }, width: 70 }
                            },
                            {
                                style: { colfloat: "floated" },
                                name: "ecr_dept", display: true,
                    ...
                    },
                    {
                        element: [
                            ...
                            { name: "rqst_dept", editable: { type: "select", data: { memory: "부서" }, validate: { rule: "required" } } },
                    ...
                    },
                    {
                        element: [
                            ...
                            {
                                style: { colspan: 3 }, name: "act_effect",
...
function successApproval(response, param) {
    ...
    var FormId = 45;
    if (DeptArea == "DP") FormId = 88;
    else if (DeptArea == "SOLAR") FormId = 87;
    else FormId = 45;

    if (DeptArea == "SMC") {
        switch (gw_com_api.getValue("frmData_내역", 1, "ecr_tp")) {
            case "20":  //긴급
                FormId = "115";
                break;
            case "30":  //기술제안
