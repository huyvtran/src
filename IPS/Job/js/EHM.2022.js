    ...
    UI: function () { 
                    ...
                    },
                    {
                        element: [
                            { header: true, value: "발생현상", format: { type: "label" } },
                            {
                                ...
                                editable: { type: "text", width: 1008, validate: { rule: "required", message: "발생현상" } }
                            }
                        ]
                    },
                    {
                ...
                row: [
                    {
                        element: [
                            ...
                            {
                                name: "rmk_text",
                                format: { type: "textarea", rows: 7, width: 1008 },
                                editable: { type: "textarea", rows: 7, width: 1008 }
                            },
                ...
                row: [
                    {
                        element: [
                              ...
                              {
                                  name: "rmk_text",
                                  format: { type: "textarea", rows: 4, width: 1008 }//,
                                  //editable: { type: "textarea", rows: 10, width: 1008 }
                              },
                              { name: "rmk_cd", hidden: true, editable: { type: "hidden" } },
                              { name: "issue_no", hidden: true, editable: { type: "hidden" } }
                        ]
        ...
        var args = {
            ...
            memory: "교체구분"
				...
				{
				    header: "기장착부품군(OUT)", name: "apart_tp", width: 120, align: "center", format: { type: "select", data: { memory: "부품군" } },
				    editable: {
				        validate: { rule: "required" }, type: "select",
				        data: {
				...
				{
				    header: "교체부품군(IN)", name: "bpart_tp", width: 120, align: "center", format: { type: "select", data: { memory: "부품군" } },
				    editable: {
				        validate: { rule: "required" }, type: "select",
				        data: {
				            memory: "부품군", unshift: [{ title: "-", value: "" }], push: [{ title: "기타", value: "기타" }],
                ...
                row: [
                    {
                        element: [
                            { header: true, value: "교체내용", format: { type: "label" } },
                            {
                                name: "rmk_text",
                                format: { type: "textarea", rows: 4, width: 1008 },
                                editable: { type: "textarea", rows: 4, width: 1008 }
                            },
                            { name: "rmk_cd", hidden: true, editable: { type: "hidden" } },
                            { name: "issue_no", hidden: true, editable: { type: "hidden" } }
                        ]
                ...
                row: [
                    ...
                    },
                    {
                        element: [
                            ...
                            { style: { colspan: 5 }, name: "rslt_rmk1", format: { type: "textarea", rows: 5, width: 1008 } }
                        ]
                    },
                    {
                        element: [
                            { header: true, value: "특이사항", format: { type: "label" } },
                            { style: { colspan: 5 }, name: "rslt_rmk2", format: { type: "textarea", rows: 5, width: 1008 } },
