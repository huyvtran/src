...
var gw_job_process = {
    ...
    UI: function () {
        ...
        var args = { targetid: "frmData_D1", query: "w_eccb2020_S_2", type: "TABLE", title: "협의 안건",
            ...
            content: { width: { label: 120, field: 230 }, height: 25,
                row: [
                    {
                        element: [
    ...
    procedure: function () {
        ...
        function click_lyrMenu_Sub_상세(ui) {
            ...
            //var url = "w_info_eccb_item.aspx?root_type=" + root_type + "&ecr_no=" + ecr_no;
            var url = "w_link_eccb_item.aspx?data_key=" + ecr_no;
            window.open(url, "", "");
