                ...
                row: [
                    ...
                    },
                    {
                        element: [
                            ...
                            { name: "rqst_user_nm", format: { type: "text", width: 128, maxlength: 10, validate: { rule: "required" } } },
                            { header: true, value: "직급", format: { type: "label" } },
                            { name: "rqst_user_pos", format: { type: "text", width: 128, maxlength: 10, validate: { rule: "required" } } },
                            { header: true, value: "E-Mail", format: { type: "label" } },
                            { name: "rqst_user_email", format: { type: "text", width: 166, maxlength: 100, validate: { rule: "required" } } }
                        ]
                    },
                    {
                        element: [
                    ...
                    },
                    {
                        element: [
                            ...
                            { name: "chg_dtl_tp", format: { type: "text", width: 414, maxlength: 100 }, style: { colspan: 3 } },
                    ...
                    },
                    {
                        element: [
                            ...
                            { name: "issue_title", format: { type: "text", width: 1002 }, style: { colspan: 7 } }
                        ]
                    },
                    {
                        element: [
