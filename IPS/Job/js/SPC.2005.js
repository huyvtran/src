    ...
    ready: function () {
        ...
        var args = { request: [ 
				...
				{ type: "PAGE", name: "QCPART_SUPP", query: "DDDW_SPC_QCPART",
				    param: [{ argument: "arg_hcode", value: "IPS-POP"}] },
				...
				{ type: "INLINE", name: "협력사", data: [ {title: "IPS(제조)", value: "IPS-POP"} ] },
                { type: "INLINE", name: "보기",
                    data: [
						{ title: "축약", value: "S" },
						{ title: "확장", value: "L" }
...
//                            	, data: { memory: "QCITEM_SUPP", unshift: [ { title: "전체", value: "" } ] } }
        ...
        var args = { targetid: "grdData_메뉴", query: "SPC_2000_M_1", title: "검사 내역",
            caption: true, width: 570, height: 508, show: true, selectable: true, dynamic: true,
            element: [
                    ...
                    { element: [
                            ...
                            { name: "part_no",
                              editable: { type: "select", validate: { rule: "required", message: "Part No." }
                            	, data: { memory: "QCPART_SUPP", unshift: [{ title: "-", value: ""}] }
                                , change: [{ name: "qcitem_cd", memory: "QCITEM_SUPP", key: ["part_no"], unshift: [{ title: "-", value: ""}]}]
								}
							},
                    ...
                    { element: [
                            ...
                            { name: "qcitem_cd",
                              editable: { type: "select", validate: { rule: "required", message: "검사항목" },
                                  data: { memory: "QCITEM_SUPP", key: ["part_no"], unshift: [{ title: "-", value: ""}] }
								} 
							},
...
//                    { element: [
//                            { header: true, value: "QC Seq", format: { type: "label"} },
//                            { name: "qc_seq", editable: { type: "text" } },
//                            { header: true, value: "supp_cd", format: { type: "label"} },
...
//                    }
        ...
        var args = { targetid: "grdData_권한", query: "SPC_2000_S_2", title: "검사 결과",
            ...
            element: [
                ...
                { header: "Value.", name: "qc_value", width: 80, align: "center", mask: "numeric-float"
                	, editable: { type: "text"} },
...
//        gw_com_module.eventBind(args);
        ...
        gw_com_api.setValue("frmOption", 1, "supp_cd", "IPS-POP");
...
function processLink(param) {
    ...
    if (param.master) {
        args = { key: param.key,
	        source: { type: "GRID", id: "grdData_메뉴", row: "selected", block: true,
...
function processInsert(param) {
    ...
    if (param.sub) {
	    ...
	    gw_com_api.setValue("frmData_상세", 1, "supp_cd", gw_com_api.getValue("frmOption", 1, "supp_cd"), false );
	}
}
//----------
