<%@ Page Title="" Language="C#" MasterPageFile="~/Master/Page_14.master" AutoEventWireup="true"
    CodeFile="w_eccb4010_supp.aspx.cs" Inherits="Job_w_eccb4010_supp" %>

<asp:Content ID="Content1" ContentPlaceHolderID="objContentHead" runat="Server">
    <link id="style_theme" href="" rel="stylesheet" type="text/css" />
    <script src="js/w.eccb4010.supp.js" type="text/javascript"></script>
...
<asp:Content ID="Content7" ContentPlaceHolderID="objContentMenu" runat="Server">
    <table width="100%" cellpadding="0" cellspacing="0">
        <tr>
            <td align="right" width="820"></td>
            <td align="right" width=""><div id="lyrInput"></div></td>
            <td align="right" width="170"><div id="lyrMenu_1"></div></td>
        </tr>
    </table>
</asp:Content>
