<%@ Page Title="" Language="C#" MasterPageFile="~/Master/Control_13.master" AutoEventWireup="true"
    CodeFile="ECCB_5040.aspx.cs" Inherits="JOB_ECCB_5040" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="objContentHead" runat="Server">
    ...
    <script src="js/ECCB.5040.js" type="text/javascript"></script>
...
<asp:Content ID="Content8" ContentPlaceHolderID="objContentData_2" runat="Server">
    <div id="grdData_상세현황" style="height: 19px; width: 100%" Height="250px">
    </div>
</asp:Content>
