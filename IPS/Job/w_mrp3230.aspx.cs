...
public partial class Job_w_mrp3230 : System.Web.UI.Page
{
    ...
    public static string Update(cSaveData DATA)
    {
        ...
        try
        {
            ...
            //---------------------------------------------------------------------------
            if (DATA.getFirst().getQuery() == "EHM_2312_M_1" && DATA.getFirst().getFirst().getType() == typeQuery.INSERT)
            {
