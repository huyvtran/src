<%@ Page Title="" Language="C#" MasterPageFile="~/Master/Control_13.master" AutoEventWireup="true"
    CodeFile="SCM_8090.aspx.cs" Inherits="JOB_SCM_8090" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="objContentHead" runat="Server">
    ...
    <script src="js/SCM.8090.js" type="text/javascript"></script>
...
<asp:Content ID="Content6" ContentPlaceHolderID="objContentControl_1" runat="Server">
    <div id="lyrChart_통계">
        <dxchartsui:WebChartControl ID="ctlChart_1" runat="server" Height="500px" Width="700px"
