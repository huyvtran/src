...
public partial class Job_w_srm1041 : System.Web.UI.Page
{
    ...
    public static string Print(cRetrieveData DATA)
    {
        ...
        try
        {
            ...
            string strTarget = strRoot + "Report/" + strPage + "/" + strPage + "_" + strUser + "_" + strKey;
            ...
            try
            {
                ...
                while (objDr.Read())
                {
                    ...
                    objWorkSheet.Cells[iRow, 13] = objDr["proj_no"].ToString();
                    objWorkSheet.Cells[iRow, 15] = objDr["prc_cd"].ToString();
                    objWorkSheet.Cells[iRow, 17] = objDr["pur_unit"].ToString();
                    objWorkSheet.Cells[iRow, 19] = Convert.ToDecimal(objDr["dlv_qty"]);
                    objWorkSheet.Cells[iRow, 21] = objDr["req_date"].ToString();
                    ...
                    objRange.MergeCells = true;
                    objRange.HorizontalAlignment = Excel.XlHAlign.xlHAlignCenter;
                    objRange = objWorkSheet.get_Range("S" + iRow.ToString(), "T" + iRow.ToString());
                    objRange.MergeCells = true;
                    objRange.HorizontalAlignment = Excel.XlHAlign.xlHAlignCenter;
                    objRange = objWorkSheet.get_Range("U" + iRow.ToString(), "V" + iRow.ToString());
                    objRange.MergeCells = true;
                    objRange.HorizontalAlignment = Excel.XlHAlign.xlHAlignCenter;
                    objRange = objWorkSheet.get_Range("B" + iRow.ToString(), "V" + iRow.ToString());
            ...
            try
            {
                ...
                strReturn = new JavaScriptSerializer().Serialize(
                                new entityProcessed<string>(
                                    ...
                                    strPage + "_" + strUser + "_" + strKey + "." + strPrint)
                            );
            }
            catch (Exception ex)
            {
