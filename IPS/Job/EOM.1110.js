...
function checkRemovable(param) {
	...
	gw_com_api.messageBox([ { text: "작업 중입니다." } ]);
	return;
    ...
    else gw_com_api.messageBox([ { text: "REMOVE" } ], 420, gw_com_api.v_Message.msg_confirmRemove, "YESNO", param);
...
function processRemove(param) {
    ...
    var obj = (param.detail) ? "grdData_4" : ((param.sub) ? "grdData_3" : "grdData_2");
    var args = {
        url: "COM",
        procedure: "PROC_DELETE_ISSUE_DIV",
        nomessage: true,
        input: [
            { name: "user", value: gw_com_module.v_Session.USR_ID, type: "varchar" }, { name: "type", value: "R&D", type: "varchar" }, { name: "hcode", value: gw_com_api.getValue(obj, "selected", "hcode", true), type: "varchar" }, { name: "dcode", value: gw_com_api.getValue(obj, "selected", "dcode", true), type: "varchar" }
        ],
        output: [
            { name: "r_value", type: "int" }, { name: "message", type: "varchar" }
        ],
        handler: {
