...
var gw_job_process = {
    ...
    ready: function () {
        ...
        //alert("v_Session.strAnn_key : " + v_Session.strAnn_key.toString());
        //alert('값 받는중..');
        ...
        // login
        //~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
        var userid = "recuser";             //gw_com_api.getPageParameter("user_id")
        var password = hex_md5("recuser");  //gw_com_api.getPageParameter("passwd")
        //alert('1');
        var args = {
            request: "PAGE",
        ...
        function successSession(data) {
            ...
            var menu_id = v_Session.strAnn_key < "ANN2015-0005" ? "HRM_8000" : "HRM_8000_1";
            //----------
            var args = {
                request: "PAGE",
        ...
        function successMenu(data) {
            ...
            /*
             strAnn_key = <%=serializer.Serialize(strAnn_key)%>;
             strAnn_Seq = <%=serializer.Serialize(strAnn_Seq)%>;
             strApp_key = <%=serializer.Serialize(strApp_key)%>;

            */

            var ann_key = v_Session.strAnn_key;
            var ann_seq = v_Session.strAnn_Seq;
            var app_key = v_Session.strApp_key;
           

            //var ann_key = gw_com_api.getPageParameter("ann_key");
            //var ann_seq = gw_com_api.getPageParameter("ann_seq");
            //var app_key = gw_com_api.getPageParameter("app_key");

            var args = data[0].DATA[column.menu_args];
            args="&ann_key=" + ann_key + "&ann_seq=" + ann_seq + "&app_key=" + app_key;
