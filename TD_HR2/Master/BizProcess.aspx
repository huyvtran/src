...
<asp:Content ID="Content1" ContentPlaceHolderID="objMasterHead" runat="Server">
    ...
    <script src="js/master.biz.js" type="text/javascript"></script>
    ...
    <table id="lyrMaster" border="0" width="1200px" cellspacing="0" cellpadding="0" style="padding: 0;
        ...
        <tr>
            <td width="100%" valign="bottom">
                ...
                <table border="0" width="100%" cellspacing="0" cellpadding="0" style="padding: 0; margin: 0; white-space: nowrap;">
                    <tr>
                        <td align="left" style="padding-left: 10px;"><img src="../style/images/master/Main_Log.gif" width="100" border="0" alt="Main"/></td>
                                    ...
                                    <td valign="top">
                                        <div class="workarea_bg">
                                            ...
                                            <div id="lyrAdd">
                                                ...
                                                <!-- Notice End -->
                                                <!-- Approval Start -->
                                               <div id="lyrAppr" style="width: 510px; float:left; overflow: hidden; margin-top:300px; margin-left:5px;">
                                                    <table border="0" width="100%" cellpadding="2" cellspacing="0">
                                                        <tr>
                                                            <td colspan="3" align="left">
                                                                <img id="imgAppr" src="../style/images/master/main_appr_list.png" alt="결재현황" style="cursor: pointer;" />
                                                            
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td>
                                                                <table id="tblAppr" border="0" cellpadding="2" cellspacing="2" style="margin: 0; padding: 0;">
                                                                </table>
                                                            </td>
                                                        </tr>
                                                    </table>
...
<%--                                                <div id="right_image_area" style="width: 300px; float:right; overflow: hidden; margin-top:300px;">
                                                    <table border="0" width="100%" cellpadding="2" cellspacing="0">
                                                        ...
                                                        <tr>
                                                            <td  align="right">
                                                                <img id="img4" src="../style/images/master/main_srm_02.png" alt="전화" style="cursor: pointer;" onclick="window.open('/Files/Manual/4-2 협력사 매뉴얼(SRM)_APS.pdf');" />                                                            
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td  align="right">
...
--%>
                                ...
                                서울시 용산구 효창원로 6-4 금홍2빌딩 전화 : 02-3272-7200  FAX : 02-3272-7201<br />
                                Copyright(C) 2014 TechData ALL RIGHT RESERVED.
                                        </!--div-->
