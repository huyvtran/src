...
public partial class Job_w_upload_notice : System.Web.UI.Page
{
    string strData = "NOTICE";
    ...
    protected void ctlUpload_FileUploadComplete(object sender, DevExpress.Web.FileUploadCompleteEventArgs e)
    {
        ...
        try
        {
            ...
            //========================== 파일 경로 변경 =============================
            strPath = HttpContext.Current.Server.MapPath("~/Files/NOTICE_FILES") + String.Format("{0:yyyymmdd}", DateTime.Today) + "\\";
            //=======================================================================
