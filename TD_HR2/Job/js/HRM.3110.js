...
var gw_job_process = {
    ...
    UI: function () {
        ...
        var args = {
            ...
            element: [
                ...
                { name: "삭제", value: "삭제" },
                { name: "저장", value: "저장" },
                { name: "일정", value: "일정보고", icon: "기타" },
                { name: "완료", value: "완료보고", icon: "기타" },
                { name: "닫기", value: "닫기" }
			]
        };
        //----------
    ...
    procedure: function () {
        ...
        gw_com_module.eventBind(args);
        //----------
        var args = { targetid: "lyrMenu", element: "일정", event: "click", handler: processButton };
        gw_com_module.eventBind(args);
        //----------
...
function processSendmail(param) {
    ...
    var type = param.element == "일정" ? "ATTEXTRA" : "ATTEXTRA2";
    var ext_no = gw_com_api.getValue("frmData_MAIN", 1, "ext_no");
    var args = {
        url: "COM",
        subject: MailInfo.getSubject({ type: type, ext_no: ext_no }),
        body: MailInfo.getBody({ type: type, ext_no: ext_no }),
        to: MailInfo.getTo({ type: type, ext_no: ext_no }),
        edit: true
    };
...
var MailInfo = {
    getSubject: function (param) {
        ...
        var args = {
            ...
            url: "../Service/svc_Data_Retrieve_JSONs.aspx" +
                    "?QRY_ID=HRM_3110_MAIL" +
                    "&QRY_COLS=val" +
                    "&CRUD=R" +
                    "&arg_field=subject&arg_type=" + param.type + "&arg_ext_no=" + param.ext_no,
            handler_success: successRequest
        };
        //=================== async : false ========================
        $.ajaxSetup({ async: false });
    ...
    getBody: function (param) {
        ...
        var args = {
            ...
            url: "../Service/svc_Data_Retrieve_JSONs.aspx" +
                    ...
                    "&QRY_COLS=val" +
                    "&CRUD=R" +
                    "&arg_field=body&arg_type=" + param.type + "&arg_ext_no=" + param.ext_no,
            handler_success: successRequest
        };
        //=================== async : false ========================
        $.ajaxSetup({ async: false });
    ...
    getTo: function (param) {
        ...
        var args = {
            request: "PAGE",
            url: "../Service/svc_Data_Retrieve_JSONs.aspx" +
                    "?QRY_ID=HRM_3110_MAIL_RECEIVER" +
                    "&QRY_COLS=name,value" +
                    "&CRUD=R" +
                    "&arg_ext_no=" + param.ext_no,
            handler_success: successRequest
        };
        //=================== async : false ========================
        $.ajaxSetup({ async: false });
