...
var gw_job_process = {
    ...
    UI: function () {
        ...
        var args = {
            ...
            caption: false, height: 250, pager: false, show: true, selectable: true, //number: true,
            element: [
                { header: "평가연도", name: "evl_year", width: 80 },
                { header: "평가명", name: "evl_nm", width: 80 },
				//{ header: "평가일자", name: "evl_date", width: 80, align: "center", mask: "date-ymd" },
				{ header: "실적등급", name: "total1_grade", width: 80, align: "center" },
				{ header: "역량등급", name: "total2_grade", width: 80, align: "center" },
                { header: "인센티브 등급", name: "group1_grade", width: 80, align: "center" },
                { header: "연봉조정 등급", name: "group2_grade", width: 80, align: "center" }
    ...
    procedure: function () {
        ...
        gw_com_module.eventBind(args);
        //----------
        var args = { targetid: "lyrMenu", element: "기타", event: "click", handler: processBatch };
        gw_com_module.eventBind(args);
        //=====================================================================================
