...
var gw_job_process = {
    ...
    UI: function () {
        ...
        var args = {
            ...
            content: { width: { label: 80, field: 160 },
                row: [
                    {
                        element: [
                            { header: true, value: "Issue No.", format: { type: "label" } },
                            { name: "issue_no" },
                    ...
                    },
                    {
                        element: [
                            ...
                            { name: "cust_prod_nm", display: true },
                    ...
                    },
                    {
                        element: [
                            ...
                            { header: true, value: "완료일시", format: { type: "label" } },
                            { style: { colfloat: "float" }, name: "end_dt", mask: "date-ymd", format: { type: "text", width: 62 } },
                            { style: { colfloat: "floated" }, name: "end_time", mask: "time-hh", format: { type: "text", width: 30 } }
                        ]
                    },
                    {
                        element: [
                    ...
                    },
                    {
                        element: [
                            ...
                            { style: { colspan: 5 }, name: "as_title", format: { type: "text", width: 734 } }
                        ]
                    },
                    {
                        element: [
                            { header: true, value: "의뢰자", format: { type: "label" } },
                            { name: "remp" },
                    ...
                    {
                        element: [
                            { header: true, value: "의뢰일시", format: { type: "label" } },
                            { name: "rdate" },
                    ...
                    {
                        element: [
                            { header: true, value: "접수내용", format: { type: "label" } },
        ...
        var args = {
            ...
            content: { width: { label: 80, field: 160 }, height: 25,
                row: [
                    {
                        element: [
        ...
        //=====================================================================================
        var args = {
            targetid: "grdData_AS_발생내역", query: "DLG_ISSUE_S_1", title: "Issue 내역",
            caption: true, height: "100%", pager: false, show: true, selectable: true, number: true,
            element: [
				{ header: "Module", name: "prod_sub", width: 80, align: "center" },
				{ header: "주요원인", name: "status_grp", width: 80 },
				{ header: "현상분류", name: "status_tp1", width: 130 },
				{ header: "현상구분", name: "status_tp2", width: 130 },
				{ header: "부위분류", name: "part_tp1", width: 90 },
				{ header: "부위구분", name: "part_tp2", width: 130 },
				{ header: "원인분류", name: "reason_tp1", width: 90 },
				{ header: "원인구분", name: "reason_tp2", width: 130, hidden: true },
				{ header: "귀책분류", name: "duty_tp1", width: 90 },
				{ header: "귀책구분", name: "duty_tp2", width: 130,},
                { name: "prod_type", hidden: true, editable: { type: "hidden" } },
                { name: "issue_seq", hidden: true, editable: { type: "hidden" } },
        ...
        //=====================================================================================
        var args = {
            targetid: "grdData_PO_발생내역", query: "DLG_ISSUE_S_1", title: "발생 내역",
        ...
        //=====================================================================================
        var args = {
            targetid: "grdData_QD_발생내역", query: "DLG_ISSUE_S_1", title: "발생 내역",
            caption: true, height: "100%", pager: false, show: true, selectable: true,
            element: [
                { header: "순번", name: "issue_seq", width: 35, align: "center" },
        ...
        //=====================================================================================
        var args = {
            targetid: "frmData_발생내용", query: "DLG_ISSUE_S_2", type: "TABLE", title: "발생 현상 및 원인",
            width: "100%", show: true, selectable: true,
            content: { height: 25, width: { label: 80, field: 720 },
                row: [
                    {
                        element: [
                            { header: true, value: "발생 현상</br></br>및</br></br>원인", format: { type: "label" } },
                            { name: "rmk_text", format: { type: "textarea", rows: 7, width: 930 } },
                            { name: "issue_no", hidden: true }
                        ]
                    }
                ]
        ...
        //=====================================================================================
        var args = {
            targetid: "grdData_AS_조치내역", query: "DLG_ISSUE_S_3", title: "조치 내역",
            caption: true, height: "100%", pager: false, show: true, selectable: true, number: true,
            element: [
                { header: "Module", name: "prod_sub", width: 80, align: "center" },
				{ header: "조치일자", name: "work_dt", width: 92, align: "center", mask: "date-ymd" },
				{ header: "조치분류", name: "work_tp1", width: 125 },
				{ header: "조치구분", name: "work_tp2", width: 120 },
				{ header: "시작시각", name: "start_time", width: 60, align: "center", mask: "time-hh", editable: { type: "text" } },
				{ header: "종료시각", name: "end_time", width: 60, align: "center", mask: "time-hh", editable: { type: "text" } },
                { header: "완료여부", name: "pstat", width: 50, align: "center" },
                { header: "유상", name: "cost_yn", width: 50, align: "center", format: { type: "checkbox", value: "1", offval: "0" } },
                { header: "작업시간", name: "work_time", width: 60, align: "center", mask: "numeric-float" },
				{ header: "외주업체", name: "work_company", width: 150 },
				{ header: "작업자", name: "work_man1", width: 60, align: "center" },
				{ header: "작업인원", name: "worker_cnt", width: 40, align: "center" },
                { name: "end_dt", hidden: true, editable: { type: "hidden" } },
        ...
        //=====================================================================================
        var args = {
            targetid: "grdData_PO_조치내역", query: "DLG_ISSUE_S_3", title: "조치 내역",
            caption: true, height: "100%", pager: false, show: true, selectable: true,
            element: [
				{ header: "순번", name: "issue_seq", width: 35, align: "center" },
        ...
        //=====================================================================================
        var args = {
            targetid: "grdData_QD_조치내역", query: "DLG_ISSUE_S_3", title: "조치 내역",
            caption: true, height: "100%", pager: false, show: true, selectable: true,
            element: [
				{ header: "순번", name: "issue_seq", width: 35, align: "center" },
				{
        ...
        //=====================================================================================
        var args = {
            targetid: "frmData_조치내용", query: "DLG_ISSUE_S_4", type: "TABLE", title: "조치 내용",
            width: "100%", show: true, selectable: true,
            content: { height: 25, width: { label: 80, field: 720 },
                row: [
                    {
                        element: [
                            { header: true, value: "조치 및 결과", format: { type: "label" } },
                            { name: "rmk_text", format: { type: "textarea", rows: 10, width: 930 } },
                            { name: "issue_no", hidden: true }
                        ]
                    }
                ]
        ...
        //=====================================================================================
        var args = {
            targetid: "grdData_AS_교체내역", query: "DLG_ISSUE_S_5", title: "Issue Parts",
            caption: true, height: "100%", pager: false, show: true, selectable: true, number: true,
            element: [
                { header: "Module", name: "prod_sub", width: 80, align: "center" },
				{ header: "기장착부품코드", name: "apart_cd", width: 120, align: "center", mask: "search" },
				{ header: "기장착부품명", name: "apart_nm", width: 200 },
				{ header: "규격", name: "apart_spec", width: 150 },
				{ header: "기장착부품 Ser.No.", name: "apart_sno", width: 150 },
				{ header: "교체부품코드", name: "bpart_cd", width: 120, align: "center", mask: "search" },
				{ header: "교체부품명", name: "bpart_nm", width: 200, align: "left" },
				{ header: "규격", name: "bpart_spec", width: 150 },
				{ header: "교체부품 Ser.No.", name: "bpart_sno", width: 150 },
				{ header: "수량", name: "change_qty", width: 50, align: "center", mask: "numeric-int" },
				{ header: "유상", name: "charge_cs", width: 70, align: "center", format: { type: "checkbox", value: "1", offval: "0" } },
        ...
        var args = {
            target: [
				{ type: "FORM", id: "frmData_AS_발생정보", offset: 8 },
                { type: "FORM", id: "frmData_PO_발생정보", offset: 8 },
                { type: "FORM", id: "frmData_QD_발생정보", offset: 8 },
				{ type: "GRID", id: "grdData_AS_발생내역", offset: 8 },
				{ type: "GRID", id: "grdData_PO_발생내역", offset: 8 },
				{ type: "GRID", id: "grdData_QD_발생내역", offset: 8 },
				{ type: "FORM", id: "frmData_발생내용", offset: 8 },
				{ type: "GRID", id: "grdData_AS_조치내역", offset: 8 },
				{ type: "GRID", id: "grdData_PO_조치내역", offset: 8 },
				{ type: "GRID", id: "grdData_QD_조치내역", offset: 8 },
				{ type: "FORM", id: "frmData_조치내용", offset: 8 },
				{ type: "GRID", id: "grdData_AS_교체내역", offset: 8 },
				{ type: "GRID", id: "grdData_PO_교체내역", offset: 8 },
				{ type: "GRID", id: "grdData_QD_교체내역", offset: 8 },
...
function processRetrieve(param) {
    ...
    var args = {
        source: {
            ...
            remark: [{ element: [{ name: "issue_no"}] }]
        },
        target: [
			{ type: "FORM", id: getObject({ name: "정보" }) },
            { type: "GRID", id: getObject({ name: "발생" }), select: true },
        ...
        clear: [
			{ type: "GRID", id: getObject({ name: "조치" }) },
			{ type: "GRID", id: getObject({ name: "교체" }) }
		],
        key: param.key
    };
...
function processLink(param) {
    ...
    var args = {
        source: {
            type: "GRID", id: getObject({ name: "발생" }), row: "selected", block: true,
            element: [
...
function processMemo(param) {
    ...
    var args = {
        type: "PAGE", page: "w_find_memo", title: "상세 내용",
        width: 790, height: 400, open: true
    };
