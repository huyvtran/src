...
var gw_job_process = {
    ...
    UI: function () {
        ...
        var args = {
            ...
            element: [
				{ name: "조회", value: (v_global.logic.option ? "조회" : "새로고침"), act: true },
                { name: "저장", value: "저장" },
        ...
        var args = {
            ...
            trans: true, border: true, show: v_global.logic.option, remark: "lyrRemark2",
        ...
        //=====================================================================================
        var args = {
            targetid: "grdData_MAIN", query: "HRM_1110_1", title: "평가이력",
            caption: true, height: 100, pager: false, show: true, selectable: true, number: true,
            element: [
				{ header: "평가연도", name: "evl_year", width: 60, align: "center" },
				...
				{ header: "평가그룹", name: "evl_group_nm", width: 50, align: "center" },
				{ header: "진행상태", name: "evl_status1", width: 50, align: "center" },
        ...
        //=====================================================================================
        var args = {
            targetid: "grdData_SUB", query: "HRM_1110_2", title: "자기평가",
            caption: true, height: 290, pager: false, show: true, selectable: true, number: true,
            editable: { multi: true, bind: "_edit_yn", focus: "item_grade", validate: true },
            element: [
                ...
                {
                    header: "등급", name: "seq1_grade", width: 60, align: "center",
                    editable: { type: "select", data: { memory: "등급", unshift: [{ title: "-", value: "" }] } }
                },
                //{ header: "점수", name: "seq1_point", width: 60, align: "right", mask: "numeric-float" },
        ...
        args = {
            source: {
                ...
                element: [
                    ...
                    { name: "emp_no", argument: "arg_chk_emp" }
                ],
                argument: [
