    ...
    UI: function () {
        ...
        var args = {
            ...
            element: [
                ...
                { header: "1차평가자", name: "seq1_nm", width: 80, align: "center" },
				//{ header: "2차평가", name: "evl_status2", width: 50, align: "center" },
                { header: "2차평가자", name: "seq2_nm", width: 80, align: "center" },
                { header: "평가시작일", name: "fr_date", width: 80, align: "center", mask: "date-ymd" }, //차수별 시작/마감일
                { header: "평가마감일", name: "to_date", width: 80, align: "center", mask: "date-ymd" },
...
//----------
//function processTempSave(param) {
//    var rowIDs = gw_com_api.getRowIDs("grdData_SUB");
//    for (var i in rowIDs) {                                 //added 161014
...
//        v_global.score.val1.push(chkval1);
//        v_global.score.val2.push(chkval2);
//        v_global.score.val3.push(chkval3);
//    }
//}
////----------
...
function successSave(response, param) {
    ...
    //if (param.element == "제출") {
    //    if (!chkStatus(param)) return false;
    //    processBatch({ element: "제출", nomessage: true });
    //} else {
        //response[0].QUERY = "HRM_1120_1";
        //processRetrieve({ key: response });
    //}
