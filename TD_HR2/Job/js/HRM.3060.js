...
var gw_job_process = {
    ...
    UI: function () {
                ...
                row: [
                    ...
                    },
                    {
                        element: [
                            ...
                            { name: "dept_cd", label: { title: "부서 :" }, editable: { type: "text" }, hidden: true },
        ...
        var args = {
            ...
            caption: true, height: 23, pager: false, show: true, selectable: true, number: true,
        ...
        //=====================================================================================
        var args = {
            targetid: "grdList_CHECK", query: "HRM_3060_3", title: "check",
            show: false, selectable: true,
            element: [
        ...
        //=====================================================================================
        var args = {
            targetid: "grdList_EXCEL", query: "HRM_3060_5", title: "업무실적등록_" + gw_com_module.v_Session.USR_NM, show: false,
            element: [
...
function processItemchanged(param) {
    ...
    if (param.object == "grdData_MAIN" && param.element == "work_ymd") {
        if (checkWORKTIME(gw_com_module.v_Session.EMP_NO, gw_com_api.unMask(param.value.current, "date-ym"))) {
            ...
            gw_com_api.messageBox([{ text: "해당연월의 자료가 있습니다." }, { text: "조회 후 수정하세요."}]);
...
function processRetrieveEnd(param) {
    ...
    if (param.object == "grdList_EXCEL") {
        // Excel Export
        gw_com_module.gridDownload({ targetid: param.object, header: false });
    }
    ...
    if (param.object == "lyrMenu_SUB") {
        ...
        args = {
            ...
            data: [
                ...
                { name: "pos_nm", value: gw_com_module.v_Session.POS_NM },
                { name: "pstat", value: "0" },
                { name: "pstat_nm", value: "등록" }
            ],
            clear: [
                { type: "GRID", id: "grdData_SUB" }
            ]
...
function processBatch(param) {
    ...
    if (work_ymd == "" || work_ymd == undefined) {
    ...
    if (param.batch) {
        var args = {
            ...
            input: [
                ...
                { name: "dept_cd", value: "%", type: "varchar" },
...
//----------
function checkWORKTIME(arg_emp_no, arg_work_ymd) {
    ...
    var args = {
        source: {
            ...
            argument: [
                ...
                { name: "arg_work_ymd", value: arg_work_ymd }
            ]
        },
        target: [
            { type: "GRID", id: "grdList_CHECK" }
        ]
    };
    ...
    if (gw_com_api.getValue("grdList_CHECK", 1, "cnt", true) > 0) {
        rtn = false;
    }
