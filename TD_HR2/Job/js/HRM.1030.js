    ...
    UI: function () {
        ...
        var args = {
            ...
            element: [
				...
				{ header: "직종", name: "work_nm", width: 60, align: "center", hidden: true },
				{ header: "직급", name: "grade_nm", width: 60, align: "center" },
				{ header: "호칭", name: "pos_nm", width: 60, align: "center", hidden: true },
        ...
        var args = {
            ...
            element: [
				...
				},
				{
				    ...
				    editable: { type: "text", maxlength: 14, validate: { rule: "required" }, width: 110 }, hidden: true
				},
				{
        ...
        var args = {
            ...
            element: [
				...
				{ header: "취득일", name: "evaluation_date", width: 60, align: "center", mask: "date-ymd" },
            	{ header: "비고", name: "rmk", width: 100, hidden: true }
            ]
        };
        //----------
        gw_com_module.gridCreate(args);
        ...
        var args = {
            ...
            caption: false, height: 250, pager: false, show: true, selectable: true, number: true,
            element: [
				{ header: "구분", name: "award_tp_nm", width: 100 },
				{ header: "훈격 및 징계등급", name: "award_kind", width: 100 },
				{ header: "시작일", name: "s_date", width: 60, align: "center", mask: "date-ymd" },
				{ header: "종료일", name: "e_date", width: 60, align: "center", mask: "date-ymd" },
				{ header: "내용", name: "content", width: 150 }//,
        ...
        var args = {
            ...
            element: [
            	...
            	{ header: "비고", name: "rkm", width: 100, hidden: true }
            ]
        };
        //----------
        gw_com_module.gridCreate(args);
        ...
        case "조회":
            {
                ...
                var args = {
                    type: "PAGE", page: "HRM_1031", title: "사원 검색",
...
function processRetrieveEnd(param) {
    ...
    var img = gw_com_api.getValue("frmData_EMP", 1, "img");
    var ext = gw_com_api.getValue("frmData_EMP", 1, "ext");
    var src = "data:image/" + ext + ";base64," + img;
    $("#ctl00_objContentData_imgPhoto").attr("src", src);
    //$("#ctl00_objContentData_imgPhoto").attr("height", "150px");
    //$("#ctl00_objContentData_imgPhoto").attr("width", "auto");
