...
var gw_job_process = {
    ...
    UI: function () {
        ...
        //=====================================================================================
        var args = {
            targetid: "grdList_MAIN", query: "DLG_APPR_22", title: "결재문서",
    ...
    procedure: function () {
        ...
        gw_com_module.eventBind(args);
        //----------
        var args = { targetid: "grdList_MAIN", grid: true, event: "rowdblclick", handler: processOpenAppr };
        gw_com_module.eventBind(args);
        //=====================================================================================
...
function processOpenAppr(param) {
    if (gw_com_api.getSelectedRow("grdList_MAIN") > 0) {
        //if (gw_com_api.getValue("grdList_MAIN", "selected", "appr_yn", true) != "대기") {
        ...
        if (gw_com_module.dialoguePrepare(args) == false) {
            args.param = {
                ...
                data: {
                    appr_id: gw_com_api.getValue("grdList_MAIN", "selected", "appr_id", true),
                    appr_seq: gw_com_api.getValue("grdList_MAIN", "selected", "appr_seq", true)
                }
            };
