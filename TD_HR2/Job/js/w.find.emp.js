...
var gw_job_process = {
    ...
    ready: function () {
        ...
        function start() {
            ...
            gw_com_api.setValue("frmOption", 1, "ret_yn", "0");
        }
    ...
    UI: function () {
        ...
        //=====================================================================================
        var args = {
            targetid: "grdData_목록2", query: "w_find_emp_M_1", title: "사원 검색",
    ...
    var args = {
        source: {
            ...
            element: [
				...
				{ name: "ret_yn", argument: "arg_ret_yn" }
			]
        },
        target: [
        ...
        case gw_com_api.v_Stream.msg_openedDialogue:
            {
                ...
                if (param.data != undefined) {
                    ...
                    v_global.logic.multi = param.data.multi
                    if (param.data.multi) {
