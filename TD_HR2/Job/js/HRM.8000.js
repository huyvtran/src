...
var gw_job_process = {
    ...
    UI: function () {
        ...
        var args = {
            ...
            height: 210, show: true, caption: true, selectable: true, number: true, // dynamic: true, multi: true, checkrow: true,
        ...
        //=====================================================================================
        var args = {
            targetid: "frmData_자기소개", query: "HRM_8000_02", type: "TABLE", title: "자기소개서 <font color='red'> (각 항목별 1,000자 이내로 입력세요.)</font>",
            caption: true, show: true, selectable: true,
    ...
    procedure: function () {
        ...
        gw_com_module.eventBind(args);
        //----------
        var args = { targetid: "btnMove_6", element: "save", event: "click", handler: processSave };
        gw_com_module.eventBind(args);
        //----------
        var args = { targetid: "btnMove_6", element: "submit", event: "click", handler: processSubmit };
        gw_com_module.eventBind(args);
        //----------
...
function processLogin(param) {
    ...
    var args = {
        ...
        width: 360, height: 260, locate: ["center", "center"], open: true
    };
