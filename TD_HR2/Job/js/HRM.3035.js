...
var gw_job_process = {
    ...
    UI: function () {
        ...
        //=====================================================================================
        var args = {
            targetid: "grdData_BIZTRIP", query: "HRM_3035_2", title: "외근현황",
            caption: true, height: 165, show: true, selectable: true, number: true,// multi: true, checkrow: true,
            editable: { master: true, bind: "_edit_yn", focus: "fr_date", validate: true },
            element: [
                { header: "결재상태", name: "appr_yn_nm", width: 40, align: "center" },
                ...
                {
                    header: "보고서 제목", name: "trip_desc", width: 200,
                    editable: { type: "text", width: 206, maxlength: 98, validate: { rule: "required" } }
                },
                { header: "정산금액", name: "exp_sum", width: 70, align: "right", mask: "numeric-int" },
                { header: "결재자", name: "appr_emp_nm", width: 50, align: "center" },
                { header: "검토자", name: "check_emp_nm", width: 50, align: "center" },
                ...
                { header: "청구번호", name: "expadj_slip", width: 100, editable: { type: "hidden" }, align: "center", hidden: true },
                ...
                { header: "근태중복", name: "dup_chk", width: 250 },
...
function processBatch(param) {
    ...
    if ($.inArray(gw_com_api.getValue("grdData_BIZTRIP", "selected", "appr_yn", true), ["0", "1", "2"]) >= 0) {
...
function checkStat() {
    ...
    return ($.inArray(gw_com_api.getValue("grdData_BIZTRIP", "selected", "appr_yn", true), ["0", "1", "2"]) >= 0 ? false : true);
...
function changeStat(param) {
    ...
    var stat = gw_com_api.getValue("grdData_BIZTRIP", "selected", "appr_yn", true);
    if (stat != "4") return;
    var qry = {
        query: "HRM_3030_2",
        row: [{
