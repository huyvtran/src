    ...
    UI: function () {
        ...
        var args = {
            ...
            element: [
				...
				{ header: "자기평가", name: "evl_status1", width: 50, align: "center" },
				{ header: "1차평가", name: "evl_status2", width: 50, align: "center" },
				{ header: "2차평가", name: "evl_status3", width: 50, align: "center" },
    ...
    switch (arg_evl_seq) {
        case "2":
            args.element = [
                ...
                {
                    header: "자기평가", name: "seq1_grade", width: 60, align: "center",
                ...
                {
                    header: "1차평가", name: "seq2_grade", width: 60, align: "center",
                    format: { type: "select", data: { memory: "등급", unshift: [{ title: "-", value: "" }] } },
                ...
                {
                    header: "2차평가", name: "seq3_grade", width: 60, align: "center",
                    format: { type: "select", data: { memory: "등급", unshift: [{ title: "-", value: "" }] } }
                },
