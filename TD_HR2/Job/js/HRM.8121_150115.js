...
var gw_job_process = {
    ...
    UI: function () {
        ...
        var args = {
            ...
            element: [
				{
				    header: "외국어명", name: "d5_inf01", width: 200,
				    editable: { type: "text", width: 352, validate: { rule: "required" } }
				},
				{
				    header: "회화", name: "d5_inf02", width: 60, align: "center",
				    format: { type: "select", data: { memory: "등급2" }, width: 110 },
				    editable: { type: "select", data: { memory: "등급2" }, width: 110 }
				},
				{
				...
				{
				    header: "TEST명", name: "d5_inf04", width: 200,
				    format: { type: "select", data: { memory: "외국어", unshift: [{ title: "-", value: "" }] }, width: 352 },
				    editable: { type: "select", data: { memory: "외국어", unshift: [{ title: "-", value: "" }] }, width: 352 }
				},
				{
				...
				},
				{
				    ...
				    editable: { type: "text", width: 76, maxlength: 4 }
				},
                { name: "ann_key", editable: { type: "hidden" }, hidden: true },
                { name: "ann_seq", editable: { type: "hidden" }, hidden: true },
                { name: "app_key", editable: { type: "hidden" }, hidden: true },
