...
function processSend(param) {
    ...
    if (eval(opener.processSendMail2)) {
        //opener.focus();
        opener.processSendMail2({ subject: gw_com_api.getValue("frmInput", 1, "subject"), body: convertImgeUrl(gw_com_api.getValue("frmInput", 1, "body")) });
        processSended({}, param);
    }
