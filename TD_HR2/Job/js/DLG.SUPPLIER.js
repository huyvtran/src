...
function informResult() {
    ...
    var args = {
        ID: gw_com_api.v_Stream.msg_selectedSupplier,
        data: {
            supp_cd: gw_com_api.getValue("grdData_목록", "selected", "supp_cd", true),
            supp_nm: gw_com_api.getValue("grdData_목록", "selected", "supp_nm", true),
            biz_no: gw_com_api.getValue("grdData_목록", "selected", "rgst_no", true)
        }
    };
    gw_com_module.streamInterface(args);
        ...
        case gw_com_api.v_Stream.msg_openedDialogue:
            {
                ...
                if (param.data != undefined) {
                    ...
                    if (param.data.supp_nm != "" && param.data.supp_nm != gw_com_api.getValue("frmOption", 1, "supp_nm")) {
