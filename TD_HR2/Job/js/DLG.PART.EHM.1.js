...
var gw_job_process = {
    ...
    UI: function () {
        ...
        var args = {
            ...
            editable: { bind: "open", focus: "part_tp_nm", validate: true }, /*remark: "lyrRemark",*/
            content: {
                row: [
                    {
                        element: [
                            {
                                ...
                                editable: { type: "text", size: 8, maxlength: 20, readonly: true }
                            },
				            //{
				            //    name: "part_tp_nm", label: { title: "부품군 :" },
				            //    editable: { type: "text", size: 12, maxlength: 20, readonly: true }
				            //},
        ...
        //=====================================================================================
        var args = {
            targetid: "grdData_부품", query: "DLG_PART_EHM_M_3", title: "주요 부품",
            height: 300, dynamic: true, show: true, key: true,
            element: [
				{ header: "부품군", name: "part_tp_nm", width: 100, align: "center", hidden: true },
				{ header: "부품코드", name: "part_cd", width: 80, align: "center" },
				{ header: "부품명", name: "part_nm", width: 200, align: "left" },
				//{ header: "규격", name: "part_spec", width: 200, align: "left" },
				{ header: "제조사", name: "part_supp", width: 150, align: "left" },
				{ header: "모델", name: "part_model", width: 150 },
				{ header: "규격(REV)", name: "part_rev", width: 150 },
				{ header: "사용GAS", name: "part_gas", width: 60, align: "center" },
				{ header: "사용유량", name: "part_flux", width: 60, align: "center" },
				{ header: "비고(REV)", name: "rmk", width: 400, align: "left" },
				{ name: "part_tp", hidden: true },
    ...
    procedure: function () {
        ...
        //gw_com_api.setValue("frmOption", 1, "prod_type", "MAHA SP");
    ...
    var args = {
        source: {
            ...
            element: [
				...
				//{ name: "part_tp", argument: "arg_part_tp" }
            ],
            argument: [
                { name: "arg_part_tp", value: "%" }
            ]
        },
        target: [
...
function informResult(param) {
    ...
    var args = {
        ID: gw_com_api.v_Stream.msg_selectedPart_EHM_1,
        data: {
