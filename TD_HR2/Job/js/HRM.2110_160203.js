        ...
        var args = {
            ...
            element: [
				...
				},
				{
				    ...
				    editable: { type: "select", data: { memory: "기부" }, validate: { rule: "required" }, width: 246 }
				},
				{
				    header: "지급처상호", name: "comp_nm", width: 170,
				    editable: { type: "text", maxlength: 20, width: 282 }
				},
				{
				    header: "사업자번호", name: "comp_regno", width: 60, align: "center", mask: "biz-no",
				...
				{
				    header: "전년도이월금액", name: "previous_amt", width: 60, align: "right", mask: "numeric-int",
				    editable: { type: "text", maxlength: 10, width: 102 }, hidden: true
				},
				{
				    header: "이월금액", name: "next_amt", width: 60, align: "right", mask: "numeric-int",
				    editable: { type: "text", maxlength: 10, width: 102 }
				},
				{
				    header: "기부금액", name: "gibu_amt", width: 60, align: "right", mask: "numeric-int",
				    editable: { type: "text", maxlength: 10, width: 102 }
				},
				{
            ...
            element: [
				{
				    ...
				    editable: { type: "select", data: { memory: "소득공제" }, validate: { rule: "required" }, width: 274 }
				},
				{
				    header: "금융기관", name: "bank_cd", width: 150,
				    format: { type: "select", data: { memory: "금융기관" } },
				    editable: { type: "select", data: { memory: "금융기관" }, validate: { rule: "required" }, width: 274 }
				},
				{
				    header: "계좌번호", name: "acnt_no", width: 80,
				    editable: { type: "text", maxlength: 20, width: 150 }
				},
				{
				    header: "납입연차", name: "year_cnt", width: 40, align: "right", mask: "numeric-int",
				    editable: { type: "text", maxlength: 5, width: 78 }
				},
				{
				...
				{
				    header: "비고", name: "rmk", width: 150,
				    editable: { type: "text", maxlength: 50, width: 252 }, hidden: true
				},
                { name: "emp_no", editable: { type: "hidden" }, hidden: true },
                { name: "taxadj_year", editable: { type: "hidden" }, hidden: true },
        ...
        var args = {
            ...
            element: [
				...
				},
				{
				    ...
				    editable: { type: "text", maxlength: 10, validate: { rule: "required" }, width: 90 }, hidden: true
				},
                { name: "emp_no", editable: { type: "hidden" }, hidden: true },
