...
var gw_job_process = {
    ...
    UI: function () {
        ...
        //=====================================================================================
        var args = {
            targetid: "grdData_BIZTRIP", query: "HRM_3030_2", title: "출장현황(국외)",
            ...
            element: [
                ...
                { header: "출장목적", name: "trip_desc", width: 150, editable: { type: "text", maxlength: 100, width: 156 } },
                {
                    ...
                    editable: { type: "text", maxlength: 20, width: 106 }
                },
...
function processDelete(param) {
    ...
    switch (obj) {
        case "":
            if(!($.inArray(gw_com_api.getValue("grdData_BIZTRIP", "selected", "appr_yn", true), ["", "9"]) >= 0 &&
                $.inArray(gw_com_api.getValue("grdData_BIZTRIP", "selected", "appr_yn2", true), ["", "9"]) >= 0)) {
                gw_com_api.messageBox([{ text: "결재중이거나 완료된 내역은 수정할 수 없습니다." }]);
                return;
            }
...
function processBatch(param) {
    ...
    if (opt == "2" && gw_com_api.getValue("grdData_BIZTRIP", "selected", "appr_yn", true) != "2") {
        ...
        return;
    } else if ($.inArray(gw_com_api.getValue("grdData_BIZTRIP", "selected", "appr_yn" + opt, true), ["0", "1", "2", "4"]) >= 0) {
...
function checkStat() {
    ...
    return ($.inArray(gw_com_api.getValue("grdData_BIZTRIP", "selected", "appr_yn2", true), ["0", "1", "2", "5"]) >= 0 ? false : true);
