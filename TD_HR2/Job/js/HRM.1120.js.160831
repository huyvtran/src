...
var gw_job_process = {
    ...
    UI: function () {
        ...
        //=====================================================================================
        var args = {
            targetid: "grdData_MAIN", query: "HRM_1120_1_Test", title: "평가대상자",
...
function successSave(response, param) {
    ...
    if (param.stat) {
        ...
        response[0].QUERY = "HRM_1120_1_Test";
    ...
    switch (param.element) {
        case "제출":
            ...
            for (var i in rowIDs) {                                 //added 160829
                ...
                var chkval1 = gw_com_api.getValue("grdData_SUB", rowIDs[i], "seq1_grade", true);
                var chkval2 = gw_com_api.getValue("grdData_SUB", rowIDs[i], "seq2_grade", true);
                var chkval3 = gw_com_api.getValue("grdData_SUB", rowIDs[i], "seq3_grade", true);
            ...
            if (today < fr_date || today > to_date) {               //added 160830
