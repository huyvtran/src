            ...
            try
            {
                ...
                foreach (string strAppKey in DATA.getOption("APPKEY").Split(','))
                {
                    ...
                    while (objDr.Read())
                    {
                        ...
                        // 인적
                        objWorkSheet.Cells[6, 6] = objDr["ann_cat01"].ToString();   // 구분
                        objWorkSheet.Cells[6, 11] = objDr["ann_cat02"].ToString();   // 지원부문
                        objWorkSheet.Cells[9, 6] = objDr["app_nm_kr"].ToString();   // 성명(한글)
                        objWorkSheet.Cells[9, 11] = objDr["reg_no"].ToString();      // 주민등록번호
                        objWorkSheet.Cells[10, 6] = objDr["app_nm_en"].ToString();  // 성명(영문)
                        objWorkSheet.Cells[10, 11] = objDr["age"].ToString();        // 나이
                        objWorkSheet.Cells[10, 16] = objDr["sex"].ToString();       // 성별
                        objWorkSheet.Cells[11, 6] = objDr["app_nm_cn"].ToString();  // 성명(한자)
                        objWorkSheet.Cells[11, 11] = objDr["email"].ToString();      // E-Mail
                        objWorkSheet.Cells[12, 6] = objDr["addr"].ToString();       // 거주지 주소
                        objWorkSheet.Cells[13, 6] = objDr["tel_no"].ToString();     // 전화번호
                        objWorkSheet.Cells[13, 11] = objDr["mobile_no"].ToString();  // 휴대폰
                        objWorkSheet.Cells[13, 16] = objDr["d1_inf01"].ToString() + " / " + objDr["d1_inf02"].ToString();   // 희망연봉/직위
                        ...
                        // 자기소개
                        objWorkSheet.Cells[446, 3] = "'" + objDr["d1_inf26"].ToString(); // 성장과정(학교생활)
                        objWorkSheet.Cells[456, 3] = "'" + objDr["d1_inf31"].ToString(); // 성격/생활신조
                        objWorkSheet.Cells[466, 3] = "'" + objDr["d1_inf32"].ToString(); // 특기분야
                        objWorkSheet.Cells[476, 3] = "'" + objDr["d1_inf33"].ToString(); // 지원동기
                        objWorkSheet.Cells[486, 3] = "'" + objDr["d1_inf34"].ToString(); // 희망업무/계획
                        ...
                        if (objDr["d1_inf30"].ToString() != "")
                        {
                            ...
                            string imgPath = "http://hr.goodware.co.kr/Files/Recruit/" + objDr["d1_inf30"].ToString();
                    ...
                    while (objDr.Read())
                    {
                        ...
                        objWorkSheet.Cells[17, 9] = objDr["d2_inf04_1"].ToString();   // 고등학교 전공
//                        objWorkSheet.Cells[17, 12] = objDr["d2_inf06_1"].ToString();   // 고등학교 주/야
                        objWorkSheet.Cells[17, 11] = objDr["d2_inf05_1"].ToString();   // 부전공
                        objWorkSheet.Cells[17, 13] = objDr["d2_inf11_1"].ToString();   // ?년제
                        objWorkSheet.Cells[17, 14] = objDr["d2_inf07_1"].ToString();   // 고등학교 졸업구분
                        ...
                        objWorkSheet.Cells[18, 9] = objDr["d2_inf04_2"].ToString();   // 전문대 전공
//                        objWorkSheet.Cells[18, 12] = objDr["d2_inf06_2"].ToString();   // 전문대 주/야
                        objWorkSheet.Cells[18, 11] = objDr["d2_inf05_2"].ToString();   // 부전공
                        objWorkSheet.Cells[18, 13] = objDr["d2_inf11_2"].ToString();   // ?년제
                        objWorkSheet.Cells[18, 14] = objDr["d2_inf07_2"].ToString();   // 전문대 졸업구분
                        objWorkSheet.Cells[18, 15] = objDr["d2_inf08_2"].ToString()+"/"+objDr["d2_inf12_2"].ToString();   // 전문대 소재지
                        ...
                        objWorkSheet.Cells[19, 9] = objDr["d2_inf04_3"].ToString();   // 대학교 전공
//                        objWorkSheet.Cells[19, 12] = objDr["d2_inf06_3"].ToString();   // 대학교 주/야
                        objWorkSheet.Cells[19, 11] = objDr["d2_inf05_3"].ToString();   // 부전공
                        objWorkSheet.Cells[19, 13] = objDr["d2_inf11_3"].ToString();   // ?년제
                        objWorkSheet.Cells[19, 14] = objDr["d2_inf07_3"].ToString();   // 대학교 졸업구분
                        objWorkSheet.Cells[19, 15] = objDr["d2_inf08_3"].ToString()+"/"+objDr["d2_inf12_3"].ToString();   // 대학교 소재지
                        ...
                        objWorkSheet.Cells[20, 9] = objDr["d2_inf04_4"].ToString();   // 대학교 전공
//                        objWorkSheet.Cells[20, 12] = objDr["d2_inf06_4"].ToString();   // 대학교 주/야
                        objWorkSheet.Cells[20, 11] = objDr["d2_inf05_4"].ToString();   // 부전공
                        objWorkSheet.Cells[20, 13] = objDr["d2_inf11_4"].ToString();   // ?년제
                        objWorkSheet.Cells[20, 14] = objDr["d2_inf07_4"].ToString();   // 대학교 졸업구분
                        objWorkSheet.Cells[20, 15] = objDr["d2_inf08_4"].ToString()+"/"+objDr["d2_inf12_4"].ToString();   // 대학교 소재지
                        ...
                        objWorkSheet.Cells[21, 9] = objDr["d2_inf04_8"].ToString();   // 대학원(석사) 전공
//                        objWorkSheet.Cells[21, 12] = objDr["d2_inf06_8"].ToString();   // 대학원(석사) 주/야
                        objWorkSheet.Cells[21, 11] = objDr["d2_inf05_8"].ToString();   // 부전공
                        objWorkSheet.Cells[21, 13] = objDr["d2_inf11_8"].ToString();   // ?년제
                        objWorkSheet.Cells[21, 14] = objDr["d2_inf07_8"].ToString();   // 대학원(석사) 졸업구분
                        objWorkSheet.Cells[21, 15] = objDr["d2_inf08_8"].ToString()+"/"+objDr["d2_inf12_8"].ToString();   // 대학원(석사) 소재지
                        ...
                        objWorkSheet.Cells[22, 11] = objDr["d2_inf10_8"].ToString();   // 대학원(석사) 논문제목
                        ...
                        objWorkSheet.Cells[23, 9] = objDr["d2_inf04_9"].ToString();   // 대학원(박사) 전공
//                        objWorkSheet.Cells[23, 12] = objDr["d2_inf06_9"].ToString();   // 대학원(박사) 주/야
                        objWorkSheet.Cells[23, 11] = objDr["d2_inf05_9"].ToString();   // 부전공 
                        objWorkSheet.Cells[23, 13] = objDr["d2_inf11_9"].ToString();   // ?년제
                        objWorkSheet.Cells[23, 14] = objDr["d2_inf07_9"].ToString();   // 대학원(박사) 졸업구분
                        objWorkSheet.Cells[23, 15] = objDr["d2_inf08_9"].ToString()+"/"+objDr["d2_inf12_9"].ToString();   // 대학원(박사) 소재지
                        ...
                        objWorkSheet.Cells[24, 11] = objDr["d2_inf10_9"].ToString();   // 대학원(박사) 논문제목
                    }
                    objDr.Close();
