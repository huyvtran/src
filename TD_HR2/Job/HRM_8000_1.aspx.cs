...
public partial class JOB_HRM_8000 : System.Web.UI.Page
{
            ...
            for (int iAry = 0; iAry < DATA.getSize(); iAry++)
            {
                ...
                switch (DATA.getObject(iAry).getQuery())
                {
                    ...
                    case "HRM_8000_09": //자격/면허
                        ...
                        break;
                    case "HRM_8000_11": //사회활동
                        {
                            strID = "EMP_RECRUIT_D11";
                            strKey = "rec_seq";
                        }
                        break;
                    default:
    ...
    public static string sendToUserEmail(string pTitle, string pEmail)
    {
        ...
        sb.Append("<td colspan='3'> <img src='http://recruit.techdata.co.kr/recruit/images/applicant_ok_01.png' width='417' height='76' alt=''></td> </tr>");
        sb.Append("<tr> <td rowspan='3' valign='top'> <img src='http://recruit.techdata.co.kr/recruit/images/applicant_ok_02.png' width='161' height='184' alt=''></td>");
        sb.Append("<td colspan='2'> <img src='http://recruit.techdata.co.kr/recruit/images/applicant_ok_03.png' width='256' height='39' alt=''></td> </tr>");
        sb.Append("<tr> <td colspan='2' width='256' height='110' align='center' valign='top'>&nbsp;<b>" + pTitle + "</b></td> </tr>");
        sb.Append("<tr> <td> <img src='http://recruit.techdata.co.kr/recruit/images/applicant_ok_05.png' width='60' height='35' alt=''></td> <td width='196' height='35' align='center'>&nbsp;<b>" + tDay + "</b></td>");
        sb.Append("</tr> <tr> <td colspan='3'> <img src='http://recruit.techdata.co.kr/recruit/images/applicant_ok_07.png' width='417' height='56' alt=''></td> </tr> </table>");

        //bool success = cMail.sendMail(pEmail, "", "[TechData]에 지원해주셔서 감사합니다.", sb.ToString(), true, "smtp_2");
        bool success = mail.sendMail("", pEmail, "[TechData]에 지원해주셔서 감사합니다.", sb.ToString(), true, "smtp_2");
