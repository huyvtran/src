<%@ Page Language="C#" MasterPageFile="~/Master/Page_7.master" AutoEventWireup="true"
    CodeFile="DLG_EMAIL_RECRUIT.aspx.cs" Inherits="Job_DLG_EMAIL_RECRUIT" Title="" ValidateRequest="false" %>
...
<%@ Register assembly="DevExpress.Web.ASPxHtmlEditor.v15.1" namespace="DevExpress.Web.ASPxHtmlEditor" tagprefix="dx" %>
<asp:Content ID="Content1" ContentPlaceHolderID="objContentHead" runat="Server">
    <link id="style_theme" href="" rel="stylesheet" type="text/css" />
    <script src="js/DLG.EMAIL.RECRUIT.js" type="text/javascript"></script>
    <script type="text/javascript">
        var _param = { args: { id: "<%=_args.ClientID%>" } };
        $(function () {
...
<asp:Content ID="Content6" ContentPlaceHolderID="objContentData" runat="Server">
    ...
    <asp:TextBox runat="server" id="_args" ClientIDMode="Static" style="display:none" />
    <form id="frmInput" action=""></form>
    <form id="frmSubject" action=""></form>
    <form id="frmServer" runat="server">
        <div id="lyrControl"style="margin-left:2px;margin-right:4px">
            <dx:ASPxHtmlEditor ID="ASPxctlHTML" runat="server" Width="100%" ClientInstanceName="ctlHTML"
                ...
                <SettingsImageUpload UploadImageFolder="~/Files/EMAIL/Image">
