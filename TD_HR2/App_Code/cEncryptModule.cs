...
public class cEncryptModule : System.Web.UI.Page
{

    private static string strKeyValue;

    public cEncryptModule()
	{
    ...
    protected string EncString
    {
        get
        {
            return ConfigurationManager.ConnectionStrings["EncKey"].ConnectionString;  //문자열 
        }
    }
    #endregion
