        ...
        try
        {
            ...
            if (strModel == "1")
            {
                ...
                try
                {
                    ...
                    objWorkSheet.Cells[2, 1] = "[ " + strName + " ]"; iRow++;
			...
			*/
                        ...
                        while (objDr.Read())
                        {
                            if (!sClass1.Equals(objDr["model_class1"]) && !sClass1.Equals(""))
                            {
                                ...
                                objWorkSheet.Cells[iRow, 2] = "=SUM(B" + iSubRow.ToString() + ":B" + (iRow - 1).ToString() + ")";
                                objWorkSheet.Cells[iRow, 4] = "=SUM(D" + iSubRow.ToString() + ":D" + (iRow - 1).ToString() + ")";
                                objWorkSheet.Cells[iRow, 6] = "=SUM(F" + iSubRow.ToString() + ":F" + (iRow - 1).ToString() + ")";
                                objWorkSheet.Cells[iRow, 8] = "=SUM(H" + iSubRow.ToString() + ":H" + (iRow - 1).ToString() + ")";
                            ...
                            iCol++;
                            objWorkSheet.Cells[iRow, iCol++] = Convert.ToDecimal(objDr["mat_cost"]);
                        ...
                        objWorkSheet.Cells[iRow, iCol++] = fMCost;
                        objWorkSheet.Cells[iRow, iCol++] = Math.Floor(((fAmt - fMCost) / fAmt) * 10000) / 10000;
...
*/
                        ...
                        while (objDr.Read())
                        {
                            ...
                            else if (strDiv != objDr["title_div2"].ToString().Substring(2))
                            {
                                ...
                                objWorkSheet.Cells[iRow, 5] = string.Format("=SUM(E{0}:E{1})", iSubRow.ToString(), (iRow - 1).ToString());
                            ...
                            objWorkSheet.Cells[iRow, 5] = string.Format("=C{0} * D{0}", iRow.ToString());
                        ...
                        if (Convert.ToDecimal(strMngRate) != 0)
                        {
                            ...
                            objWorkSheet.Cells[iRow, 4] = strCell;
                            objWorkSheet.Cells[iRow, 5] = "=D" + iRow.ToString();
                            iRow++;
                            ...
                            objWorkSheet.Cells[iRow, 1] = strDiv + " TOTAL";
                            //objWorkSheet.Cells[iRow++, 5] = fDiv;
                            objWorkSheet.Cells[iRow, 5] = string.Format("=SUM(E{0}:E{1})", (iRow - 1).ToString(), (iRow - 1).ToString());
                            strCellTotal += strCellTotal.Equals("") ? "E" + iRow.ToString() : " + E" + iRow.ToString();
                        ...
                        objWorkSheet.Cells[iRow, 5] = "=INT((" + strCellTotal + ") / 1000) * 1000";
                ...
                try
                {
                    ...
                    for (int iAry = 0; iAry < aryModelNo.Count; iAry++)
                    {
                        ...
                        while (objDr.Read())
                        {
                            ...
                            objRange = objWorkSheet.get_Range("B" + iRow.ToString(), "B" + iRow.ToString());
                            objRange.HorizontalAlignment = Excel.XlHAlign.xlHAlignLeft;				
                            ...
                            objWorkSheet.Cells[iRow, 14] = string.Format("=K{0} * M{0}", iRow.ToString());
                        ...
                        objWorkSheet.Cells[iRow, 11] = string.Format("=SUM(K{0}:K{1})", iSubRow.ToString(), (iRow - 2).ToString());
                        objWorkSheet.Cells[iRow++, 13] = string.Format("=SUM(N{0}:N{1})", iSubRow.ToString(), (iRow - 2).ToString());
...

                    {
                        ...
                        {
                            copyRange = objWorkSheet.get_Range("AA24", "AO24");
                            objRange = objWorkSheet.get_Range("A" + (++iRow).ToString(), "O" + (iRow).ToString());
                            copyRange.Copy(objRange);

                            objWorkSheet.Cells[iRow, 1] = (++iAry).ToString() + ". " + "Managing Cost";

                            copyRange = objWorkSheet.get_Range("AA38", "AO38");
                            objRange = objWorkSheet.get_Range("A" + (++iRow).ToString(), "O" + (iRow).ToString());
                            copyRange.Copy(objRange);

                            copyRange = objWorkSheet.get_Range("AA39", "AO40");
                            objRange = objWorkSheet.get_Range("A" + (++iRow).ToString(), "O" + (iRow+1).ToString());
                            copyRange.Copy(objRange);

                            objWorkSheet.Cells[iRow, 1] = "Managing Cost";
                            objWorkSheet.Cells[iRow, 13] = Convert.ToDecimal(objDr["est_amt"]);

                            fAmt += Convert.ToDecimal(objDr["est_amt"]);

                            iRow+=2;

                            copyRange = objWorkSheet.get_Range("AA41", "AO42");
                            objRange = objWorkSheet.get_Range("A" + iRow.ToString(), "O" + (++iRow).ToString());
                            copyRange.Copy(objRange);
                        ...
                        if (objDr.Read() && Convert.ToInt32(objDr["cnt"]) > 0)
                        {
                            ...
                            objWorkSheet.Cells[iRow, 1] = (++iAry).ToString() + ". " + "Profit";
                            ...
                            objWorkSheet.Cells[iRow, 1] = "Profit";
                            objWorkSheet.Cells[iRow, 13] = Convert.ToDecimal(objDr["est_amt"]);
