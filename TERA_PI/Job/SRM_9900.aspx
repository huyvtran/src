<%@ Page Title="" Language="C#" MasterPageFile="~/Master/Page_7.master" AutoEventWireup="true"
    CodeFile="SRM_9900.aspx.cs" Inherits="Job_SRM_9900" %>

<%@ Register assembly="Microsoft.ReportViewer.WebForms, Version=11.0.0.0, Culture=neutral, PublicKeyToken=89845dcd8080cc91" namespace="Microsoft.Reporting.WebForms" tagprefix="rsweb" %>

<asp:Content ID="Content1" ContentPlaceHolderID="objContentHead" runat="Server">
    <link id="style_theme" href="" rel="stylesheet" type="text/css" />
    <script src="js/SRM.9900.js" type="text/javascript"></script>
...
<asp:Content ID="Content3" ContentPlaceHolderID="objContentMenu" runat="Server">
    ...
    <div id="lyrReportViewer">
        <rsweb:ReportViewer ID="ReportViewer1" runat="server" Font-Names="굴림" Font-Size="Small" PageCountMode="Actual" Visible="False">
        </rsweb:ReportViewer>
    </div>
</asp:Content>
