<%@ Page Language="C#" MasterPageFile="~/Master/Page_7.master" AutoEventWireup="true"
    CodeFile="w_edit_html.aspx.cs" Inherits="Job_w_edit_html" Title="" %>
...
<asp:Content ID="Content6" ContentPlaceHolderID="objContentData" runat="Server">
    ...
    <div id="lyrControl">
        <dx:ASPxHtmlEditor ID="ASPxctlHTML" runat="server" Width="100%" ClientInstanceName="ctlHTML"
            ClientVisible="False" Height="500px" EnableTheming="True" Font-Names="굴림체" 
            Font-Size="9pt" Theme="Default">
                    ...
                    <Items>
                        ...
                        <dx:ToolbarFontNameEdit>
                            <Items>
                                ...
                                <dx:ToolbarListEditItem Text="돋움" Value="돋움" />
                                <dx:ToolbarListEditItem Text="돋움체" Value="돋움체" />
                                <dx:ToolbarListEditItem Text="맑은고딕" Value="맑은고딕" />
            ...
            <SettingsHtmlEditing AllowScripts="True" EnablePasteOptions="True" EnterMode="BR">
            </SettingsHtmlEditing>
            <SettingsDialogs>
                <InsertImageDialog ShowMoreOptionsButton="False">
                    <SettingsImageUpload UploadFolder="~/EDIT_FILES/images/" UploadImageFolder="~/EDIT_FILES/images/">
                    </SettingsImageUpload>
                    <SettingsImageSelector>
                        <EditingSettings TemporaryFolder="~/Files/FileManagerTemp" />
                    </SettingsImageSelector>
                </InsertImageDialog>
            </SettingsDialogs>
        </dx:ASPxHtmlEditor>
