<%@ Page Title="" Language="C#" MasterPageFile="~/Master/Page_9.master" AutoEventWireup="true"
    CodeFile="DEV_0206.aspx.cs" Inherits="JOB_DEV_0206" %>

<asp:Content ID="Content1" ContentPlaceHolderID="objContentHead" runat="Server">
    <link id="style_theme" href="" rel="stylesheet" type="text/css" />
    <script src="js/DEV.0206.js" type="text/javascript"></script>
...
<asp:Content ID="Content4" ContentPlaceHolderID="objContentOption" runat="Server">
    <table>
        <tr>
            <td>
                <div id="lyrMenu_down" align ="left"></div>
            </td>
            <td>
                <div id="lyrMenu_dept" align ="left"></div>
            </td>
        </tr>
    </table>
</asp:Content>
