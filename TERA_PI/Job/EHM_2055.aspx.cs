...
public partial class JOB_EHM_2055 : System.Web.UI.Page
{
    ...
    public static string Print(cExcelData DATA)
    {
        ...
        try
        {
            ...
            // 소스파일 및 생성파일명 설정
            string strIndex = "Down";

            string strRoot = HttpContext.Current.Server.MapPath("~/");
            string strSource = strRoot + "Report/" + strPage + "/" + strPage + ".xls";
            string strTarget = strRoot + "Report/" + strPage + "/" + strPage + "_" + strIndex;
            string strPrint = strPage + "_" + strIndex + "." + strType;
            ...
            try
            {
                ...
                while (objDr.Read())
                {
                    ...
                    {
                        objBaseRange = objBaseSheet.get_Range("A4", "B10");
                    ...
                    // Data Row 작성
                    objBaseRange = objBaseSheet.get_Range("C4", "C10");
