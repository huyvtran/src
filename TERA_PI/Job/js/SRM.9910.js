...
var gw_job_process = {
    ...
    UI: function () {
                ...
                row: [
                    {
                        element: [
                            {
                                name: "ymd_fr", label: { title: "처리일자 :" }, mask: "date-ymd", style: { colfloat: "floating" },
        ...
        //=====================================================================================
        var args = {
            targetid: "grdList_MAIN", query: "SRM_9910_1", title: "ERP정입고 I/F 오류 현황",
            ...
            element: [
				...
				{ header: "입고수량", name: "in_qty", width: 50, align: "right", mask: "numeric-int" },
                { header: "처리자", name: "emp_nm", width: 50, align: "center" },
				{ header: "처리일자", name: "proc_date", width: 80, align: "center", mask: "date-ymd" },
                { header: "처리결과", name: "proc_yn_nm", width: 80, align: "center" },
                { header: "오류내용", name: "err_msg", width: 300 },
				{ name: "seq", hidden: true },
				{ name: "proc_yn", hidden: true },
    ...
    args = {
        source: {
            ...
            element: [
                ...
                { name: "proc_yn", argument: "arg_proc_yn" }
            ],
            remark: [
