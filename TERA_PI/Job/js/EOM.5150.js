...
var gw_job_process = {
    ...
    ready: function () {
        ...
        var args = { request: [
				...
				{  type: "INLINE", name: "통계유형",
				    data: [
						{ title: "가동시간", value: "EQRUNT" },
						{ title: "가동율", value: "EQRUNR" },
						{ title: "다운시간", value: "EQDOWNT" },
						{ title: "다운율", value: "EQDOWNR" },
						{ title: "Wafer사용량", value: "EQWAFER" },
						{ title: "Gas사용량", value: "EQGAS" }
					]
				},
    ...
    UI: function () {
        ...
        var args = { targetid: "grdData_Main", query: "EOM_5150_M1", title: "운영 설비",
            caption: true, width: 200, height: 230, pager: false, show: true,
            element: [
        ...
        var args = { targetid: "grdData_Sub", query: "EOM_5150_S1", title: "상세내역",
            caption: true, width: 1100, height: 140, pager: false, show: true,
            element: [
				{ header: "호기", name: "eq_no", width: 80, align: "center" },
