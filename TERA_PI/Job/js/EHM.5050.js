...
var gw_job_process = {
    ...
    procedure: function () {
                ...
                case "ISSUE-STATUS":
                    {
                        args.data.param.push(
                            ...
                            { name: "status_nm1", value: status_nm = gw_com_api.getValue("grdData_현황", "selected", "category", true) }
                        );
                    }
                    break;
                case "ISSUE-PART":
        ...
        function rowdblclick_grdData_상세현황(ui) {
            var dept_area = gw_com_api.getValue("frmOption", 1, "dept_area") == "%" ? "&#37" : gw_com_api.getValue("frmOption", 1, "dept_area");
            var args = {
                ID: gw_com_api.v_Stream.msg_linkPage,
                to: {
                    type: "MAIN"
