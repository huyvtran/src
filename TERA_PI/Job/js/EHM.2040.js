...
var gw_job_process = {
    ...
    UI: function () {
            ...
            content: { row: [
                    ...
                    },
                    {
                        element: [
                            ...
                            { name: "cust_proc", label: { title: "PROCESS :" }, hidden: true },
        ...
        //=====================================================================================
        var args = { targetid: "grdData_현황", query: "EHM_2040_M_1", title: "부품 교체 내역",
    ...
    procedure: function () {
        ...
        if (v_global.process.param != "") {
            ...
            gw_com_api.setValue("frmOption", 1, "issue_type", gw_com_api.getPageParameter("issue_type"));
...
function processRetrieve(param) {
    ...
    var args = {
        ...
        target: [
			{ type: "GRID",
			    id: "grdData_현황",
                query: (v_global.process.param != "") ? "EHM_2040_M_1" : "EHM_2040_M_1",
