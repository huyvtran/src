...
var gw_job_process = {
    ...
    UI: function () {
        ...
        //==== Grid : Main ====
        var args = { targetid: "grdData_Main", query: "EOM_2200_M_1", title: "설비 다운 이력",
            ...
            element: [
				...
				{ header: "등록자", name: "issue_user", width: 80, align: "center" },
				{ header: "현상분류", name: "status_tp1_nm", width: 80, align: "center" },
				{ header: "상세분류", name: "status_tp2_nm", width: 80, align: "center" },
        ...
        //==== Form : Main ====
        var args = { targetid: "frmData_Sub", query: "EOM_2200_S_1", type: "TABLE", title: "다운 내역",
