...
var gw_job_process = {
    ...
    UI: function () {
        ...
        var args = {
            tabid: "lyrFrame",
            target: [
				{ type: "PAGE", id: "QDM_5520", title: "품질지수통계", launch: true },
				{ type: "PAGE", id: "QDM_5521", title: "VOC 상세 정보" },
				{ type: "PAGE", id: "QDM_5522", title: "Top3 불량 현황" },
				{ type: "PAGE", id: "QDM_5523", title: "설비 불량 지수" },
				//{ type: "PAGE", id: "QDM_5524", title: "설비 다운 지수" },
				{ type: "PAGE", id: "QDM_5510", title: "품질지수현황" }
			]
        };
...
streamProcess = function (param) {
    switch (param.ID) {
        case gw_com_api.v_Stream.msg_linkTabPage: {
                var arg = "";
