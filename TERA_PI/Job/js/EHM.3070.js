...
var gw_job_process = {
    ...
    UI: function () {
        ...
        //============  Buttons : lyrMenu_측정 : 측정항목
        var args = {
            targetid: "lyrMenu_측정", type: "FREE",
            element: [
				{ name: "추가", value: "추가" },
				{ name: "삭제", value: "삭제" }
            ]
            ...
            content: {
                row: [
                    ...
                    },
                    {
                        element: [
                            {
                                name: "issue_title", label: { title: "제목 :" },
                                editable: { type: "text", size: 50 }
                            }
                        ]
                    },
                    {
        ...
        //============  grdData_정보 : 접수 정보
        var args = {
            targetid: "grdData_정보", query: "EHM_3070_M_1", title: "접수 정보",
            ...
            element: [
				...
				{ header: "Process", name: "cust_proc", width: 80 },
                { header: "제품유형", name: "prod_type", width: 80 },
                { header: "제목", name: "issue_title", width: 250 },
				{ header: "처리상태", name: "pstat", width: 80, align: "center" },
				{ header: "접수자", name: "aemp_nm", width: 70, align: "center" },
				{ header: "작성일시", name: "upd_dt", width: 160, align: "center" }
			]
        };
        gw_com_module.gridCreate(args);
        //============  frmData_내역 : 접수 내역
        var args = {
            targetid: "frmData_내역", query: "EHM_3070_M_2", type: "TABLE", title: "접수 내역",
                ...
                row: [
                    {
                        element: [
                            ...
                            {
                                name: "issue_tp",
                                editable: { type: "select", data: { memory: "분류", unshift: [{ title: "-", value: "" }] } }
                            }
                        ]
                    },
                    {
                        element: [
                            { header: true, value: "고객사", format: { type: "label" } },
                            {
                                name: "cust_cd",
                                editable: {
                                    type: "select", data: { memory: "고객사", unshift: [{ title: "-", value: "" }] },
                            ...
                            { header: true, value: "LINE", format: { type: "label" } },
                            {
                                name: "cust_dept",
                                editable: {
                                    type: "select", data: { memory: "LINE", unshift: [{ title: "-", value: "" }], key: ["cust_cd"] }
                                }
                            },
                            { header: true, value: "Process", format: { type: "label" } },
                            {
                                name: "cust_proc",
                                editable: {
                                    type: "select", data: { memory: "PROCESS", unshift: [{ title: "-", value: "" }] }
                                }
                            }
                        ]
                    },
                    {
                        element: [
                            ...
                            { name: "cust_emp", editable: { type: "text" } },
                    ...
                    },
                    {
                        element: [
                            ...
                            { name: "adept_nm", editable: { type: "hidden" }, display: true },
                            { name: "adept", editable: { type: "hidden" }, hidden: true },
                            { header: true, value: "접수자", format: { type: "label" } },
                            { name: "aemp_nm", editable: { type: "hidden" }, display: true },
                            { name: "aemp", editable: { type: "hidden" }, hidden: true },
                            { header: true, value: "작성일시", format: { type: "label" } },
                            { name: "upd_dt", format: { width: 150 } }
                        ]
                    },
                    {
                        element: [
                            ...
                            {
                                style: { colspan: 5 }, name: "issue_title",
                                format: { type: "text", width: 592 },
                                editable: { type: "text", width: 592, maxlength: 200 }
                            }
                        ]
                    },
                    {
                        element: [
                            { header: true, value: "요청내용", format: { type: "label" } },
                            {
                                ...
                                format: { type: "textarea", rows: 5, width: 590 },
                                editable: { type: "textarea", rows: 5, width: 590 }
                            },
        ...
        gw_com_module.formCreate(args);
        //============  grdData_측정 : 측정 정보 List
        var args = {
            targetid: "grdData_측정", query: "EHM_3070_S_4", title: "측정 항목",
            caption: true, height: 184, pager: false, show: true, number: true, selectable: true,
            editable: { multi: true, bind: "select", focus: "msr_cd", validate: true },
            element: [
				{
				    header: "항목명", name: "msr_cd", width: 100,
				    editable: { type: "text", validate: { rule: "required" }, bind: "create" }
				},
                {
                    header: "값", name: "msr_val", width: 80, align: "right", mask: "numeric-float",
                    editable: { type: "text", width: 98 }
                },
                { header: "비고", name: "msr_rmk", width: 150, editable: { type: "text", width: 178 } },
                { name: "voc_no", hidden: true, editable: { type: "hidden" } },
                { name: "del", hidden: true, display: true }
            ]
        };
        gw_com_module.gridCreate(args);
        ...
        var args = {
            ...
            element: [
                ...
                { header: "통보일시", name: "mailsend_dt", width: 160, align: "center", mask: "date-ymd"},
                {
                    header: "처리결과", name: "result_cd", width: 100, align: "center",
                    editable: { type: "select", data: { memory: "처리결과" }, validate: { rule: "required" } }
                },
                {
                    header: "처리일자", name: "result_dt", width: 160, align: "center", mask: "date-ymd",
                    editable: { type: "text", validate: { rule: "required" } }
                },
                {
                    header: "결과사유", name: "result_rmk", width: 500,
                    editable: { type: "text" }
                },
        ...
        var args = {
            target: [
				...
				{ type: "GRID", id: "grdData_측정", offset: 8 },
    ...
    procedure: function () {
        ...
        //============  Button Events : lyrMenu_측정
        var args = { targetid: "lyrMenu_측정", element: "추가", event: "click", handler: click_lyrMenu_측정_추가 };
        gw_com_module.eventBind(args);
        //----------
        var args = { targetid: "lyrMenu_측정", element: "삭제", event: "click", handler: click_lyrMenu_측정_삭제 };
        gw_com_module.eventBind(args);
        ...
        //============  Event Handler : lyrMenu_측정
        function click_lyrMenu_측정_추가(ui) {

            if (!checkManipulate({})) return;
            if (gw_com_api.getValue("frmData_내역", 1, "voc_no") == "") {
                return;
            }
            var args = {
                targetid: "grdData_측정", edit: true,
                data: [
        ...
        //----------
        function click_lyrMenu_측정_삭제(ui) {

            if (!checkManipulate({})) return;
            
            if (gw_com_api.getValue("grdData_측정", "selected", "del", true) == "0") {
                gw_com_api.messageBox([{ text: "삭제할 수 없는 항목입니다." }], 420);
                return;
            }

            var args = { targetid: "grdData_측정", row: "selected", select: true }
    ...
    var args = {
        source: {
            ...
            element: [
                ...
                { name: "issue_title", argument: "arg_issue_title" }
            ],
            argument: [
            ...
            remark: [
                ...
                { element: [{ name: "adept_nm" }] },
                { element: [{ name: "aemp_nm" }] }
            ]
        },
        target: [
			{
...
function processLink(param) {
    ...
    var args = {};
    if (param.sub) {
        //if (gw_com_api.getSelectedRow("grdData_담당", false) < 1) return;
        //args = {
	    //    source: {
	    //        type: "INLINE",
	    //        argument: [
        //            { name: "arg_voc_no", value: gw_com_api.getValue("grdData_담당", "selected", "voc_no", true) },
        //            { name: "arg_charge_seq", value: gw_com_api.getValue("grdData_담당", "selected", "charge_seq", true) }
        //        ]
	    //    },
	    //    target: [
	    //        { type: "FORM", id: "frmData_담당" }
        ...
        case gw_com_api.v_Stream.msg_selectedEmployee:
            {
                if (param.data != undefined) {
                    if (v_global.event.object == "frmOption") {
                        gw_com_api.setValue(
                                            v_global.event.object,
                                            v_global.event.row,
                                            v_global.event.element,
