...
var gw_job_process = {
    ...
    UI: function () {
        ...
        var args = { targetid: "grdData_대분류", query: "SPC_1012_M_1", title: "품질검사 품목분류",
            ...
            element: [
				...
				},
				{
				    ...
				    editable: { type: "text", width: 184, validate: { rule: "required", message: "품목분류 명칭" } }
				},
        ...
        var args = { targetid: "grdData_중분류", query: "SPC_1012_S_1", title: "검사대상품목",
            ...
            editable: { master: true, bind: "select", focus: "part_no", validate: true },
            element: [
				{
        ...
        var args = { targetid: "grdData_소분류", query: "SPC_1012_S_2", title: "검사표준",
            ...
            element: [
            	...
            	{ header: "UCL(%)", name: "ucl_rate", width: 60, align: "center", editable: { type: "text" }, hidden: true },
            	{ header: "LCL(%)", name: "lcl_rate", width: 60, align: "center", editable: { type: "text" }, hidden: true },
            ...
            switch (ui.element) {
                case "supp_nm":
                    { v_global.event.type = ui.type; v_global.event.object = ui.object; v_global.event.row = ui.row; v_global.event.element = ui.element;
                        var args = { type: "PAGE", page: "DLG_SUPPLIER", title: "협력사 선택", width: 600, height: 460, open: true };
    ...
    if (param.detail)
        args = { targetid: "grdData_소분류", edit: true,
            data: [
                ...
                { name: "app_date", value: gw_com_api.getDate() }
            ]
        };
    else if (param.sub)
