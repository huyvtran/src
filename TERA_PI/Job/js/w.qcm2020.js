    ...
    UI: function () {
                ...
                row: [
                    {
                        element: [
				            ...
				            },
                            {
                                ...
                                editable: { type: "text", size: 8, maxlength: 10 }, hidden: true
                            }
                        ]
                    },
                    {
        ...
        var args = {
            ...
            element: [
				...
				{ header: "NCR 상태", name: "ncr_stat", width: 70, align: "center", hidden: true },
				{ header: "NCR진행상태", name: "ncr_stat2", width: 70, align: "center" },
                ...
                row: [
                    {
                        element: [
                            ...
                            { name: "issue_tp", editable: { type: "select", data: { memory: "발생구분" }, validate: { rule: "required", message: "발생구분" } } }
                        ]
                    },
                    {
                        element: [
                    ...
                    },
                    {
                        element: [
                            ...
                            { name: "prod_sub", editable: { type: "select", data: { memory: "Module" } } },
            ...
            element: [
                ...
                },
				{
				    ...
				    editable: {
				        ...
				        change: [
							{ name: "part_tp1", memory: "발생Module", key: ["prod_type"] },
				...
				{
				    header: "발생부위", name: "part_tp2", width: 262, align: "center",
				    format: { type: "select", data: { memory: "발생부위" } },
				    editable: { type: "select", data: { memory: "발생부위", key: ["prod_type", "part_tp1"] } }
				},
				{
				    header: "발생원인", name: "reason_tp2", width: 262, align: "center",
				    format: { type: "select", data: { memory: "발생원인" } },
        ...
        //=====================================================================================
        var args = {
            targetid: "frmData_발생현상상세", query: "w_qcm2020_S_2", type: "TABLE", title: "발생 내용",
        ...
        var args = {
            ...
            element: [
				...
				{
				    header: "작업시간", name: "work_time", width: 70, align: "center", mask: "numeric-float",
				    editable: { type: "text" }
				},
				{
                ...
                row: [
                    ...
                    },
                    {
                        element: [
                            ...
                            { style: { colspan: 5 }, name: "rslt_rmk1", format: { type: "textarea", rows: 5, width: 1024 } }
                        ]
                    },
                    {
                        element: [
                            { header: true, value: "특이사항", format: { type: "label" } },
                            { style: { colspan: 5 }, name: "rslt_rmk2", format: { type: "textarea", rows: 5, width: 1024 } },
        ...
        //=====================================================================================
        var args = {
            targetid: "grdData_첨부파일", query: "w_qcm2020_S_7", title: "첨부 파일", caption: true,
            height: "100%", pager: false, show: true, number: true, selectable: true,
