...
var gw_job_process = {
    ...
    UI: function () {
        ...
        //=====================================================================================
        var args = {
            targetid: "frmData_내역", query: "w_eccb3010_M_1", type: "TABLE", title: "검증Test 시행 정보",
                ...
                row: [
                    ...
                    },
                    {
                        element: [
                            ...
                            {
                                style: { colspan: 3 }, name: "cip_title", format: { width: 500 },
                    ...
                    },
                    {
                        element: [
                            ...
                            {
                                style: { colspan: 3 }, name: "test_model", format: { width: 500 },
                                editable: { type: "text", width: 500 }
                            },
                            { header: true, value: "기안부서", format: { type: "label" } },
                            {
                                name: "draft_dept",
                    ...
                    },
                    {
                        element: [
                            ...
                            { name: "plan_str_dt", mask: "date-ymd", editable: { type: "text" } },
                            { header: true, value: "완료예정일", format: { type: "label" } },
                            { name: "plan_end_dt", mask: "date-ymd", editable: { type: "text" } },
                            { header: true, value: "기안일자", format: { type: "label" } },
                            { name: "draft_dt", mask: "date-ymd", editable: { type: "text" } }
                        ]
                    },
                    {
                        element: [
                    ...
                    },
                    {
                        element: [
                            ...
                            {
                                style: { colfloat: "floating" },
                                name: "mp_class2_sel", format: { width: 0 },
                                editable: { type: "select", data: { memory: "분류3", unshift: [{ title: "-", value: "" }] }, width: 155 },
                                display: true
                            },
                            {
                                style: { colfloat: "floated" },
                                name: "mp_class2_etc", format: { width: 0 },
                                editable: { type: "text", width: 155 }, display: true
                            },
                    ...
                    },
                    {
                        element: [
                            ...
                            {
                                style: { colfloat: "floating" }, name: "act_module3_etc", format: { width: 0 }, editable: { type: "text", width: 155 },
                                display: true
                            },
                    ...
                    },
                    {
                        element: [
                            ...
                            { name: "act_emp_nm", mask: "search", display: true, editable: { type: "text" } },
                            ...
                            {
                                style: { colfloat: "floating" }, name: "sub_emp2_nm",
                                mask: "search", display: true, format: { width: 70 },
                                editable: { type: "text", width: 155 }
                            },
                            {
                                style: { colfloat: "floated" },
                                name: "sub_emp3_nm", mask: "search",
                                display: true, format: { width: 70 },
                                editable: { type: "text", width: 155 }
                            },
                    ...
                    {
                        element: [
                            { header: true, value: "예상경비내역", format: { type: "label" } },
                            {
                                style: { colspan: 3 }, name: "plan_cost_note",
                                format: { type: "textarea", rows: 5, width: 500 },
                                editable: { type: "textarea", rows: 5, width: 500 }
                            },
                            { header: true, value: "총금액", format: { type: "label" } },
                            { name: "plan_cost", mask: "currency-ko", editable: { type: "text" } }
                        ]
                    },
                    {
                        element: [
        ...
        var args = {
            ...
            element: [
                ...
                { header: "Line", name: "cust_dept", width: 120, align: "center", editable: { type: "hidden" } },
                {
        ...
        //=====================================================================================
        var args = {
            targetid: "frmData_메모A", query: "w_eccb3010_S_2_1", type: "TABLE", title: "검증Test 필요성 및 문제점",
        ...
        //=====================================================================================
        var args = {
            targetid: "frmData_메모B", query: "w_eccb3010_S_2_2", type: "TABLE", title: "문제 해결 방안",
            caption: true, show: true, selectable: true, fixed: true,
            editable: { bind: "select", validate: true },
            content: {
                width: { field: "100%" }, height: 370,
                row: [
    ...
    procedure: function () {
        ...
        function itemdblclick_frmData_메모A(ui) {
            ...
            switch (ui.element) {
                case "memo_html":
                    {
                        v_global.logic.memo = "검증Test 필요성 및 문제점";
...
function processPrint(param) {
    ...
    window.open("/Job/w_link_cip_print.aspx?data_key=" + v_global.logic.key, "", "");
...
function processInsert(param) {
    ...
    if (param.sub) {
        ...
        var args = {
            type: "PAGE", page: "w_find_ecr", title: "검증Test 대상 선택",
...
function processApprove(param) {
    ...
    var title = encodeURIComponent(Query.getApprovalTitle({ type: "CIP", ref_key1: v_global.logic.key }));
    var url = "http://gw.terasemicon.com/_ERPR/Public/ERPRLogin.aspx?UserId=" + gw_com_module.v_Session.USR_ID
        + "&Pwd=&Lang=ko&EAID=102&gw_num=100&htmltag=&cip_no=%27" + v_global.logic.key + "%27&NextUrl=/_EAPP/EADocumentWrite.aspx?FormID=102&ErpDocTitle=" + title;
