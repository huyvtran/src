...
var gw_job_process = {
    ...
    UI: function () {
                ...
                row: [
                    {
                        element: [
                          ...
                          },
                          {
                              ...
                              editable: { type: "select", size: 7, maxlength: 20, data: { memory: "Warranty", unshift: [{ title: "전체", value: "" }] } }
                          }
                        ]
                    },
                    {
                        element: [
                              ...
                              },
                              {
                                  ...
                                  editable: { type: "text", size: 12, maxlength: 50 }, hidden: true
                              },
                              {
        ...
        //=====================================================================================
        var args = { targetid: "grdData_현황", query: "w_ehm1020_M_1", title: "장비 목록",
            height: 306,
            show: true,
            selectable: true,
            dynamic: true,
            element: [
				...
				{ header: "제품규격", name: "prod_spec", width: 100, align: "center" },
				{ header: "챔버구성", name: "prod_subtp", width: 60, align: "center" },
				{ header: "챔버수", name: "prod_subqty", width: 60, align: "center" },
				{
				    header: "S/W Ver.",
				    name: "sw_version",
				    width: 60,
        ...
        //=====================================================================================
        var args = { targetid: "grdData_이력", query: "w_ehm1020_S_1", title: "변경 이력",
            caption: true,
            height: 80,
            pager: false,
            show: true,
    ...
    procedure: function () {
        ...
        function rowdblclick_grdData_현황(ui) {
            ...
            var args = { type: "PAGE", page: "w_ehm1030", title: "A/S 장비 관리",
                width: 720, height: 500, open: true, control: true
            };
            if (gw_com_module.dialoguePrepare(args) == false) {
                var args = { page: "w_ehm1030",
                    param: { ID: gw_com_api.v_Stream.msg_editASEquipment,
                        data: { prod_sno: gw_com_api.getValue(
                                            ui.object, ui.row, "prod_sno", (ui.type == "GRID" ? true : false))
                        }
                    }
                };
                gw_com_module.dialogueOpen(args);
    ...
    var args = {
        source: {
            ...
            element: [
                ...
                { name: "sw_version", argument: "arg_sw_version" },
