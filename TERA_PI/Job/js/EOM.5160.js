...
var gw_job_process = {
    ...
    UI: function () {
        ...
        //==== Main Grid
        var args = { targetid: "grdData_Main", query: "EOM_5160_M_1", title: "GAS별",
            caption: true, width: 370, height: 299, pager: false, show: true,
            element: [
				{ header: "GAS종류", name: "category", width: 165, align: "center" },
				{ header: "사용량(kl)", name: "value1", width: 60, align: "center" },
        ...
        //==== Main Chart
        var args = { targetid: "lyrChart_Main", query: "EOM_5160_M_1", title: "GAS별", show: true,
        ...
        //==== Sub Grid
        var args = { targetid: "grdData_Sub", query: "EOM_5160_S_1", title: "설비별",
            caption: true, width: 370, height: 299, pager: false, show: true,
            element: [
				{ header: "설비", name: "category", width: 165, align: "center" },
				{ header: "사용량(kl)", name: "value1", width: 60, align: "center" },
        ...
        //==== Sub Chart
        var args = { targetid: "lyrChart_Sub", query: "EOM_5160_S_1", title: "설비별", show: true,
            format: { view: "1", rotate: "0", reverse: "1" },
...
function processRetrieve(param) {
	...
	var sTitle1 = "Gas별"; var sTitle2 = "설비별";
	if (sChart == "EQ") { sTitle1 = "설비별"; var sTitle2 = "Gas별"; }
	gw_com_api.setCaption("grdData_Main", sTitle1, true);
	gw_com_api.setCaption("grdData_Sub", sTitle2, true);
