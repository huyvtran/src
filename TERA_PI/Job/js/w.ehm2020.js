                ...
                case "astat":
                    {
                        if (ui.value.current == "1" || ui.value.current == "2") {
                            /*
                            if (gw_com_api.getValue(ui.object, ui.row, "work_cnt", true) <= 0) {
                                gw_com_api.setValue(ui.object, ui.row, ui.element, "0", true);
                                gw_com_api.messageBox([
                                    { text: "조치 내역이 입력되지 않은 데이터는" },
                                    { text: "확인할 수 없습니다." }
                                ]);
                                return;
                            }
