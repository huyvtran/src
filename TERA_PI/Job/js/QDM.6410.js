...
//				{ name: "삭제", value: "삭제", icon: "삭제" },
        ...
        //==== Main Grid : 발생 내역
        var args = {
            targetid: "grdData_현황", query: "QDM_6410_M_1", title: "NCR 확인 내역",
            ...
            element: [
				...
				{ header: "부적합 원인", name: "rmk01", width: 300 },
				{ header: "재발방지대책", name: "rmk03", width: 300 },
				{ header: "확인계획일자", name: "plan_date", width: 70, align: "center", mask: "date-ymd" },
				{ header: "확인일시", name: "astat_dt", width: 100, align: "center" },
				{ header: "확인결과", name: "astat", width: 60, align: "center" },
				...
				{ header: "설비명", name: "prod_nm", width: 150, hidden: true },
