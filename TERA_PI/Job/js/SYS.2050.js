...
var gw_job_process = {
    ...
    UI: function () {
        ...
        var args = {
            ...
            show: true,
            selectable: true,
            editable: { bind: "select", focus: "rpt_id", validate: true
            },
            content: {
                width: {
                    label: 80,
...
function processLink(param) {
    ...
    var args = {
        source: {
            ...
            block: true,
            element: [
                { name: "rpt_id", argument: "arg_rpt_id" }
	        ]
        },
        target: [
            {
        ...
        target: [
		    {
		        type: "GRID",
		        id: "grdData_항목",
		        key: [ { row: "selected", element: [ { name: "rpt_id" } ] } ]
		    }
	    ],
        handler: {
