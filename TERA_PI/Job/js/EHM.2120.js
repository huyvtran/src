...
var gw_job_process = {
    ...
    UI: function () {
        ...
        var args = {
            ...
            editable: { bind: "select", focus: "stock_usr", validate: true },
            element: [
                ...
                {
                    header: "입고일", name: "stock_dt", width: 100, align: "center",
    ...
    switch (param.object) {
        case "grdData_Main":
            if (param.element == "stock_usr" || param.element == "stock_dt") {
                ...
                if (param.element == "stock_usr" && gw_com_api.getValue(param.object, param.row, "stock_dt", (param.type == "GRID" ? true : false)) == "") {
                    gw_com_api.setValue(param.object, param.row, "stock_dt", gw_com_api.getDate(""), (param.type == "GRID" ? true : false));
                } else if (param.element == "stock_dt" && gw_com_api.getValue(param.object, param.row, "stock_usr", (param.type == "GRID" ? true : false)) == "") {
                    gw_com_api.setValue(param.object, param.row, "stock_usr", gw_com_module.v_Session.USR_NM, (param.type == "GRID" ? true : false));
                }
            }
            break;
    }
