...
var gw_job_process = {
    ...
    UI: function () {
        ...
        gw_com_module.buttonMenu(args);
        //=====================================================================================
        var args = { targetid: "frmData_내역", query: "w_eccb4010_M_1", type: "TABLE", title: "ECO 내역",
            caption: true,
            show: true,
            selectable: true,
            editable: {
                    ...
                    },
                    {
                        element: [
                            ...
                            },
                            {
                                ...
                                name: "notify_dept1",
                                format: { type: "select", data: { memory: "부서" },  width: 80 },
                                editable: { type: "select", data: { memory: "부서" }, width: 186 }
                            },
                            {
                                style: {
                                    colfloat: "diving"
        ...
        //=====================================================================================
        var args = { targetid: "grdData_모델", query: "w_eccb4010_S_1", title: "적용 모델",
            caption: true,
            height: "100%",
            pager: false,
            show: true,
        ...
        //=====================================================================================
        var args = { targetid: "frmData_메모A", query: "w_eccb4010_S_2_1", type: "TABLE", title: "BEFORE (변경 전)",
            caption: true,
            show: true,
            fixed: true,
            selectable: true,
        ...
        gw_com_module.formCreate(args);
        //=====================================================================================
        var args = { targetid: "frmData_메모B", query: "w_eccb4010_S_2_2", type: "TABLE", title: "AFTER (변경 후)",
            caption: true,
            show: true,
            fixed: true,
            selectable: true,
        ...
        gw_com_module.formCreate(args);
        //=====================================================================================
        var args = { targetid: "grdData_도면", query: "w_eccb4010_S_3", title: "설변 도면",
            caption: true,
            height: "100%",
            pager: false,
            show: true,
            ...
            element: [
				...
				{ header: "DWG No.", name: "dwg_no1", width: 100, align: "center", editable: { type: "text" } },
                { header: "도면보기", name: "link1", width: 60, align: "center", format: { type: "link" } },
                { header: "Part Name", name: "part_nm1", width: 200, align: "center", editable: { type: "text" } },
				{ header: "Rev.", name: "rev_no1", width: 40, align: "center", editable: { type: "text" } },
                {
                    header: "구분", name: "item_type2", width: 70, align: "center",
                    format: { type: "select", data: { memory: "도면구분", unshift: [{ title: "-", value: "" }] } },
                    editable: { type: "select", data: { memory: "도면구분", unshift: [{ title: "-", value: "" }] } }
                },
				{ header: "DWG No.", name: "dwg_no2", width: 100, align: "center", editable: { type: "text" } },
                { header: "도면보기", name: "link2", width: 60, align: "center", format: { type: "link" } },
                { header: "Part Name", name: "part_nm2", width: 200, align: "center", editable: { type: "text" } },
				{ header: "Rev.", name: "rev_no2", width: 40, align: "center", editable: { type: "text" } },
    ...
    procedure: function () {
        ...
        //----------
        function click_grdData_도면_link(ui) {
            var dwg_no = gw_com_api.getValue(ui.object, ui.row, (ui.element == "link1" ? "dwg_no1" : "dwg_no2"), true);
            if (dwg_no == undefined || dwg_no == "") return;
            var rev_no = gw_com_api.getValue(ui.object, ui.row, (ui.element == "link1" ? "rev_no1" : "rev_no2"), true);
            //var url = "https://plm.terasemicon.com/Windchill/tera/part/ViewPart?number=" + dwg_no + "&version=" + rev_no;
            var url = "http://192.168.20.13/Windchill/tera/part/ViewPart?number=" + dwg_no + "&version=" + rev_no;
            window.open(url);
        }
        //----------        
...
function processApprove(param) {
    ...
    var title = encodeURIComponent(Query.getApprovalTitle({ type: "ECO", ref_key1: v_global.logic.key }));
    var url = "http://gw.terasemicon.com/_ERPR/Public/ERPRLogin.aspx?UserId=" + gw_com_module.v_Session.USR_ID
        + "&Pwd=&Lang=ko&EAID=107&gw_num=100&htmltag=&eco_no=%27" + v_global.logic.key + "%27&NextUrl=/_EAPP/EADocumentWrite.aspx?FormID=107&ErpDocTitle=" + title;
...
function successSave(response, param) {
    ...
    // PLM I/F
    if (v_global.logic.if_key) {
        var stat = encodeURI("등록");
        //var url = "https://plm.terasemicon.com/Windchill/login/PLMConnection.jsp?redirectUrl=part/ecoIf&id=" + v_global.logic.if_key + "&ecoNo=" + v_global.logic.key + "&state=" + stat;
        var url = "http://192.168.20.13/Windchill/login/PLMConnection.jsp?redirectUrl=part/ecoIf&id=" + v_global.logic.if_key + "&ecoNo=" + v_global.logic.key + "&state=" + stat;
        var content =
        "<iframe" +
            " id='plm_if_page_eco'" +
            " src='" + url + "'" +
...
function successApproval(response, param) {
    ...
    var FormId = 79;
    if (DeptArea == "DP") FormId = 239;
    else if (DeptArea == "SOLAR") FormId = 240;
    else FormId = 79;
