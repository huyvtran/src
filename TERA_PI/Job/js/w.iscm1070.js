...
var gw_job_process = {
    ...
    procedure: function () {
        ...
        var args = {
            ...
            element: "제조의뢰상신",
            event: "click",
            handler: click_lyrMenu_1_제조의뢰상신
        };
        ...
        var args = {
            ...
            element: "제조변경상신",
            event: "click",
            handler: click_lyrMenu_1_제조변경상신
        };
        gw_com_module.eventBind(args);
        //----------
        var args = {
...
function processApprove(param) {
    ...
    if (param.modify) {
        ...
        else if (status == '미처리' || status == '반송' || status == '회수') {
            gw_com_api.messageBox([
                { text: "결재 재상신 대상이므로 처리할 수 없습니다." }
            ], 420);
            return false;
        }
    }
...
function successApproval(response, param) {
    ...
    var params = [
        { name: "form_id", value: (param.modify) ? 71 : 70 },
        { name: "cmpid", value: 1 },
