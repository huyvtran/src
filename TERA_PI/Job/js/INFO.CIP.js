...
var gw_job_process = {
    ...
    UI: function () {
        ...
        var args = {
            ...
            query: "w_eccb3010_S_2_1",
            type: "TABLE",
            title: "검증Test 필요성 및 문제점",
            caption: true,
            show: true,
            fixed: true,
            selectable: true,
...
streamProcess = function (param) {
    ...
    switch (param.ID) {
        case gw_com_api.v_Stream.msg_infoCIP:
            {
                var retrieve = false;
                if (param.data != undefined) {
                    if (param.data.cip_no
                        != gw_com_api.getValue("frmOption", 1, "cip_no")) {
                        gw_com_api.setValue("frmOption", 1, "cip_no", param.data.cip_no);
                        retrieve = true;
                    }
                }
                ...
                if (retrieve)
                    processRetrieve({});
                gw_com_api.setFocus("frmOption", 1, "cip_no");
            }
            break;
