...
var gw_job_process = {
    ...
    UI: function () {
        ...
        //=====================================================================================
        var args = { targetid: "grdData_분류1", query: "ECCB_5020_M_1", title: "적용 영역별",
        ...
        //=====================================================================================
        var args = { targetid: "grdData_분류2", query: "ECCB_5020_S_1", title: "적용 모듈별",
            caption: true, width: 325, height: 299, pager: true, show: true,
            group: [ { element: "grouptext", show: false, summary: false } ],
            element: [
        ...
        gw_com_module.gridCreate(args);
        //=====================================================================================
        var args = { targetid: "grdData_분류3", query: "ECCB_5020_S_2", title: "MP 분류별",
            caption: true, width: 325, height: 299, pager: true, show: true,
            group: [ { element: "grouptext", show: false, summary: false } ],
            element: [
				{ header: "상세분류", name: "category", width: 175, align: "center" },
        ...
        gw_com_module.gridCreate(args);
        //=====================================================================================
        var args = { targetid: "grdData_분류4", query: "ECCB_5020_S_3", title: "적용 모델별",
            caption: true, width: 325, height: 299, pager: true, show: true,
            group: [ { element: "grouptext", show: false, summary: false } ],
            element: [
				{ header: "상세분류", name: "category", width: 175, align: "center" },
