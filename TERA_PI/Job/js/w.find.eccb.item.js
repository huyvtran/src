...
var gw_job_process = {
    ...
    UI: function () {
        ...
        //=====================================================================================
        var args = { targetid: "grdData_현황", query: "w_find_eccb_item_M_1", title: "ECCB 심의 대상",
            height: 300,
            show: true,
            multi: true,
            checkrow: true,
...
function informResult(param) {
    ...
    $.each(ids, function () {
        rows.push({
            root_type: gw_com_api.getCellValue("GRID", "grdData_현황", this, "root_type"),
            root_type_nm: gw_com_api.getCellValue("GRID", "grdData_현황", this, "root_type_nm"),
            root_no: gw_com_api.getCellValue("GRID", "grdData_현황", this, "root_no"),
            ecr_no: gw_com_api.getCellValue("GRID", "grdData_현황", this, "ecr_no"),
            cip_no: gw_com_api.getCellValue("GRID", "grdData_현황", this, "cip_no"),
            root_title: gw_com_api.getCellValue("GRID", "grdData_현황", this, "ecr_title"),
            root_dt: gw_com_api.getCellValue("GRID", "grdData_현황", this, "ecr_dt"),
            root_dept: gw_com_api.getCellValue("GRID", "grdData_현황", this, "ecr_dept_nm"),
            root_emp: gw_com_api.getCellValue("GRID", "grdData_현황", this, "ecr_emp_nm"),
            act_rqst_date: gw_com_api.getCellValue("GRID", "grdData_현황", this, "act_rqst_date")
        });
    });
    var args = {
