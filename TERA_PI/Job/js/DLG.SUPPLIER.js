...
function informResult(param) {
    ...
    var args = {
        ...
        data: {
            supp_cd: gw_com_api.getValue("grdData_목록", (param.row != undefined ? param.row : "selected"), "supp_cd", true),
            supp_nm: gw_com_api.getValue("grdData_목록", (param.row != undefined ? param.row : "selected"), "supp_nm", true),
            biz_no: gw_com_api.getValue("grdData_목록", (param.row != undefined ? param.row : "selected"), "rgst_no", true)
        }
    };
    gw_com_module.streamInterface(args);
