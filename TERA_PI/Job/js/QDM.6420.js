...
var gw_job_process = {
    ...
    UI: function () {
        ...
        //=====================================================================================
        var args = {
            targetid: "grdData_Sub", query: "QDM_6420_S_1", title: "담당 부서",
        ...
        //                    //{ name: "gw_stat", editable: { type: "hidden" }, display: true },
        //                    {
        //                        name: "astat",
        ...
        //                        editable: { type: "textarea", rows: 8, width: 1000 }
        //                    },
        //                    { name: "rqst_no", hidden: true, editable: { type: "hidden" } },
        //                    { name: "act_seq", hidden: true, editable: { type: "hidden" } },
    ...
    procedure: function () {
        ...
        if (v_global.process.param != "") {	// Page Parameter 변수 저장
            ...
            v_global.logic.key_seq = gw_com_api.getPageParameter("act_seq");
            ...
            if (v_global.logic.key == "")
                ...
                processRetrieve({ rqst_no: v_global.logic.key, act_seq: v_global.logic.key_seq }); //수정 및 조회
        }
...
function createTableObject(param) {
    ...
    if (param.objId == "frmData_D1"){	// Detail1 Form : NCR 담당 부서 처리결과
	    args = { targetid: "frmData_D1", query: "QDM_6220_D_1", type: "TABLE", title: "처리계획 및 결과",
	        caption: true, show: true, selectable: true,
	        ...
	        content: { width: { label: 100, field: 190 }, height: 25,
	            row: [
                    ...
                    {
                        element: [
                            { header: true, value: "조치 수리내용", format: { type: "label" } },
                            {
        ...
        args = { targetid: "frmData_D2", query: "QDM_6220_D_2", type: "TABLE", title: "유효성 확인",
            caption: true, width: "100%", show: true, selectable: true,
            editable: (param.readonly) ? undefined : { bind: "select", focus: "astat", validate: true },
            content: {
                ...
                row: [
                    {
                        element: [
                            ...
                            //{ name: "gw_stat_dt" }
                            {
                                ...
                                editable: { type: "hidden", width: 200/*, validate: { rule: "required" }*/ }
                            }
	                    ]
                    },
                    {
        ...
        args = {
            source: {
                ...
                argument: [
                    ...
                    { name: "arg_rqst_no", value: param.rqst_no },
                    { name: "arg_act_seq", value: 0 }, //param.act_seq },
                    { name: "arg_data_key", value: param.rqst_no },	// 첨부파일용
...
function processLink(param) {
    ...
    if (param.object == "grdData_Sub") {
        ...
        var editable = gw_com_api.getValue("grdData_Sub", "selected", "check_cd", true) == "적합" ? true : false;
        createTableObject({ objType: "FORM", objId: "frmData_D2", readonly: !editable, clear: true });
        ...
        $.each(this.KEY, function () {
            switch (this.NAME) {
                case "rqst_no":
                    ...
                    break;
                case "act_seq":
                    v_global.logic.key_seq = this.VALUE;
                    break;
            }
        });
    });
    processRetrieve({ rqst_no: v_global.logic.key, act_seq: v_global.logic.key_seq });
...
function processSend(param) {
    ...
    if (CheckCode != "부적합") {
        gw_com_api.messageBox([
	        { text: "확인결과가 부적합이 아닌 경우에는 결과통보를 할 수 없습니다." }], 480);
        return;
    }

    //var CheckCode = gw_com_api.getValue("frmData_D2", 1, "gw_stat");
    //if (CheckCode != "부적합") {
    //    gw_com_api.messageBox([
	//        { text: "확인결과가 부적합이 아닌 경우에는 결과통보를 할 수 없습니다." }], 480);
    //    return;
