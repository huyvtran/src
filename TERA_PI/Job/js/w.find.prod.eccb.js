...
var gw_job_process = {
    ...
    UI: function () {
        ...
        var args = {
            ...
            element: [
				{
				    header: "사업부", name: "dept_area", width: 150, align: "center",
                ...
                { header: "제품명", name: "prod_nm", width: 150, align: "center", editable: { type: "text" } },
                { header: "제품코드", name: "prod_cd", width: 150, align: "center", editable: { type: "text" } },
        ...
        //=====================================================================================
        var args = { targetid: "grdData_제품", query: "w_find_prod_eccb_M_1", title: "제품",
            height: 250,
            show: true,
            dynamic: true,
            key: true,
...
processRetrieve = function (param) {
    ...
    var args = {
        source: { type: "GRID", id: "grdData_분류", row: "selected",
            element: [
