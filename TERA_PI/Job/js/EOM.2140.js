    ...
    UI: function () {
        ...
        var args = { targetid: "grdData_Main", query: "EOM_2140_M_1", title: "설비 상태 이력",
            ...
            element: [
				...
				{ header: "대분류", name: "status_tp1", width: 80, align: "center" 
                ...
                { header: "운영이관", name: "unit_yn", width: 60, align: "center" },
                ...
                row: [
                    ...
                    { element: [
                        ...
                        { name: "eq_module1", format: { width: 90 },
                            ...
                            editable: { type: "select", width: 90, data: { memory: "설비모듈", key: ["eq_cd"] }, validate: { rule: "required" } }
                        },
                        ...
                        { name: "status_tp4" , format: { width: 120 }, style: { colfloat: "floated" },
							editable: { type: "select", width: 120 
                    ...
                    { element: [
                        ...
                        { name: "unit_rmk", style: { colspan: 7 },
                            format: { type: "textarea", rows: 7, width: 600 },
                            editable: { type: "textarea", rows: 7, width: 600}
                        },
