...
var gw_job_process = {
    ...
    UI: function () {
                ...
                row: [
                        {
                            element: [
                              {
                                  name: "ymd_fr", label: { title: "이동일자 :" }, mask: "date-ymd",
        ...
        //==== Main Grid : 이동 현황
        var args = {
            targetid: "grdData_Main", query: "SRM_4610_M_1", title: "이동 현황",
            ...
            element: [
				...
				{ header: "이동일자", name: "io_date", width: 70, align: "center", mask: "date-ymd" },
        ...
        //==== Sub Grid : 이동 목록
        var args = {
            targetid: "grdData_Sub", query: "SRM_4610_S_1", title: "이동 목록",
            ...
            element: [
				...
				{ header: "Tracking", name: "mtrack_no", width: 80, align: "center" },
				{ header: "이동 Tracking", name: "track_no", width: 80, align: "center" },
    ...
    procedure: function () {
        ...
        //----------
        var args = { targetid: "lyrMenu", element: "이동", event: "click", handler: processInsert };
        gw_com_module.eventBind(args);
