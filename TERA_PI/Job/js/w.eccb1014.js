...
var gw_job_process = {
                ...
                row: [
                        ...
                        element: [
                            ...
                            { header: true, value: "사업부", format: { type: "label" } },
                            {
                                ...
                                editable: {
                                    ...
                                    //change: [
                                    //    { name: "act_module1_sel", memory: "분류2", key: ["dept_area"] },
                                    //    { name: "act_module2_sel", memory: "분류2", key: ["dept_area"] },
                                    //    { name: "act_module3_sel", memory: "분류2", key: ["dept_area"] }
                                    //]
                                }
                            }
                        ]
                    },
                    {
                        element: [
                            ...
                            {
                                name: "ecr_title", style: { colspan: 3 },
                                format: { width: 630 },
                    ...
                    },
                    {
                        element: [
                            ...
                            {
                                name: "act_time_sel", style: { colspan: 3, colfloat: "float" }, display: true,
                                format: { width: 0 },
                    ...
                    },
                    {
                        element: [
                            { header: true, value: "실행요청부서", format: { type: "label" } },
                            {
                                ...
                                editable: { type: "select", data: { memory: "부서" }, validate: { rule: "required" } }
                            },
                    ...
                    },
                    {
                        element: [
                            { header: true, value: "분류", format: { type: "label" } },
                            {
                                ...
                                format: { width: 0 },
                                editable: {
                                    type: "select", width: 155, data: { memory: "분류1", unshift: [{ title: "", value: "" }] },
                            ...
                            {
                                name: "act_module1_sel", style: { colfloat: "floating" }, display: true,
                                format: { width: 0 },
                                editable: {
                                    type: "select", width: 155, data: { memory: "분류2", key: ["dept_area"], unshift: [{ title: "", value: "" }] },
                                    validate: { rule: "required" }
                                }
                            },
                            {
                                name: "act_module1_etc", style: { colfloat: "floating" }, display: true,
                                format: { width: 0 },
                            ...
                            {
                                name: "mp_class1_sel", style: { colfloat: "floating" }, display: true,
                                format: { width: 0 },
                                editable: {
                            ...
                            {
                                name: "mp_class1_etc", style: { colfloat: "floated" }, display: true,
                                format: { width: 0 },
                                editable: { type: "text", width: 155 }
                            },
                    ...
                    },
                    {
                        element: [
                            ...
                            { name: "act_region2_text", format: { width: 200 }, style: { colfloat: "floating" } },
                            { name: "act_module2_text", format: { width: 300 }, style: { colfloat: "floating" } },
                            {
                                name: "act_module2_sel", format: { width: 0 }, style: { colfloat: "floating" }, display: true,
                                editable: { type: "select", width: 155, data: { memory: "분류2", key: ["dept_area"], unshift: [{ title: "-", value: "" }] } }
                            },
                            {
                                name: "act_module2_etc", style: { colfloat: "floating" }, display: true,
                                format: { width: 0 },
                                editable: { type: "text", width: 155 }
                            },
                    ...
                    },
                    {
                        element: [
                            ...
                            { name: "act_region3_text", format: { width: 200 }, style: { colfloat: "floating" } },
                            { name: "act_module3_text", format: { width: 300 }, style: { colfloat: "floating" } },
                            {
                                name: "act_module3_sel", style: { colfloat: "floating" }, display: true,
                                format: { width: 0 },
                                editable: {
                                    type: "select", width: 155,
                                    data: { memory: "분류2", key: ["dept_area"], unshift: [{ title: "-", value: "" }] }
                                }
                            },
                            {
                            ...
                            {
                                name: "mp_class3_sel", style: { colfloat: "floating" }, display: true,
                                format: { width: 0 },
                                editable: { type: "select", data: { memory: "분류3", unshift: [{ title: "", value: "" }] }, width: 155 }
                            },
                            {
    ...
    procedure: function () {
        ...
        //----------
        var args = { targetid: "lyrMenu_1", element: "의견", event: "click", handler: click_lyrMenu_1_의견 };
        gw_com_module.eventBind(args);
        //----------
        ...
        //----------
        function click_lyrMenu_1_의견() {
            if (!checkManipulate({})) return;
            if (v_global.logic.key == undefined) return;
            var args = {
                type: "PAGE", page: "w_info_ecr_gw_opinion", title: "결재의견",
        ...
        case gw_com_api.v_Stream.msg_openedDialogue:
            {
                ...
                switch (param.from.page) {
                    ...
                    case "w_upload_eccb":
                        ...
                        break;
                    case "w_info_ecr_gw_opinion":
                        {
                            args.ID = param.ID;
                            args.data = { key: v_global.logic.key };
                        }
                        break;
                }
                gw_com_module.streamInterface(args);
