...
var gw_job_process = {
    ...
    UI: function () {
        ...
        var args = {
            ...
            height: 440, number: true, show: true, selectable: true, key: true,
            element: [
                { name: "color", hidden: true },
				{ name: "cancel_yn", hidden: true },
				{ header: "구분", name: "type", width: 50, align: "center", fix: { color: { by: "cancel_yn", to: "#909090" } } },
				{ header: "확인", name: "confirm", width: 50, align: "center", fix: { color: { by: "cancel_yn", to: "#909090" } } },
				{ header: "Project Name", name: "proj_nm", width: 130, fix: { color: { by: "cancel_yn", to: "#909090" } } },
				{ header: "Project No", name: "projkey", width: 80, align: "center", fix: { color: { by: "cancel_yn", to: "#909090" } } },
				{ header: "발주번호", name: "pur_no", width: 110, align: "center", fix: { color: { by: "cancel_yn", to: "#909090" } } },
				{ header: "발주일자", name: "pur_date", width: 80, align: "center", fix: { mask: "date-ymd", color: { by: "cancel_yn", to: "#909090" } } },
				{ header: "품목수", name: "item_qty", width: 50, align: "center", fix: { mask: "numeric-int", color: { by: "cancel_yn", to: "#909090" } } },
				{ header: "납기미등록", name: "no_regist", width: 70, align: "center", fix: { mask: "numeric-int", color: { by: "cancel_yn", to: "#909090" } } },
				{ header: "미납품", name: "no_dlv", width: 50, align: "center", fix: { mask: "numeric-int", color: { by: "cancel_yn", to: "#909090" } } },
				{ header: "취소품목", name: "cancel_qty", width: 60, align: "center", fix: { mask: "numeric-int", color: { by: "cancel_yn", to: "#909090" } } },
				{ header: "발주일변경", name: "po_change", width: 60, align: "center", fix: { color: { by: "cancel_yn", to: "#909090" } } },
				{ header: "발주수량변동", name: "qty_change", width: 70, align: "center", fix: { mask: "numeric-int", color: { by: "cancel_yn", to: "#909090" } } },
				{ header: "발주단가변동", name: "price_change", width: 70, align: "center", fix: { mask: "numeric-int", color: { by: "cancel_yn", to: "#909090" } } },
				{ header: "납기일변동", name: "date_change", width: 70, align: "center", fix: { mask: "numeric-int", color: { by: "cancel_yn", to: "#909090" } }, hidden: true },
				{ header: "상태", name: "pstat_nm", width: 60, align: "center", fix: { color: { by: "cancel_yn", to: "#909090" } } },
				{ header: "납기요구일", name: "req_date", width: 150, align: "center", fix: { color: { by: "cancel_yn", to: "#909090" } } },
				{ header: "전송일시", name: "sent_dt", width: 160, align: "center", fix: { color: { by: "cancel_yn", to: "#909090" } } },
				{ header: "확인일시", name: "checked_dt", width: 160, align: "center", fix: { color: { by: "cancel_yn", to: "#909090" } } },
				{ header: "출력일시", name: "printed_dt", width: 160, align: "center", fix: { color: { by: "cancel_yn", to: "#909090" } } },
				{ name: "pur_type", hidden: true },
				{ name: "pur_date", hidden: true },
				{ name: "root_type", hidden: true },
                { name: "pstat", hidden: true },
                { name: "confirm2", hidden: true }
			],
            subgrid: {
                query: "w_srm1030_4",
                height: "100%",
        ...
        //    tabid: "lyrTab",
        //    target: [
		//		{ type: "GRID", id: "grdData_현황", title: "발주서 목록" }
		//	]
        //};
        ////----------
    ...
    procedure: function () {
        ...
        function click_lyrMenu_납기등록(ui) {
            ...
            else if (gw_com_api.getValue("grdData_현황", "selected", "pstat", true) != "O") {
                gw_com_api.messageBox([
                    { text: "[" + gw_com_api.getValue("grdData_현황", "selected", "pstat_nm", true) + "] 상태의 발주서 입니다." }
                ], 350);
                return;
            }
...
function checkPrintable(param) {
    ...
    else if (gw_com_api.getValue("grdData_현황", "selected", "confirm2", true) != "OK") {
        gw_com_api.messageBox([
            { text: gw_com_api.getValue("grdData_현황", "selected", "confirm2", true) },
            { text: "납기등록 정보를 확인해 주세요." }
        ]);
        return false;
    }
    return true;
