...
var gw_job_process = {
    ...
    ready: function () {
        ...
        function start() { 
        	...
        	var args = { targetid: "grdData_Tracking", edit: true };
    ...
    UI: function () {
        ...
        //==== Find Grid : Option
        var args = {
            targetid: "grdData_Tracking", query: "", title: "이동 Tracking",
            height: "100%", pager: false, show: true,
            editable: { master: true, bind: "select", focus: "to_track_no", validate: true },
            element: [
				        {
    ...
    procedure: function () {
        ...
        //gw_com_module.eventBind(args);
        var args = { targetid: "grdData_Tracking", grid: true, event: "itemkeyup", handler: eventItemKeyUp };
        gw_com_module.eventBind(args);
        ...
        function eventItemKeyUp(ui) {
            if (ui.object == "grdData_Tracking") {
                ...
                if (event.keyCode == 17 || event.keyCode == 13) {
                    if ($.trim(gw_com_api.getValue("grdData_Tracking", "selected", "to_track_no", true)) == "") {
...
function processClear(param) {
    ...
    gw_com_api.show("grdData_Tracking");
