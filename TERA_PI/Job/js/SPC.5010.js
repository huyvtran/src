...
var gw_job_process = {
    ...
    UI: function () {
        ...
        var args = { targetid: "grdData_Main", query: "SPC_5010_M_1", title: "업체별 공정능력 현황",
            caption: false, height: 250, show: true, selectable: true, dynamic: true,
            color: { rule: [ 
            ...
            element: [
				...
				{ header: "검사항목수", name: "qc_qty", width: 46, align: "center" },
				{ header: "Best", name: "grade1_cnt", width: 46, align: "center" },
				{ header: "Acceptable", name: "grade2_cnt", width: 46, align: "center" },
				{ header: "Enough", name: "grade3_cnt", width: 46, align: "center" },
				{ header: "Poor", name: "grade4_cnt", width: 46, align: "center" },
				{ header: "Bad", name: "grade5_cnt", width: 46, align: "center" },
        ...
        //==== Grid : Detail ====
        var args = { targetid: "grdData_Detail", query: "SPC_5010_D_1", title: "판정기준",
            caption: true, height: 250, show: true, selectable: true, dynamic: true,
            color: { row: true }, pager: false,
            element: [
