...
var gw_job_process = {
    ...
    UI: function () {
        ...
        //=====================================================================================
        var args = {
            targetid: "grdList_MAIN", query: "PCN_1090_1", title: "변경점 검토 요청 현황",
                ...
                row: [
                    {
                        element: [
                            ...
                            { name: "issue_no", format: { type: "text", width: 166 } },
        ...
        //=====================================================================================
        var args = {
            targetid: "frmData_SUB", query: "PCN_1090_7", type: "TABLE", title: "TERA 검토결과",
