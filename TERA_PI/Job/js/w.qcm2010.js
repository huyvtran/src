...
//				{
//				    type: "PAGE", name: "모듈", query: "dddw_zcoder",
//				    param: [
//                        { argument: "arg_hcode", value: "IQDM22" }
//                    ]
//				},
                {
                ...
                },
                {
                    ...
                    data: [{ title: "초발", value: "0" }, { title: "재발", value: "1" }]
                }
			],
            starter: start
        };
    ...
    UI: function () {
                ...
                row: [
                    ...
                    },
                    {
                        element: [
                            ...
                            { name: "important_level", editable: { type: "select", data: { memory: "중요도" } } },
                    ...
                    },
                    {
                        element: [
                            { header: true, value: "발생현상", format: { type: "label" } },
                            {
                                ...
                                format: { type: "text", width: 1024 },
                                editable: { type: "text", width: 1024, validate: { rule: "required", message: "발생현상" } }
                            }
                        ]
                    },
                    {
                    ...
                    },
                    {
                        element: [
                            ...
                            { name: "upd_dt" },
                            { header: true, value: "확인일시", format: { type: "label" } },
                            { name: "adate" }
                        ]
                    },
                    {
                    ...
                    },
                    {
                        element: [
                            ...
                            { name: "rcr_yn", editable: { type: "select", data: { memory: "재발여부" } } },
        ...
        var args = {
            ...
            element: [
                { header: "순번", name: "issue_seq", width: 35, align: "center", editable: { type: "hidden" } },
				{
				    ...
				    editable: { type: "select", data: { memory: "모듈" } }
				},
				{
				    header: "현상분류", name: "status_tp1", width: 150, align: "center",
				    format: { type: "select", data: { memory: "현상분류" } },
				    editable: {
				        type: "select", data: { memory: "현상분류", by: [{ source: { id: "frmData_발생정보", row: 1, key: "prod_type" } }] },
				        change: [{ name: "status_tp2", memory: "현상구분", by: [{ source: { id: "frmData_발생정보", row: 1, key: "prod_type" } }, { key: "status_tp1" }] }]
				    }
				},
				{
				    ...
				    editable: {
				        type: "select",
				        data: { memory: "현상구분", by: [{ source: { id: "frmData_발생정보", row: 1, key: "prod_type" } }, { key: "status_tp1" }] }
				    }
				},
				{
				    header: "부위분류", name: "part_tp1", width: 150, align: "center",
				    format: { type: "select", data: { memory: "부위분류" } },
				    editable: {
				        type: "select", data: { memory: "부위분류", by: [{ source: { id: "frmData_발생정보", row: 1, key: "prod_type" } }] },
				        change: [{ name: "part_tp2", memory: "부위구분", by: [{ source: { id: "frmData_발생정보", row: 1, key: "prod_type" } }, { key: "part_tp1" }] }]
				    }
				},
				{
				    header: "부위구분", name: "part_tp2", width: 200, align: "center",
				    format: { type: "select", data: { memory: "부위구분" } },
				    editable: {
				        type: "select",
				        data: { memory: "부위구분", by: [{ source: { id: "frmData_발생정보", row: 1, key: "prod_type" } }, { key: "part_tp1" }] }
				    }
				},
                ...
                row: [
                    {
                        element: [
                            ...
                            {
                                name: "rmk_text",
                                format: { type: "textarea", rows: 5, width: 1024 },
                                editable: { type: "textarea", rows: 5, width: 1024 }
                            },
                ...
                row: [
                    {
                        element: [
                            ...
                            {
                                name: "rmk_text",
                                format: { type: "textarea", rows: 3, width: 1024 },
                                editable: { type: "textarea", rows: 3, width: 1024 }
                            },
                            { name: "rmk_cd", hidden: true, editable: { type: "hidden" } },
                            { name: "issue_no", hidden: true, editable: { type: "hidden" } }
                        ]
        ...
        //=====================================================================================
        var args = {
            targetid: "grdData_첨부파일", query: "w_qcm2010_S_7", title: "첨부 파일",
            ...
            element: [
				...
				{ header: "설명", name: "file_desc", width: 330, editable: { type: "text" } },
    ...
    procedure: function () {
        ...
        function click_lyrMenu_1_1_NCR(ui) {
            ...
            var args = { url: "COM", procedure: "PROC_NCR_CreateFromIssue",  nomessage: true,
                input: [
        ...
        if (gw_com_api.getPageParameter("chk_no") != "") {
            processInsert({});
        }
    ...
    if (param.sub) {
        ...
        var args = {
            ...
            data: [
                ...
                { name: "pstat", value: "발생" },
                { name: "issue_tp", value: (gw_com_api.getPageParameter("chk_no") != "") ? "수입" : "" }
            ],
            clear: [
		        { type: "GRID", id: "grdData_발생내역" },
		        { type: "GRID", id: "grdData_조치내역" },
