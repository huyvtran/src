    ...
    UI: function () {
        ...
        var args = {
            ...
            element: [
				...
				{
				    header: "관련코드", name: "rcode", width: 60, align: "center",
				    editable: { type: "text" }
				},
				//{
				//    header: "문자열1", name: "fcode1", width: 100, align: "left",
				//    editable: { type: "text" }
				//},
				//{
				//    header: "문자열2", name: "fcode2", width: 100, align: "left",
				//    editable: { type: "text" }
				//},
				//{
				//    header: "문자열3", name: "fcode3", width: 100, align: "left",
				//    editable: { type: "text" }
				//},
				//{
				//    header: "문자열4", name: "fcode4", width: 100, align: "left",
				//    editable: { type: "text" }
				//},
				//{
				//    header: "문자열5", name: "fcode5", width: 100, align: "left",
				//    editable: { type: "text" }
				//},
				//{
				//    header: "숫자값1", name: "dvalue1", width: 70, align: "center",
				//    editable: { type: "text" }
				//},
				//{
				//    header: "숫자값2", name: "dvalue2", width: 70, align: "center",
				//    editable: { type: "text" }
				//},
				//{
				//    header: "숫자값3", name: "dvalue3", width: 70, align: "center",
				//    editable: { type: "text" }
				//},
				{
				    header: "비고", name: "rmk", width: 300, align: "left",
				    editable: { type: "text" }
				}
			]
        };
