...
var gw_job_process = {
    ...
    UI: function () {
        ...
        var args = {
            tabid: "lyrFrame",
            target: [
				{ type: "PAGE", id: "EOM_5170", title: "설비 사용률", launch: true },
				{ type: "PAGE", id: "EOM_5180", title: "분류별 통계" },
				{ type: "PAGE", id: "EOM_5140", title: "Wafer 통계" },
				{ type: "PAGE", id: "EOM_5160", title: "Gas 통계" },
				{ type: "PAGE", id: "EOM_5150", title: "월별추이" },
                { type: "PAGE", id: "EOM_5110", title: "설비가동현황" }
			]
        };
