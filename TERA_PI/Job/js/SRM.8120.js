...
var gw_job_process = {
    ...
    UI: function () {
        ...
        //=====================================================================================
        var args = {
            targetid: "grdList_MAIN", query: "SRM_8120_1", title: "",
            ...
            element: [
				...
				{ header: "검수수량", name: "chk_qty", width: 50, align: "right", mask: "numeric-int" },
                { header: "결과", name: "chk_result_nm", width: 40, align: "center" },
                ...
                { header: "검수일(B)", name: "chk_date", width: 80, align: "center", mask: "date-ymd" },
                { header: "차이(B-A)", name: "date_diff", width: 60, align: "right", mask: "numeric-int" },
                { header: "선입고", name: "direct_yn", width: 50, align: "center", format: { type: "checkbox", value: "1", offval: "0", title: "" } },
                ...
                //{ header: "검수구분", name: "chk_yn_nm", width: 70, align: "center" },
            ]
        };
        //----------
