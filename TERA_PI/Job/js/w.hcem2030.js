...
var gw_job_process = {
    ...
    procedure: function () {
        ...
        function click_frmOption_2_3_취소(ui) {
            ...
            gw_com_api.setValue(getObject({ name: "Option" }), 1, "exchange_dt", gw_com_api.getValue(getObject({ name: "갑지" }), 1, "exchange_dt"));
            gw_com_api.setValue(getObject({ name: "Option" }), 1, "exchange_1", parseFloat(gw_com_api.getValue(getObject({ name: "갑지" }), 1, "exchange_1")));
            gw_com_api.setValue(getObject({ name: "Option" }), 1, "exchange_2", parseFloat(gw_com_api.getValue(getObject({ name: "갑지" }), 1, "exchange_2")));
            gw_com_api.setValue(getObject({ name: "Option" }), 1, "distribution_rate", parseFloat(gw_com_api.getValue(getObject({ name: "갑지" }), 1, "distribution_rate")));
            gw_com_api.setValue(getObject({ name: "Option" }), 1, "duty_rate", parseFloat(gw_com_api.getValue(getObject({ name: "갑지" }), 1, "duty_rate")));
            gw_com_api.setValue(getObject({ name: "Option" }), 1, "manage_rate", parseFloat(gw_com_api.getValue(getObject({ name: "갑지" }), 1, "manage_rate")));
            gw_com_api.setValue(getObject({ name: "Option" }), 1, "profit_rate", parseFloat(gw_com_api.getValue(getObject({ name: "갑지" }), 1, "profit_rate")));
            gw_com_api.setValue(getObject({ name: "Option" }), 1, "est_fix", gw_com_api.getValue(getObject({ name: "갑지" }), 1, "est_fix"));
        ...
        function click_frmOption_3_2_취소(ui) {
            ...
            gw_com_api.setValue("frmOption_3_2", 1, "mat_rate", gw_com_api.getValue(getObject({ name: "을지" }), "selected", "mat_rate", true));
