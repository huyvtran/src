...
var gw_job_process = {
    ...
    UI: function () {
        ...
        //=====================================================================================
        var args = {
            targetid: "grdData_목록", query: "w_find_emp_M_1", title: "사원 검색",
...
function informResult(param) {
    ...
    var args = {
        ...
        data: {
            dept_cd: gw_com_api.getValue("grdData_목록", (param.row != undefined ? param.row : "selected"), "dept_cd", true),
            dept_nm: gw_com_api.getValue("grdData_목록", (param.row != undefined ? param.row : "selected"), "dept_nm", true),
            emp_no: gw_com_api.getValue("grdData_목록", (param.row != undefined ? param.row : "selected"), "emp_no", true),
            emp_nm: gw_com_api.getValue("grdData_목록", (param.row != undefined ? param.row : "selected"), "emp_nm", true)
        }
    };
    gw_com_module.streamInterface(args);
        ...
        case gw_com_api.v_Stream.msg_selectEmployee:
            {
                ...
                if (gw_com_api.getValue("frmOption", 1, "emp_nm") == "" && gw_com_api.getValue("frmOption", 1, "dept_nm") == "") {
                    v_global.logic.auto_retrieve = false;
                }
