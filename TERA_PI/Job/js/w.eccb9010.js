...
var gw_job_process = {
    ...
    UI: function () {
        ...
        //=====================================================================================
        var args = { targetid: "grdData_목록", query: "w_eccb9010_M_1", title: "ECCB 위원",
            height: 442,
            show: true,
            number: true,
            selectable: true,
    ...
    procedure: function () {
        ...
        var args = {
            ...
            grid: true,
            event: "itemdblclick",
            handler: itemdblclick_grdData_목록
        };
        gw_com_module.eventBind(args);
        //----------
        var args = {
        ...
        function click_lyrMenu_추가(ui) {
            ...
            var args = {
                targetid: "grdData_목록",
                edit: true,
                data: [ { name: "root_seq", value: gw_com_api.getValue("frmOption", 1, "dept_area") } ]
            };
