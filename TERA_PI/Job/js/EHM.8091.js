...
var gw_job_process = {
    ...
    ready: function () {
        ...
        var args = {
            request: [
                    {
                        type: "PAGE", name: "사업부", query: "DDDW_CM_CODE",
    ...
    UI: function () {
        ...
        //=====================================================================================
        //var args = {
        //    targetid: "lyrMenu_down", type: "FREE", align:"left",
        //    element: [
        //        { name: "양식", value: "양식 다운로드", align: "left", icon: "저장" }
        //    ]
        //};
        ////----------
        ...
        //=====================================================================================
        var args = {
            targetid: "lyrMenu_down", type: "FREE",
            show: true, border: true, align: "left",
            editable: { bind: "open", focus: "cert_yn" },
            content: {
                row: [
                    {
                        element: [
                            {
                                name: "dept_area", label: { title: "사업부 : " }, maxlength: 20,
                                format:{ type:"select", width:1000 },
        ...
        $("#lyrMenu_down").css("padding-left", "5px");
        //=====================================================================================
        var args = {
            targetid: "lyrMenu", type: "FREE",
            element: [
                { name: "조회", value: "새로고침", act: true },
                { name: "양식", value: "양식 다운로드", align: "left", icon: "기타" },
                { name: "저장", value: "저장" },
                { name: "닫기", value: "닫기" }
            ]
        };
        ...
        //=====================================================================================
        var args = {
            targetid: "grdData_항목", query: "EHM_1010_M_1", title: "분류 항목",
            caption: true, width: 452, height: 138, show: true, selectable: true,
            element: [
                { header: "코드", name: "hcode", width: 120, align: "center" },
                { header: "항목", name: "hname", width: 305 },
                { name: "rcode2", hidden: true },
        ...
        //=====================================================================================
        var args = {
            targetid: "grdData_대분류", query: "EHM_1010_S_1", title: "대분류",
            caption: true, width: 452, height: 259, show: true, selectable: true,
            ...
            element: [
                ...
                {
                    header: "대분류", name: "dname", width: 160,
        ...
        //=====================================================================================
        var args = {
            targetid: "grdData_중분류", query: "EHM_1010_S_2", title: "중분류",
            caption: true, height: 184, show: true, selectable: true,
            ...
            element: [
                ...
                {
                    header: "중분류", name: "dname", width: 220, align: "left",
                    editable: { type: "text", validate: { rule: "required" } }
                },
                {
        ...
        //=====================================================================================
        var args = {
            targetid: "grdData_소분류", query: "EHM_1010_S_3", title: "소분류",
            caption: true, height: 184, show: true, selectable: true,
            editable: { multi: true, bind: "select", focus: "dcode", validate: true },
            element: [
                {
                ...
                {
                    header: "소분류", name: "dname", width: 220, align: "left",
                    editable: { type: "text", validate: { rule: "required" } }
                },
                {
                    header: "비고", name: "rmk", width: 250, align: "left",
                ...
                { name: "fcode1", hidden: true, editable: { type: "hidden" } },
                { name: "rcode", hidden: true, editable: { type: "hidden" } },
                { name: "hcode", hidden: true, editable: { type: "hidden" } }
            ]
        };
        ...
        var args = {
            target: [
                { type: "GRID", id: "grdData_항목", offset: 8 },
    ...
    procedure: function () {
        ...
        gw_com_module.eventBind(args);
        //----------
        var args = { targetid: "lyrMenu", element: "양식", event: "click", handler: click_lyrMenu_양식 };
        gw_com_module.eventBind(args);
        //----------
        ...
        gw_com_module.eventBind(args);
        //----------
        var args = { targetid: "grdData_항목", grid: true, event: "rowselecting", handler: rowselecting_grdData_항목 };
        gw_com_module.eventBind(args);
        //----------
        var args = { targetid: "grdData_항목", grid: true, event: "rowselected", handler: rowselected_grdData_항목 };
        gw_com_module.eventBind(args);
        //----------
        ...
        gw_com_module.eventBind(args);
        //----------
        var args = { targetid: "grdData_대분류", grid: true, event: "itemchanged", handler: itemchanged_grdData_대분류 };
        gw_com_module.eventBind(args);
        //----------
        ...
        //----------
        v_global.logic.part = gw_com_api.getPageParameter("part");
        v_global.logic.relation = gw_com_api.getPageParameter("relation") === "true";
...
function processRetrieve(param) {
    ...
    var args = {
        source: {
            type: "INLINE",
            argument: [
                { name: "arg_part", value: v_global.logic.part }
			]
        },
        target: [
			{ type: "GRID", id: "grdData_항목", select: true }
		],
        clear: [
			{ type: "GRID", id: "grdData_대분류" },
			{ type: "GRID", id: "grdData_중분류" },
...
function processLink(param) {
    ...
    if (param.detail) {
        args = {
            ...
            target: [
	            { type: "GRID", id: "grdData_소분류", select: true }
            ],
            key: param.key
        };
    }
        ...
        args = {
            source: {
                type: "GRID", id: "grdData_항목", row: "selected", block: true,
                element: [
...
function processInsert(param) {
    ...
    if (param.detail)
        args = {
            targetid: "grdData_소분류", edit: true,
            data: [
                { name: "hcode", value: gw_com_api.getValue("grdData_항목", "selected", "rcode3", true) },
                { name: "rcode", value: v_global.logic.relation ? gw_com_api.getValue("grdData_대분류", "selected", "dcode", true) : "" },
                { name: "fcode1", value: v_global.logic.relation ? gw_com_api.getValue("grdData_중분류", "selected", "dcode", true) : "" }
            ]
        };
    else if (param.sub)
        args = {
            targetid: "grdData_중분류", updatable: true, edit: true,
            data: [
        ...
        args = {
            targetid: "grdData_대분류", updatable: true, edit: true,
            data: [
...
function processDownLoad(param) {
    var dept = gw_com_api.getValue("lyrMenu_down", 1, "dept_area");
    if (dept == "" || dept == "%" || dept == "-" || dept == undefined) {
        gw_com_api.messageBox([{ text: "사업부를 선택하세요." }]);
        return;
    }
    var ReportTitle = "Daily_Report";
    var args = {
        option: [
...
function processRemove(param) {
    ...
    var args = {
        ...
        input: [
            ...
            { name: "type", value: v_global.logic.part, type: "varchar" },
