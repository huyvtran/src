...
var gw_job_process = {
    ...
    UI: function () {
        ...
        //==== Main Grid : 발생 내역
        var args = {
            targetid: "grdData_현황", query: "QDM_6210_M_2", title: "NCR 발행 내역",
            ...
            element: [
				...
				{ header: "접수일시", name: "rcpt_dt", width: 100, align: "center" },
				...
				{ header: "부적합원인", name: "rmk01", width: 300 },
                { header: "담당부서", name: "resp_dept_nm", width: 80 },
				{ header: "담당자", name: "user_nm", width: 50, align: "center" },
				{ header: "협력사", name: "supp_nm", width: 80, align: "center" },
                { header: "처리요구일", name: "actrqst_dt", width: 70, align: "center", mask: "date-ymd" },
				{ header: "처리상태", name: "astat2", width: 60, align: "center" },
				{ header: "처리계획일", name: "plan_dt", width: 70, align: "center", mask: "date-ymd" },
				{ header: "처리일자", name: "act_dt", width: 70, align: "center", mask: "date-ymd" },
				{ header: "결재일자", name: "chk_dt", width: 70, align: "center", mask: "date-ymd" },
				{ header: "조치수리내용", name: "rmk02", width: 300 },
				{ header: "재발방지대책", name: "rmk03", width: 300 },
				{ header: "확인계획일", name: "d3_plan_date", width: 70, align: "center", mask: "date-ymd" },
				{ header: "확인일시", name: "d3_astat_dt", width: 100, align: "center" },
				{ header: "확인결과", name: "d3_astat", width: 70, align: "center" },
				{ header: "확인비고", name: "d3_check_rmk", width: 300 },
				{ header: "확인자", name: "d3_astat_user_nm", width: 50, align: "center" },
                { header: "SOP유무", name: "standard_yn", width: 60, align: "center" },
                { header: "SOP준수여부", name: "follow_yn", width: 60, align: "center" },
                { header: "1차원인선택", name: "factor_tp", width: 100, align: "center" },
                { header: "1차원인근거", name: "basis_rmk", width: 200 },
				...
				{ header: "고객사", name: "cust_nm", width: 60, hidden: true },
				{ header: "Line", name: "cust_dept", width: 60, hidden: true },
                ...
                { header: "실시결과", name: "chk_rmk", width: 250, align: "center", hidden: true },
                ...
                { header: "표준번호", name: "standard_no", width: 100, align: "center", hidden: true },
                { header: "제조테스트유무", name: "ptest_yn", width: 60, align: "center", hidden: true },
...
//    }
    ...
    var args = { ID: gw_com_api.v_Stream.msg_linkPage,
        to: { type: "MAIN" },
        data: { page: "QDM_6220_VIEW", title: "NCR 보기",
            param: [
            	{ name: "AUTH", value: "R" },
