...
var gw_job_process = {
    ...
    UI: function () {
        ...
        //=====================================================================================
        var args = { targetid: "frmData_내역", query: "VOC_2100_M_2", type: "TABLE", title: "접수 내역",
            caption: true, show: true, selectable: true,
            editable: { bind: "select", focus: "voc_no", validate: true },
            content: {
                ...
                row: [ {
                        element: [
                            ...
                            { name: "issue_dt", mask: "date-ymd", format: { type: "text" } },
                            { header: true, value: "분류", format: { type: "label" } },
                            { name: "issue_tp", format: { type: "select", data: { memory: "분류" } } }
                        ]
                    },
                    {
                        element: [
                    ...
                    },
                    {
                        element: [
                            ...
                            { style: { colspan: 5 }, name: "issue_title", format: { type: "text", width: 800 } }
                        ]
                    },
                    {
                        element: [
                            { header: true, value: "요청내용", format: { type: "label" } },
                            { name: "issue_rmk", style: { colspan: 5 }, format: { type: "textarea", rows: 5, width: 800 } }
                        ]
                    },
                    {
                        element: [
        ...
        //==== Grid : Sub ====
        var args = { targetid: "grdData_담당", query: "VOC_2100_S_1", title: "담당 정보",
        ...
        //==== Form : Sub ====
        var args = { targetid: "frmData_담당", query: "VOC_2100_S_3", type: "TABLE", title: "담당자 처리 내역",
            caption: true, show: true, selectable: true,
    ...
    procedure: function () {
        ...
        //----------
        var args = {
            targetid: "grdData_정보", grid: true, event: "rowselecting",
            handler: rowselecting_grdData_정보
        };
        gw_com_module.eventBind(args);
        //----------
        var args = {
            targetid: "grdData_정보", grid: true, event: "rowselected",
            handler: rowselected_grdData_정보
        };
        gw_com_module.eventBind(args);
        //----------
        var args = {
            targetid: "grdData_담당", grid: true, event: "rowselecting",
            handler: rowselecting_grdData_담당
        };
        gw_com_module.eventBind(args);
        //----------
        var args = {
            targetid: "grdData_담당", grid: true, event: "rowselected",
            handler: rowselected_grdData_담당
        };
        gw_com_module.eventBind(args);
        //----------
        var args = {
            ...
            grid: true,
            event: "itemdblclick",
            handler: itemdblclick_grdData_담당
        };
        gw_com_module.eventBind(args);
        //----------
        var args = {
        ...
        //----------
        var nm = gw_com_api.getPageParameter("USR_NM");
        gw_com_api.setValue("frmOption", 1, "ymd_fr", gw_com_api.getDate("", { day: -10 }));
        gw_com_api.setValue("frmOption", 1, "ymd_to", gw_com_api.getDate(""));
        gw_com_api.setValue("frmOption", 1, "emp_nm", gw_com_api.getPageParameter("USR_NM"));
        //----------
...
function successSave(response, param) {
    ...
    if (gw_com_api.getValue("frmData_담당", 1, "result_cd") == "완료")
        processInform({ voc_no: gw_com_api.getValue("frmData_담당", 1, "voc_no"), charge_seq: gw_com_api.getValue("frmData_담당", 1, "charge_seq") });
...
function processInform(param) {
    ...
    var args = {
        url: "COM",
        procedure: "PROC_MAIL_EHM_VOCREQUEST",
        nomessage: true,
        argument: [
        ...
        input: [
            ...
            { name: "voc_no", value: param.voc_no + "," + param.charge_seq, type: "varchar" },
            { name: "type", value: "RESULT", type: "varchar" }
        ],
        output: [
