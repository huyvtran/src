...
var gw_job_process = {
    ...
    UI: function () {
        ...
        //==== Main Grid : 재고현황
        var args = {
            targetid: "grdData_Main", query: "SRM_4910_M", title: "",
        ...
        //==== Sub Grid : 수불현황
        var args = {
            targetid: "grdData_Sub", query: "SRM_4910_S", title: "",
            ...
            element: [
                ...
                {
                    header: "사업부", name: "plant_cd", width: 50, align: "center",
...
function processLink(param) {
    ...
    var args = {
        ...
        data: {
            page: "SRM_4940", title: "",
            param: [
                { name: "barcode", value: gw_com_api.getValue("grdData_Sub", "selected", "barcode", true) }
            ]
        }
    };
