...
var gw_job_process = {
    ...
    UI: function () {
        ...
        //==== Main Grid : 
        var args = { targetid: "grdData_Main", query: "EDM_3120_M_1", title: "분류1",
        ...
        //==== Main Chart : 
        var args = { targetid: "lyrChart_Main", query: "EDM_3120_M_1", show: true,
        ...
        //==== Sub Grid : 
        var args = { targetid: "grdData_Sub1", query: "EDM_3120_M_1", title: "분류2",
            caption: true, width: 325, height: 249, pager: true, show: true,
            element: [
				{ header: "분류명", name: "category", width: 175, align: "center" },
				{ header: "건수", name: "value", width: 60, align: "center", mask: "currency-int" },
        ...
        gw_com_module.gridCreate(args);
        //==== Sub Chart : 
        var args = { targetid: "lyrChart_Sub1", query: "EDM_3120_M_1", show: true,
            format: { view: "1", rotate: "0", reverse: "0" },
        ...
        //==== Sub Grid : 
        var args = { targetid: "grdData_Sub2", query: "EDM_3120_M_1", title: "분류3",
            caption: true, width: 325, height: 249, pager: true, show: true,
            element: [
				{ header: "분류명", name: "category", width: 175, align: "center" },
				{ header: "건수", name: "value", width: 60, align: "center", mask: "currency-int" },
        ...
        gw_com_module.gridCreate(args);
        //==== Sub Chart : 
        var args = { targetid: "lyrChart_Sub2", query: "EDM_3120_M_1", show: true,
            format: { view: "1", rotate: "0", reverse: "0" },
