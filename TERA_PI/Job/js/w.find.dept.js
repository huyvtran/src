...
var gw_job_process = {
    ...
    UI: function () {
        ...
        //=====================================================================================
        var args = {
            targetid: "grdData_목록", query: "w_find_dept_M_1", title: "부서 검색",
...
function informResult(param) {
    ...
    var args = {
        ID: gw_com_api.v_Stream.msg_selectedDepartment,
        data: {
...
streamProcess = function(param) {
    ...
    switch (param.ID) {
        case gw_com_api.v_Stream.msg_selectDepartment:
            {
                v_global.logic.auto_retrieve = false;
                ...
                if (gw_com_api.getValue("frmOption", 1, "dept_nm") == "") {
                    v_global.logic.auto_retrieve = false;
                }
