...
var gw_job_process = {
        ...
        var args = {
            request: [
				...
				},
				{
				    ...
				    param: [
                        { argument: "arg_hcode", value: "IEHM51" }
                    ]
				},
				{
    ...
    UI: function () {
        ...
        var args = {
            ...
            show: true,
            element: [
				{ header: "처리자", name: "category", width: 90, align: "center" },
				{ header: "대상건수", name: "value", width: 50, align: "center" },
				{ header: "처리건수", name: "value2", width: 50, align: "center" },
