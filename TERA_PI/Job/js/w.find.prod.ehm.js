    ...
    UI: function () {
                    ...
                    },
				    {
				        element: [
				            ...
				            },
				            {
				                ...
				                editable: { type: "text", size: 8, maxlength: 20 }, hidden: true
				            }
				        ]
				    },
				    {
        ...
        var args = {
            ...
            element: [
				...
				{
				    header: "Line", name: "cust_dept", width: 70, align: "center",
				    format: { type: "select", data: { memory: "LINE" } }
				},
				{
				    header: "Process", name: "cust_proc", width: 70, align: "center",
				...
				{ header: "장비명", name: "prod_nm", width: 200, align: "left", hidden: true },
				{ header: "Serial No.", name: "prod_key", width: 100, align: "center" },
...
function informResult(param) {
    ...
    var wrnt_ymd = gw_com_api.unMask(
                    gw_com_api.getValue("grdData_제품", "selected", "wrnt_ymd", true),
                    "date-ymd");
    var args = {
        ...
        data: {
            ...
            wrnt_io: (wrnt_ymd < gw_com_api.getDate()) ? "OUT" : "IN"
        }
    };
