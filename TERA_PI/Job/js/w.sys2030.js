...
var gw_job_process = {
    ...
    procedure: function () {
        ...
        function click_lyrMenu_수정(ui) {
            ...
            openPage([{ name: "nt_seq", value: gw_com_api.getValue("grdData_공지일람", "selected", "nt_seq", true) }]);
        ...
        gw_com_api.setValue("frmOption", 1, "to_date", gw_com_api.getDate(""));
        //----------
