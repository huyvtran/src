...
function processApprove(param) {
    ...
    var title = encodeURIComponent(Query.getApprovalTitle({ type: "ECO-END", ref_key1: v_global.logic.key }));
    var url = "http://gw.terasemicon.com/_ERPR/Public/ERPRLogin.aspx?UserId=" + gw_com_module.v_Session.USR_ID
        + "&Pwd=&Lang=ko&EAID=109&gw_num=100&htmltag=&eco_no=%27" + v_global.logic.key + "%27&NextUrl=/_EAPP/EADocumentWrite.aspx?FormID=109&ErpDocTitle=" + title;
