...
var gw_job_process = {
    ...
    UI: function () {
        ...
        //=====================================================================================
        var args = { targetid: "grdData_Main", query: "EHM_2111", title: "자재 반입 목록",
...
function processOK(param) {
    ...
    $.each(ids, function () {
        rows.push({
            ...
            apart_cd: gw_com_api.getCellValue("GRID", "grdData_Main", this, "apart_cd"),
            apart_nm: gw_com_api.getCellValue("GRID", "grdData_Main", this, "apart_nm"),
            apart_sno: gw_com_api.getCellValue("GRID", "grdData_Main", this, "apart_sno"),
