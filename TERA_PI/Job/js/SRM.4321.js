...
var gw_job_process = {
    ...
    UI: function () {
        ...
        //=====================================================================================
        var args = { targetid: "grdData_Find", title: "납품서 번호 입력",
            ...
            element: [
				...
				editable: { type: "text", width: 100, size: 60, maxlength: 10 }
				},
				...
				{ header: "협력사명", name: "supp_nm", width: 120, align: "left"
					, editable: { type: "hidden" }
				},
                ...
                {  header: "오류", name: "err_msg", width: 220, align: "left"
                	, editable: { type: "hidden" }
                }
			]
        };
        ...
        var args = {
            ...
            height: 350, pager: true, caption: true, show: true, multi: true, checkrow: true,
            element: [
				{ header: "협력사", name: "supp_nm", width: 170, align: "left" }
...
function informResult(param) {
    ...
    $.each(ids, function () {
        ...
        if (sSuppCD != undefined && sSuppCD != gw_com_api.getValue("grdData_List", this, "supp_cd", true)) {
            suppChk = false;
            return false;
        }
    ...
    if (!suppChk) {
        gw_com_api.messageBox([{ text: "동일한 협력사의 납품서를 선택하세요." }]);
        return false;
    }
...
streamProcess = function (param) {
    ...
    switch (param.ID) {
        case gw_com_api.v_Stream.msg_selectPart_SCM: {
            ...
            processRetrieve({});
            gw_com_api.setFocus("frmOption", 1, "dlv_no");
        } break;
