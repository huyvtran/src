    ...
    UI: function () {
        ...
        var args = {
            ...
            element: [
                ...
                {
                    header: "검수일", name: "qc_dt", width: 100, align: "center",
    ...
    switch (param.object) {
        case "grdData_Main":
            if (param.element == "qc_usr" || param.element == "qc_dt" || param.element == "qc_tp" || param.element == "duty_tp") {
                ...
                if (param.element == "qc_usr" && gw_com_api.getValue(param.object, param.row, "qc_dt", (param.type == "GRID" ? true : false)) == "") {
                    gw_com_api.setValue(param.object, param.row, "qc_dt", gw_com_api.getDate(""), (param.type == "GRID" ? true : false));
                } else if (param.element == "qc_dt" && gw_com_api.getValue(param.object, param.row, "qc_usr", (param.type == "GRID" ? true : false)) == "") {
                    gw_com_api.setValue(param.object, param.row, "qc_usr", gw_com_module.v_Session.USR_NM, (param.type == "GRID" ? true : false));
                }
            }
            break;
    }
