...
function processSave(param) {
    ...
    if (gw_com_api.getValue("frmData_MAIN", 1, "dept_cd") == "" &&
        gw_com_api.getValue("frmData_MAIN", 1, "user_id") == "") {
        gw_com_api.setError(true, "frmData_MAIN", 1, "dept_cd", false, false);
        gw_com_api.setError(true, "frmData_MAIN", 1, "user_id", false, false);
        gw_com_api.messageBox([{ text: "담당자를 지정하세요." }]);
        return false;
    }
    gw_com_api.setError(false, "frmData_MAIN", 1, "dept_cd", false, false);
    gw_com_api.setError(false, "frmData_MAIN", 1, "user_id", false, false);
