    ...
    UI: function () {
        ...
        var args = {
            ...
            element: [
				...
				{ name: "저장", value: "저장" },
                { name: "통보", value: "통보", icon: "기타", updatable: true },
				{ name: "삭제", value: "삭제" },
				{ name: "닫기", value: "닫기" }
			]
        };
            ...
            element: [
				{
				    ...
				    editable: { type: "text", validate: { rule: "required" }, width: 154 }
				},
				{
                ...
                row: [
                    ...
                    },
                    {
                        element: [
                            ...
                            { name: "chk_rmk", style: { colspan: 3 }, format: { type: "text", width: 610 } },
        ...
        //=====================================================================================
        var args = {
            targetid: "grdData_File1", query: "QDM_6220_F_1", title: "첨부 문서",
    ...
    if (param.object == "grdData_Sub") {
        ...
        args = {
            ...
            source: {
                type: "FORM", id: "frmData_Main",
                element: [
                    { name: "rqst_no", argument: "arg_data_key" }
                ],
                argument: [
...
function processDelete(ui) {
    ...
    if (ui.object == "lyrMenu_Sub") {
        ...
        if (gw_com_api.getValue("grdData_File1", "selected", "_edit_yn", true) == "0") {
            gw_com_api.showMessage("문제발생 첨부파일은 삭제할 수 없습니다.");
            return;
        }
...
function processBatch(param) {
    var args = {
        ...
        argument: [
            { name: "key_no", value: v_global.logic.key }
        ],
        input: [
            { name: "type", value: param.type, type: "varchar" },
            { name: "key_no", value: v_global.logic.key, type: "varchar" },
