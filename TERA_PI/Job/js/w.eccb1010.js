...
var gw_job_process = {
                ...
                row: [
                    ...
                    },
                    {
                        element: [
                            ...
                            {
                                style: { colspan: 3 }, name: "ecr_title", format: { width: 630 },
                                editable: { type: "text", width: 630, validate: { rule: "required" } }
                            },
                            { header: true, value: "작성자/부서", format: { type: "label" } },
                            {
                                name: "ecr_emp_nm", style: { colfloat: "float" }, display: true,
                                format: { type: "text", width: 60 },
                                editable: { type: "hidden", width: 60 }
                            },
                            {
                            ...
                            //{
                            //    name: "ecr_emp", style: { colfloat: "float" }, display: true,
                            //    editable: { type: "select", data: { memory: "사원" }, width: 60 }
                            //},
                            //{
                            //    name: "ecr_dept", style: { colfloat: "floated" }, display: true,
                            //    editable: { type: "select", data: { memory: "부서" }, width: 120 }
                            //}
                        ]
                    },
                    {
                        element: [
                            ...
                            {
                                style: { colspan: 3 }, name: "ecr_desc", format: { width: 630 },
                                editable: { type: "text", width: 630 }
                            },
                            //{ header: true, value: "작성부서", format: { type: "label" } },
                            //{ name: "ecr_dept", display: true, editable: { type: "select", data: { memory: "부서" } } }
                            { header: true, value: "작성일자", format: { type: "label" } },
                            { name: "ecr_dt", mask: "date-ymd", editable: { type: "text", validate: { rule: "required" } } }
                        ]
                    },
                    {
                        element: [
                            ...
                            {
                                name: "act_time", style: { colspan: 3, colfloat: "float" }, //display: true,
                                format: { width: 0 }, editable: { type: "select", data: { memory: "조치시점" }, width: 155 }
                            ...
                            { name: "act_rqst_date", mask: "date-ymd", editable: { type: "text" } }
                        ]
                    },
                    {
                        element: [
                            { header: true, value: "실행요청부서", format: { type: "label" } },
                            { name: "rqst_dept", editable: { type: "select", data: { memory: "실행요청부서" }, validate: { rule: "required" } } },
                    ...
                    },
                    {
                        element: [
                            ...
                            {
                                name: "act_region1", format: { width: 0 }, style: { colspan: 5, colfloat: "float" },
                                editable: {
                                    type: "select", data: { memory: "분류1", unshift: [{ title: "", value: "" }] },
                                    change: [{ name: "act_module1", memory: "분류2_IN", unshift: [{ title: "", value: "" }], key: ["act_region1"] }],
                                    width: 155, validate: { rule: "required" }
                                }
                            },
                            ...
                            {
                                name: "act_module1", format: { width: 0 },
                                style: { colfloat: "floating" }, //display: true,
                                format: { width: 0 },
                                editable: {
                                    type: "select", width: 155,
                                    data: { memory: "분류2_IN", key: ["act_region1"], unshift: [{ title: "", value: "" }] },
                                    validate: { rule: "required" }
                                }
                            },
                            {
                                name: "act_module1_etc", format: { width: 0 }, style: { colfloat: "floating" }, display: true,
                            ...
                            {
                                name: "mp_class1", format: { width: 0 }, style: { colfloat: "floating" }, //display: true,
                                editable: {
                    ...
                    },
                    {
                        element: [
                            ...
                            {
                                name: "act_region2", format: { width: 0 }, style: { colspan: 5, colfloat: "float" },
                                editable: {
                                    type: "select", data: { memory: "분류1", unshift: [{ title: "", value: "" }] },
                                    change: [{ name: "act_module2", memory: "분류2_IN", unshift: [{ title: "", value: "" }], key: ["act_region2"] }],
                                    width: 155
                                }
                            },
                            { name: "act_region2_text", style: { colfloat: "floating" }, format: { width: 200 } },
                            { name: "act_module2_text", style: { colfloat: "floating" }, format: { width: 300 } },
                            {
                                name: "act_module2", format: { width: 0 }, style: { colfloat: "floating" }, //display: true,
                                format: { width: 0 },
                                editable: {
                                    type: "select", width: 155,
                                    data: { memory: "분류2_IN", key: ["act_region2"], unshift: [{ title: "", value: "" }] }
                                }
                            },
                            {
                                name: "act_module2_etc", style: { colfloat: "floating" },
                            ...
                            {
                                name: "mp_class2", style: { colfloat: "floating" }, //display: true,
                                format: { width: 0 },
                                editable: { type: "select", data: { memory: "분류3", unshift: [{ title: "", value: "" }] }, width: 155 }

                            },
                            {
                                name: "mp_class2_etc", style: { colfloat: "floated" }, display: true,
                                format: { width: 0 },
                                editable: { type: "text", width: 155 }
                            }//,
                    ...
                    },
                    {
                        element: [
                            { header: true, value: "", format: { type: "label" } },
                            {
                                name: "act_region3", style: { colspan: 5, colfloat: "float" },
                                format: { width: 0 },
                                editable: {
                                    type: "select", data: { memory: "분류1", unshift: [{ title: "", value: "" }] },
                                    change: [{ name: "act_module3", memory: "분류2_IN", unshift: [{ title: "", value: "" }], key: ["act_region3"] }],
                                    width: 155
                                }
                            },
                            { name: "act_region3_text", style: { colfloat: "floating" }, format: { width: 200 } },
                            { name: "act_module3_text", style: { colfloat: "floating" }, format: { width: 300 } },
                            {
                                name: "act_module3", style: { colfloat: "floating" }, //display: true,
                                format: { width: 0 },
                                editable: {
                                    type: "select", width: 155,
                                    data: { memory: "분류2_IN", key: ["act_region3"], unshift: [{ title: "", value: "" }] }
                                }
                            },
                            {
                                name: "act_module3_etc", style: { colfloat: "floating" }, display: true,
                                format: { width: 0 },
                                editable: { type: "text", width: 155 }
                            },
                            //{ name: "act_module3", hidden: true, editable: { type: "hidden" } },
                            { name: "mp_class3_text", style: { colfloat: "floating" }, format: { width: 200 } },
                            {
                                name: "mp_class3", style: { colfloat: "floating" }, //display: true,
                                format: { width: 0 },
                                editable: { type: "select", data: { memory: "분류3", unshift: [{ title: "", value: "" }] }, width: 155 }
                            },
                            {
                                name: "mp_class3_etc", style: { colfloat: "floated" }, display: true,
                                format: { width: 0 },
                                editable: { type: "text", width: 155 }
                            }//,
                    ...
                    },
                    {
                        element: [
                            { header: true, value: "개선예상효과", format: { type: "label" } },
                            {
                                ...
                                editable: { type: "textarea", rows: 5, width: 630 }
                            },
                    ...
                    },
                    {
                        element: [
                            ...
                            {
                                name: "gw_aemp", style: { colfloat: "float" },
                                format: { width: 70 }
                            },
    ...
    procedure: function () {
        ...
        //----------
        var args = { targetid: "lyrMenu_1", element: "상신", event: "click", handler: click_lyrMenu_1_상신 };
        gw_com_module.eventBind(args);
        //----------
        ...
        function itemchanged_frmData_내역(ui) {
            ...
            switch (ui.element) {
                ...
                case "act_region3":
                    if (ui.value.current == "") {
                        var seq = ui.element.substr(ui.element.length - 1, ui.element.length)
                        var em1 = "act_module" + seq;
                        var em2 = "act_module" + seq + "_etc";
                        var em3 = "mp_class" + seq;
                        var em4 = "mp_class" + seq + "_etc";
                        gw_com_api.setValue(ui.object, ui.row, em1, "");
                        gw_com_api.setValue(ui.object, ui.row, em2, "");
                        gw_com_api.setValue(ui.object, ui.row, em3, "");
                        gw_com_api.setValue(ui.object, ui.row, em4, "");
                    }
                    break;
                case "act_time":
                case "act_module1":
                ...
                //        if (gw_com_api.getValue(ui.object, ui.row, em) == 1000)
...
function processSave(param) {
    ...
    if (gw_com_api.getValue("frmData_내역", 1, "act_module1") == "00") {
        gw_com_api.setError(true, "frmData_내역", 1, "act_module1");
        gw_com_api.messageBox([
    ...
    if (gw_com_api.getValue("frmData_내역", 1, "act_time") == "1000" && gw_com_api.getValue("frmData_내역", 1, "act_time_etc") == "") {
        err = true;
        gw_com_api.setError(true, "frmData_내역", 1, "act_time_etc");        
    }
    if (gw_com_api.getValue("frmData_내역", 1, "act_module1") == "1000" && gw_com_api.getValue("frmData_내역", 1, "act_module1_etc") == "") {
        err = true;
        gw_com_api.setError(true, "frmData_내역", 1, "act_module1_etc");
    }
    if (gw_com_api.getValue("frmData_내역", 1, "act_module2") == "1000" && gw_com_api.getValue("frmData_내역", 1, "act_module2_etc") == "") {
        err = true;
        gw_com_api.setError(true, "frmData_내역", 1, "act_module2_etc");
    }
    if (gw_com_api.getValue("frmData_내역", 1, "act_module3") == "1000" && gw_com_api.getValue("frmData_내역", 1, "act_module3_etc") == "") {
        err = true;
        gw_com_api.setError(true, "frmData_내역", 1, "act_module3_etc");
    }
    if (gw_com_api.getValue("frmData_내역", 1, "mp_class1") == "1000" && gw_com_api.getValue("frmData_내역", 1, "mp_class1_etc") == "") {
        err = true;
        gw_com_api.setError(true, "frmData_내역", 1, "mp_class1_etc");
    }
    if (gw_com_api.getValue("frmData_내역", 1, "mp_class2") == "1000" && gw_com_api.getValue("frmData_내역", 1, "mp_class2_etc") == "") {
        err = true;
        gw_com_api.setError(true, "frmData_내역", 1, "mp_class2_etc");
    }
    if (gw_com_api.getValue("frmData_내역", 1, "mp_class3") == "1000" && gw_com_api.getValue("frmData_내역", 1, "mp_class3_etc") == "") {
        err = true;
