...
var gw_job_process = {
    ...
    UI: function () {
        ...
        //==== Main Grid
        var args = { targetid: "grdData_Main", query: "EOM_5170_M_1", title: "설비별 가동율",
            caption: true, width: "100%", height: "100%", pager: false, show: true,
            element: [
				{ header: "설비", name: "category", width: 100, align: "center" },
				{ header: "예약시간", name: "plan_time", width: 80, align: "center" },
				{ header: "예약대비", name: "plan_rate", width: 80, align: "center" },
				{ header: "다운율", name: "down_rate", width: 80, align: "center" },
				{ header: "실가동율", name: "run_rate", width: 80, align: "center" },
				{ header: "가동시간", name: "run_time", width: 80, align: "center" },
				{ header: "H/W Modify", name: "modify_time", width: 80, align: "center" },
				{ header: "H/W Test", name: "test_time", width: 80, align: "center" },
				{ header: "계측", name: "measure_time", width: 80, align: "center" },
				{ header: "Down", name: "down_time", width: 80, align: "center" },
				{ header: "Demo대기", name: "demo_time", width: 80, align: "center" },
				{ header: "설비교육", name: "edu_time", width: 80, align: "center" },
				{ name: "ymd_fr", hidden: true },
				{ name: "ymd_to", hidden: true },
				{ name: "rcode", hidden: true },
				{ name: "chart", hidden: true },
				{ name: "eq_dept", hidden: true }
			]
        };
        gw_com_module.gridCreate(args);

        //==== Main Chart
        var args = { targetid: "lyrChart_Main", query: "EOM_5170_C_1", title: "설비별 가동율", show: true,
        ...
        //==== Sub Grid
        var args = { targetid: "grdData_Sub", query: "EOM_5170_M_2", title: "모듈별 가동율",
            caption: true, width: "100%", height: 200, pager: false, show: true,
            element: [
				{ header: "모듈", name: "eq_module", width: 180, align: "center" },
				{ header: "예약시간", name: "plan_time", width: 80, align: "center" },
				{ header: "예약대비", name: "plan_rate", width: 80, align: "center" },
				{ header: "다운율", name: "down_rate", width: 80, align: "center" },
				{ header: "실가동율", name: "run_rate", width: 80, align: "center" },
        ...
        //==== Sub Chart
        var args = { targetid: "lyrChart_Sub", query: "EOM_5170_C_2", title: "모듈별 가동율", show: true,
            format: { view: "1", rotate: "0", reverse: "1" },
