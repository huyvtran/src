...
var gw_job_process = {
    ...
    UI: function () {
        ...
        //==== Grid : Main ====
        var args = { targetid: "grdData_Main", query: "EOM_2164_M_1", title: "Process 외 실적 내역",
            caption: true, pager: true, show: true, height: "420", selectable: true, number: true,
            ...
            element: [
                ...
                { header: "시작일", name: "fr_date", width: 80, align: "center", mask: "date-ymd" },
                { header: "시각(S)", name: "fr_time", width: 60, align: "center", mask: "time-hm" },
				...
				{ header: "실적시간", name: "stat_hour", width: 60, align: "center" },
