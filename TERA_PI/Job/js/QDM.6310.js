...
var gw_job_process = {
    ...
    UI: function () {
        ...
        //==== Main Grid : 발생 내역
        var args = {
            targetid: "grdData_현황", query: "QDM_6310_M_1", title: "NCR 처리 내역",
            ...
            element: [
				...
				{ header: "발행자", name: "rqst_user_nm", width: 60, align: "center" },
				...
				{ header: "처리자", name: "astat_user_nm", width: 60, align: "center", hidden: true },
