...
var gw_job_process = {
    ...
    UI: function () {
            ...
            content: { row: [
                ...
                },
                {
                    element: [
			            ...
			            {
			                name: "draft_emp", label: { title: "기안자 :" },
                ...
                },
                {
                    element: [
                        {
                            name: "cip_title", label: { title: "검증Test 제목 :" },
                            editable: { type: "text", size: 27, maxlength: 50 }
                        },
			            {
        ...
        //=====================================================================================
        var args = {
            targetid: "frmOption_4", type: "FREE",
            trans: true, border: true, show: false, margin: 10,
            content: {
                row: [
                    {
                        align: "center",
        ...
        //=====================================================================================
        var args = {
            targetid: "grdData_현황", query: "w_eccb3012_M_1", title: "검증Test 현황",
            height: 442, show: true, selectable: true, key: true, dynamic: true,
            element: [
				{ header: "검증Test No.", name: "cip_no", width: 90, align: "center" },
				...
				{ header: "TEST장비", name: "test_model", width: 200, align: "left" },
				...
				{ header: "시작예정일", name: "plan_str_dt", width: 80, align: "center", mask: "date-ymd" },
				{ header: "완료예정일", name: "plan_end_dt", width: 80, align: "center", mask: "date-ymd" },
				{ header: "시작일", name: "str_dt", width: 80, align: "center", mask: "date-ymd" },
				{ header: "완료일", name: "end_dt", width: 80, align: "center", mask: "date-ymd" },
				{ header: "대표실행자", name: "act_emp_nm", width: 70, align: "center" },
				{ header: "공동실행자", name: "sub_emp_nm", width: 70, align: "center" },
				{ header: "기안일", name: "draft_dt", width: 80, align: "center", mask: "date-ymd" },
				{ header: "기안부서", name: "draft_dept_nm", width: 70, align: "center" },
				{ header: "기안자", name: "draft_emp_nm", width: 70, align: "center" },
				...
				{ name: "draft_astat_nm", hidden: true },
				{ name: "rpt_astat_nm", hidden: true },
				{ name: "draft_usr", hidden: true },
    ...
    var args = {
        source: {
            ...
            element: [
				...
				{ name: "draft_emp", argument: "arg_draft_emp" },
