...
var gw_job_process = {
    ...
    UI: function () {
        ...
        var args = { targetid: "frmOption", type: "FREE", title: "조회 조건",
            ...
            content: { row: [
                    ...
                    { element: [
                        ...
                        { name: "status_tp2", label: { title: "중분류 :" },
                            editable: { type: "select", width: 90, data: { memory: "현상분류2", key: ["status_tp1"], unshift: [{ title: "-", value: "%"}] } }
                        }
				    ] },
				    { align: "right", element: [
        ...
        //==== Main Grid
        var args = { targetid: "grdData_Main", query: "EOM_5180_C_1", title: "설비별(Run 이외)",
            caption: true, width: "240", height: 200, pager: false, show: true,
            element: [
				{ header: "호기", name: "category", width: 80, align: "center" },
        ...
        //==== Main Chart
        var args = { targetid: "lyrChart_Main", query: "EOM_5180_C_1", title: "설비별(Run 이외)", show: true,
        ...
        //==== Sub Grid
        var args = { targetid: "grdData_Sub", query: "EOM_5180_C_2", title: "모듈별(Run 이외)",
            caption: true, width: "240", height: 200, pager: false, show: true,
            element: [
				{ header: "모듈", name: "category", width: 80, align: "center" },
				{ header: "Rate", name: "value", width: 60, align: "center" },
				{ header: "Time", name: "time", width: 60, align: "center" },
				{ name: "rcode", hidden: true }
			]
        ...
        //==== Sub Chart
        var args = { targetid: "lyrChart_Sub", query: "EOM_5180_C_2", title: "모듈별(Run 이외)", show: true,
            format: { view: "1", rotate: "0", reverse: "1" },
        ...
        //==== Sub Grid
        var args = { targetid: "grdData_3", query: "EOM_5180_C_3", title: "분류별(Run 이외)",
            caption: true, width: "240", height: 200, pager: false, show: true,
            element: [
        ...
        //==== Sub Chart
        var args = { targetid: "lyrChart_3", query: "EOM_5180_C_3", title: "분류별(Run 이외)", show: true,
            format: { view: "1", rotate: "0", reverse: "1" },
     ...
     var args = {
        source: { type: "FORM", id: "frmOption", hide: true,
            ...
            remark: [
		        ...
		        { element: [{ name: "status_tp1" }] }, { element: [{ name: "status_tp2" }] }
            ]
        },
        target: [
...
function processLink(param) {
    ...
    if (param.object == "grdData_Main") {
	    ...
	    args.clear = [ { type: "GRID", id: "grdData_4" }, { type: "CHART", id: "lyrChart_4" } ] ;
	    ...
	    args.clear = [ { type: "GRID", id: "grdData_5" }, { type: "CHART", id: "lyrChart_5" } ] ;
	    args.source.argument = [ 
	    	{ name: "arg_eq_module", value: gw_com_api.getValue("grdData_Sub", "selected", "rcode", true) },
