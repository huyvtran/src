...
var gw_job_process = {
    ...
    UI: function () {
        ...
        //=====================================================================================
        var args = {
            targetid: "frmData_내역", query: "w_eccb3020_M_1", type: "TABLE", title: "검증Test 완료 정보",
            caption: true, show: true, selectable: true,
            editable: { bind: "select", focus: "str_dt", validate: true },
            content: { width: { label: 100, field: 190 }, height: 25,
                row: [
                    {
                        element: [
                            { header: true, value: "검증Test No.", format: { type: "label" } },
                    ...
                    {
                        element: [
                            { header: true, value: "최종승인상태", format: { type: "label" } },
                            { name: "gw_astat_nm" },
                    ...
                    },
                    {
                        element: [
                            ...
                            { header: true, value: "기안자", format: { type: "label" } },
                            { name: "draft_emp_nm" }
                        ]
                    },
                    {
                        element: [
                            { header: true, value: "TEST장비", format: { type: "label" } },
                            { name: "test_model", style: { colspan: 3 }, format: { width: 500 } },
                            { header: true, value: "보고자", format: { type: "label" } },
                            {
                                name: "rpt_emp",
                    ...
                    {
                        element: [
                            { header: true, value: "시작예정일", format: { type: "label" } },
                            { name: "plan_str_dt", mask: "date-ymd" },
                            { header: true, value: "완료예정일", format: { type: "label" } },
                            { name: "plan_end_dt", mask: "date-ymd" },
                            { header: true, value: "보고부서", format: { type: "label" } },
                            {
                                name: "rpt_dept",
                    ...
                    },
                    {
                        element: [
                            ...
                            { name: "str_dt", mask: "date-ymd", editable: {  type: "text" } },
                            { header: true, value: "완료일", format: {  type: "label" }  },
                            { name: "end_dt", mask: "date-ymd", editable: {  type: "text" } },
                            { header: true, value: "보고일자", format: {  type: "label" }  },
                    ...
                    },
                    {
                        element: [
                            ...
                            {
                                name: "act_region1", style: { colspan: 5, colfloat: "float" },
                                format: { width: 0 },
                                editable: {
                            ...
                            { name: "mp_class1_text", style: { colfloat: "floating" }, format: { width: 200 } },
                            {
                                ...
                                editable: {
                                    type: "select", width: 155, display: true,
                    ...
                    { element: [
                            ...
                            {
                                style: { colfloat: "floating" },
                                name: "act_module2_text", format: { width: 300 }
                            },
                            {
                                style: { colfloat: "floating" },
                                ...
                                editable: {
                                    type: "select",
                                    data: { memory: "분류2", unshift: [{ title: "-", value: "" }] }, width: 155
                                }, display: true
                            },
                            {
                                style: { colfloat: "floating" },
                                name: "act_module2_etc", format: { width: 0 },
                            ...
                            { name: "mp_class2_sel", style: { colfloat: "floating" }, format: {  width: 0 }, display: true,
                                editable: { type: "select", width: 155,
                                    data: { memory: "분류3", unshift: [{ title: "-", value: "" }] }
                                }
                            },
                            {
                        ...
                        element: [
                            { header: true, value: "", format: {  type: "label" }  },
                            {
                                ...
                                editable: { type: "select",
                                    data: { memory: "분류1",  unshift: [{ title: "-", value: "" }] }, width: 155
                                }
                            },
                            {
                                style: { colfloat: "floating" },
                                name: "act_region3_text", format: { width: 200 }
                            },
                            {
                                style: { colfloat: "floating" },
                                name: "act_module3_text", format: { width: 300 }
                            },
                            {
                                style: { colfloat: "floating" },
                            ...
                            {
                                style: { colfloat: "floating" },
                                name: "act_module3_etc", format: {  width: 0 },
                                editable: { type: "text", width: 155 }, display: true
                            },
                            {
                            ...
                            {
                                style: { colfloat: "floating" },
                                name: "mp_class3_text", format: { width: 200 }
                            },
                            {
                                style: { colfloat: "floating" },
                                name: "mp_class3_sel", format: {  width: 0 },
                                editable: {
                                    type: "select",
                                    data: { memory: "분류3", unshift: [{ title: "-", value: "" }] }, width: 155
                                }, display: true
                            },
                            {
                                style: { colfloat: "floated" },
                                name: "mp_class3_etc", format: { width: 0 },
                                editable: { type: "text", width: 155 }, display: true
                            },
                    ...
                    {
                        element: [
                            { header: true, value: "대표실행자", format: { type: "label" } },
                            {
                                name: "act_emp_nm", mask: "search", display: true,
                                editable: { type: "text" }
                            },
                            { header: true, value: "공동실행자", format: {  type: "label" }  },
                            {
                                style: { colspan: 3, colfloat: "float" },
                                name: "sub_emp1_nm", mask: "search", display: true,
                                format: { width: 70 }, editable: { type: "text", width: 155 }
                            },
                            {
                                style: { colfloat: "floating" },
                                name: "sub_emp2_nm", mask: "search", display: true,
                                format: { width: 70 }, editable: { type: "text", width: 155 }
                            },
                            {
                                style: { colfloat: "floated" },
                                name: "sub_emp3_nm", mask: "search", display: true,
                                format: { width: 70 }, editable: { type: "text", width: 155 }
                            },
                            { name: "act_emp", hidden: true, editable: { type: "hidden" } },
                            { name: "sub_emp1", hidden: true, editable: { type: "hidden" } },
                            { name: "sub_emp2", hidden: true, editable: { type: "hidden" } },
                            { name: "sub_emp3", hidden: true, editable: { type: "hidden" } }
                        ]
                    },
                    {
                        element: [
                            { header: true, value: "예상소요경비", format: {  type: "label" }  },
                            {
                                style: { colspan: 3 },
                                name: "plan_cost_note", format: { type: "textarea", rows: 5, width: 500 }
                            },
                            { header: true, value: "총금액", format: { type: "label" } },
                            { name: "plan_cost", mask: "currency-ko" }
                        ]
                    },
                    {
                        element: [
                            { header: true, value: "실제소요경비", format: { type: "label" } },
                            {
                                style: { colspan: 3 },
                                name: "act_cost_note", format: { type: "textarea", rows: 5, width: 500 },
                                editable: { type: "textarea", rows: 5, width: 500 }
                            },
                            { header: true, value: "총금액", format: { type: "label" } },
                            { name: "act_cost", mask: "currency-ko", editable: { type: "text" } }
                        ]
                    },
                    {
                        element: [
                            { header: true, value: "횡전개 시<br>총 예상비용", format: { type: "label" } },
                            {
                                style: { colspan: 5 },
                                name: "act_amt_note", format: { type: "textarea", rows: 5, width: 800 },
                    ...
                    },
                    {
                        element: [
                            ...
                            {
                                style: { colspan: 5 },
                                name: "rmk", format: { type: "textarea", rows: 5, width: 800 },
                                editable: { type: "textarea", rows: 5, width: 800 }
                            }
                        ]
                    }
        ...
        var args = {
            ...
            element: [
                ...
                { header: "제품명", name: "prod_nm", width: 300, align: "left" },
        ...
        //=====================================================================================
        var args = {
            targetid: "frmData_메모A", query: "w_eccb3010_S_2_1", type: "TABLE", title: "TEST 내용",
        ...
        //=====================================================================================
        var args = {
            targetid: "frmData_메모B", query: "w_eccb3010_S_2_2", type: "TABLE", title: "TEST 결과",
            caption: true, show: true, fixed: true, selectable: true,
            editable: { bind: "select", validate: true },
            content: {
                width: { field: "100%" }, height: 370,
        ...
        //=====================================================================================
        var args = {
            targetid: "grdData_첨부", query: "w_eccb3010_S_3", title: "첨부 문서",
            caption: true, height: "100%", pager: false, show: true, number: true, selectable: true,
            ...
            element: [
				...
				{ header: "파일설명", name: "file_desc", width: 300, align: "left", editable: { type: "text" } },
...
function processInsert(param) {
    ...
    if (param.sub) {
        ...
        var args = {
            targetid: "frmData_메모A", edit: true, updatable: true,
            data: [
        ...
        gw_com_module.formInsert(args);
        var args = {
            targetid: "frmData_메모B", edit: true, updatable: true,
            data: [
                { name: "root_no", value: param.data.cip_no },
                { name: "root_seq", value: "2" },
        ...
        var args = {
            type: "PAGE", page: "w_find_cip", title: "검증Test 선택",
            width: 850, height: 450, locate: ["center", "top"], open: true
        };
        if (gw_com_module.dialoguePrepare(args) == false) {
            var args = { page: "w_find_cip",
                param: { ID: gw_com_api.v_Stream.msg_selectCIP,
                    data: { type: "complete" }
                }
            };
            gw_com_module.dialogueOpen(args);
...
function processMemo(param) {
    ...
    if (param.html) {
        ...
        //};
        //if (gw_com_module.dialoguePrepare(args) == false) {
        //    var args = { page: "w_edit_html_eccb",
...
function processApprove(param) {
    ...
    var title = encodeURIComponent(Query.getApprovalTitle({ type: "CIP-END", ref_key1: v_global.logic.key }));
    var url = "http://gw.terasemicon.com/_ERPR/Public/ERPRLogin.aspx?UserId=" + gw_com_module.v_Session.USR_ID
        + "&Pwd=&Lang=ko&EAID=106&gw_num=110&htmltag=&cip_no=%27" + v_global.logic.key + "%27&NextUrl=/_EAPP/EADocumentWrite.aspx?FormID=106&ErpDocTitle=" + title;
...
function successApproval(response, param) {
    ...
    var FormId = 211;
    if (DeptArea == "DP") FormId = 236;
    else if (DeptArea == "SOLAR") FormId = 238;
    else FormId = 211;
        ...
        case gw_com_api.v_Stream.msg_authedSystem:
            {
                ...
                var args = { url: "COM", procedure: "PROC_APPROVAL_CIP_END",
                    input: [
