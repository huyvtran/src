...
var gw_job_process = {
    ...
    UI: function () {
        ...
        //==== Menu : Main ====
        var args = { targetid: "lyrMenu", type: "FREE", element: [ { name: "닫기", value: "닫기" } ] };
        ...
        var args = {
            tabid: "lyrFrame",
            target: [
				{ type: "PAGE", id: "w_mrp1410", title: "생산 작업 List", launch: true },
				{ type: "PAGE", id: "w_mrp1420", title: "작업 표준서 등록" },
				{ type: "PAGE", id: "w_mrp1430", title: "Check Item 정의" },
				{ type: "PAGE", id: "w_mrp1440", title: "장비이력관리 Item 정의" }
			]
        };
