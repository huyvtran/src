...
var gw_job_process = {
    ...
    UI: function () {
        ...
        //=====================================================================================
        var args = { targetid: "grdData_현황", query: "ECCB_5010_M_1", title: "등록 추이",
        ...
        function rowdblclick_grdData_현황(ui) {
            var args = {
                ...
                data: {
                    ...
                    param: [
                        { name: "ymd_fr", value: gw_com_api.getValue("grdData_현황", "selected", "year", true) + "0101" },
                        { name: "ymd_to", value: gw_com_api.getValue("grdData_현황", "selected", "year", true) + "1231" },
                        { name: "dept_area", value: gw_com_api.getValue("grdData_현황", "selected", "dept_area", true) },
                        { name: "act_region", value: gw_com_api.getValue("grdData_현황", "selected", "rcode", true) }
                    ]
                }
            };
