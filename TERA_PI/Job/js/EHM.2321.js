...
var gw_job_process = {
    ...
    ready: function () {
        ...
        // 담당부서 숨김 여부 설정
        v_global.logic.HideDept = (gw_com_module.v_Session.USER_TP == "SYS") ? false : true;
        v_global.logic.UserDept = gw_com_module.v_Session.DEPT_CD;
    ...
    UI: function () {
        ...
        //==== Main Grid : 발생 내역
        var args = { targetid: "grdData_현황", query: "EHM_2321_M_1", title: "발생 정보",
...
function processEdit( param ) {
    ...
    if ( param.element == "추가" && TarNo != "" ) {
        gw_com_api.messageBox([ { text: "고분보가 이미 발행된 상태입니다. 수정모드로 들어갑니다." } ], 300);
    }
    
    var args = { ID: gw_com_api.v_Stream.msg_linkPage,
        to: { type: "MAIN" },
        data: { page: "EHM_2322", title: "고분보 등록", 
                param: [
...
//    }
    ...
    var args = { ID: gw_com_api.v_Stream.msg_linkPage,
        to: { type: "MAIN" },
        data: { page: "EHM_2322", title: "고분보 보기",
            param: [
            	{ name: "AUTH", value: "R" },
