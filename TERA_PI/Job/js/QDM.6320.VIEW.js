...
var gw_job_process = {
                ...
                row: [
                    ...
                    },
                    {
                        element: [
                            ...
                            { name: "chk_rmk", style: { colspan: 5 }, format: { type: "text", width: 1000 } },
    ...
    procedure: function () {
        ...
        if (v_global.logic.key > "" && v_global.logic.issue_no == "") {
            v_global.logic.issue_no = Query.getIssueNo({ rqst_no: v_global.logic.key });
        }
...
//----------
var Query = {
    getIssueNo: function (param) {
        var rtn = "";
        var args = {
            request: "PAGE",
            url: "../Service/svc_Data_Retrieve_JSONs.aspx" +
                    "?QRY_ID=QDM_6310_ISSUE" +
                    "&QRY_COLS=val" +
                    "&CRUD=R" +
                    "&arg_rqst_no=" + param.rqst_no,
