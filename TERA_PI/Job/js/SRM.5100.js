    ...
    ready: function () {
        ...
        function start() {
            ...
            if (v_global.process.param != "" && gw_com_api.getPageParameter("pr_no") != "") {
                //gw_com_api.setValue("frmOption", 1, "ymd_fr", gw_com_api.getPageParameter("req_date"));
                //gw_com_api.setValue("frmOption", 1, "ymd_to", gw_com_api.getPageParameter("req_date"));
    ...
    UI: function () {
                ...
                row: [
                    ...
                    },
                    {
                        element: [
                            ...
                            {
                                name: "qc_tp", label: { title: "검수구분 :" },
                                editable: { type: "select", data: { memory: "검수유형", unshift: [{ title: "전체", value: "%" }] } }
                            }
                        ]
                    },
                    {
        ...
        var args = {
            ...
            element: [
                ...
                { header: "요청자", name: "pr_emp_nm", width: 50, align: "center" },
                { header: "요청부서", name: "pr_dept_nm", width: 100 },
                { header: "발주담당자", name: "pur_emp_nm", width: 50, align: "center" },
				{ header: "거래처", name: "supp_nm", width: 150 },
                //{ header: "상위UNIT품번", name: "pitem_cd", width: 100 },
                { header: "상위UNIT품명", name: "pitem_nm", width: 130 },
				...
				{ header: "입고예정일시", name: "dlv_dt", width: 110, align: "center" },
