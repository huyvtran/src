...
var gw_job_process = {
    ...
    UI: function () {
        ...
        var args = {
            ...
            width: 300, height: 200, show: true, selectable: true, dynamic: true,
            element: [
        ...
        var args = {
            ...
            width: 300, height: 374, show: true, selectable: true, dynamic: true,
            element: [
    ...
    procedure: function () {
        ...
        //----------
        var args = { targetid: "lyrMenu", element: "obj", event: "click", handler: processPopup };
        gw_com_module.eventBind(args);
        //----------
        var args = { targetid: "lyrMenu", element: "arg", event: "click", handler: processPopup };
        gw_com_module.eventBind(args);
        //----------
        var args = { targetid: "lyrMenu", element: "col", event: "click", handler: processPopup };
        gw_com_module.eventBind(args);
        //----------
