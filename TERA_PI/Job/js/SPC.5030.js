...
var gw_job_process = {
    ...
    UI: function () {
                ...
                row: [
                        {
                            element: [
                              ...
                              },
                              {
                                  ...
                                  editable: { type: "select", data: { memory: "VIEW", unshift: [{ title: "전체", value: "" }] } }, hidden: true
                              }
                            ]
                        },
                        {
        ...
        //==== Grid : Main ====
        var args = {
            targetid: "grdData_Main", query: "SPC_5030_M_1", title: "NCR 관리대장",
            ...
            element: [
				...
				{ header: "불량내용", name: "qc_rmk", width: 180 },
				{ header: "작성자", name: "emp_nm", width: 80, align: "center", hidden: true },
				{ header: "처리결과", name: "qc_chk", width: 60, align: "center", hidden: true },
				{ header: "첨부 파일", name: "file_nm", width: 200, align: "left", editable: { type: "text", readonly: true }, hidden: true },
    ...
    procedure: function () {
        ...
        function click_lyrMenu_1_첨부등록(ui) {
            ...
            if (gw_com_api.getValue("grdData_Main", "selected", "ncr_no", true) == "") {
                gw_com_api.messageBox([{ text: "시정조치요구서가 발행되지 않았습니다." }]);
                return;
            }
