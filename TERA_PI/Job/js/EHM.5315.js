...
var gw_job_process = {
    ...
    UI: function () {
        ...
        //--------------------------------------------------
        //gw_com_module.formCreate 조회 조건
        var args = { targetid: "frmOption", type: "FREE", title: "조회 조건", 
            editable: { focus: "ymd_fr", validate: true },
            remark: "lyrRemark", trans: true, show: true, border: true,
            content: {
                row: [
                    {
                        element: [
                    ...
                    },
                    {
                        element: [
                            ...
                            {
                                name: "cust_prod_nm", label: { title: "호기 :" },
        ...
        var args = { targetid: "grdData_분류1", query: "EHM_5315_M_1", title: "부품별 발생 건수",
        ...
        var args = { targetid: "grdData_분류2", query: "EHM_5315_S_1", title: "Rev.별 교체수량",
        ...
        var args = { targetid: "grdData_분류3", query: "EHM_5315_S_2", title: "현상별 교체수량",
            caption: true, width: 180, height: 170, pager: false, show: true,
            element: [
        ...
        var args = { targetid: "lyrChart_분류1", query: "EHM_5315_M_1", show: true,
        ...
        var args = { targetid: "lyrChart_분류2", query: "EHM_5315_S_1", show: true,
        ...
        var args = { targetid: "lyrChart_분류3", query: "EHM_5315_S_2", show: true,
            format: { view: "1", rotate: "0", reverse: "1" },
            ...
            var args = {
                ...
                data: { page: "QDM_2030", title: "발생 내역",
                    param: [
                        ...
                        { name: "reason_yn", value: gw_com_api.getValue("grdData_분류3", "selected", "chart", true) },
                        { name: "issue_tp", value: gw_com_api.getValue("grdData_분류3", "selected", "issue_tp", true) },
...
function processChart(param) {
    ...
    if (gw_com_api.getRowCount("grdData_분류3") > 0) {
        var args = {
            source: {
                type: "GRID", id: "grdData_분류3", row: "selected",
                element: [
                	{ name: "issue_type", argument: "arg_issue_type" },
                    { name: "chart", argument: "arg_chart" },
                    { name: "ymd_fr", argument: "arg_ymd_fr" },
