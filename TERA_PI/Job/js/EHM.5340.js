...
var gw_job_process = {
    ...
    UI: function () {
        ...
        var args = {
            ...
            caption: true, width: 325, height: 299, pager: false, show: true,
            element: [
				{ header: "부품", name: "category", width: 160, align: "center" },
				{ header: "평균수명", name: "value", width: 60, align: "center" },
				{ header: "교체수량", name: "rate", width: 60, align: "center", mask: "numeric-int" },
        ...
        var args = {
            ...
            caption: true, width: 325, height: 299, pager: false, show: true,
            element: [
				{ header: "Line", name: "category", width: 160, align: "center" },
				{ header: "평균수명", name: "value", width: 60, align: "center" },
				{ header: "교체수량", name: "rate", width: 60, align: "center", mask: "numeric-int" },
				{ name: "rcode", hidden: true },
				{ name: "ymd_fr", hidden: true },
        ...
        var args = {
            ...
            caption: true, width: 325, height: 299, pager: false, show: true,
            element: [
				{ header: "호기", name: "category", width: 160, align: "center" },
				{ header: "평균수명", name: "value", width: 60, align: "center" },
				{ header: "교체수량", name: "rate", width: 60, align: "center", mask: "numeric-int" },
				{ name: "rcode", hidden: true },
				{ name: "ymd_fr", hidden: true },
        ...
        var args = {
            ...
            caption: true, width: 325, height: 299, pager: false, show: true,
            element: [
				{ header: "현상", name: "category", width: 160, align: "center" },
				{ header: "평균수명", name: "value", width: 60, align: "center" },
				{ header: "교체수량", name: "rate", width: 60, align: "center", mask: "numeric-int" },
				{ name: "rcode", hidden: true },
				{ name: "ymd_fr", hidden: true },
    ...
    procedure: function () {
        ...
        //----------
        var args = { targetid: "lyrMenu", element: "조회", event: "click",
            handler: click_lyrMenu_조회
        };
        gw_com_module.eventBind(args);
        //----------
        var args = { targetid: "lyrMenu", element: "닫기", event: "click",
            handler: click_lyrMenu_닫기
        };
        gw_com_module.eventBind(args);
        //----------
        var args = { targetid: "frmOption", element: "실행", event: "click",
            handler: click_frmOption_실행
        };
        gw_com_module.eventBind(args);
        //----------
        var args = { targetid: "frmOption", element: "취소", event: "click",
            handler: click_frmOption_취소
        };
        gw_com_module.eventBind(args);
        //----------
        var args = { targetid: "grdData_분류1", grid: true, event: "rowselected",
            handler: rowselected_grdData_분류1
        };
        gw_com_module.eventBind(args);
        //----------
        var args = { targetid: "grdData_분류2", grid: true, event: "rowselected",
            handler: rowselected_grdData_분류2
        };
        gw_com_module.eventBind(args);
        //----------
        var args = { targetid: "grdData_분류3", grid: true, event: "rowselected",
            handler: rowselected_grdData_분류3
        };
        gw_com_module.eventBind(args);
        //----------
        var args = { targetid: "grdData_분류1", grid: true, event: "rowdblclick",
            handler: rowdblclick_grdData_분류1
        };
        gw_com_module.eventBind(args);
        //----------
        var args = { targetid: "grdData_분류1", grid: true, event: "rowkeyenter",
            handler: rowdblclick_grdData_분류1
        };
        gw_com_module.eventBind(args);
        //----------
        var args = { targetid: "grdData_분류2", grid: true, event: "rowdblclick",
            handler: rowdblclick_grdData_분류2
        };
        gw_com_module.eventBind(args);
        //----------
        var args = { targetid: "grdData_분류2", grid: true, event: "rowkeyenter",
            handler: rowdblclick_grdData_분류2
        };
        gw_com_module.eventBind(args);
        //----------
        var args = { targetid: "grdData_분류3", grid: true, event: "rowdblclick",
            handler: rowdblclick_grdData_분류3
        };
        gw_com_module.eventBind(args);
        //----------
        var args = { targetid: "grdData_분류3", grid: true, event: "rowkeyenter",
            handler: rowdblclick_grdData_분류3
        };
        gw_com_module.eventBind(args);
        //----------
        var args = { targetid: "grdData_분류4", grid: true, event: "rowdblclick",
            handler: rowdblclick_grdData_분류4
        };
        gw_com_module.eventBind(args);
        //----------
        var args = { targetid: "grdData_분류4", grid: true, event: "rowkeyenter",
            handler: rowdblclick_grdData_분류4
        };
        gw_com_module.eventBind(args);
        ...
        function rowdblclick_grdData_분류1(ui) {
            var args = {
                ...
                to: { type: "MAIN" },
                data: { page: "ECCB_2030", title: "발생 내역",
                    param: [
...
function processLink(param) {
    ...
    if (param.detail) {
        ...
        var args = {
            source: { type: "GRID", id: "grdData_분류2", row: "selected", block: true,
                element: [
                    { name: "chart", argument: "arg_chart" },
