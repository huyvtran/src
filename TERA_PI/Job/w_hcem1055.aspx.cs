...
public partial class Job_w_hcem1055 : System.Web.UI.Page
{
                        ...
                        if (iKey == 0)
                        {
                            try
                            {
                                objUpdate.objDr = (new cDBQuery(
                                                        ...
                                                        " WHERE model_cd = '" + DATA.getValue(iAry, iRow, "model_cd") + "'" +
                                                        " AND model_class_key = '" + DATA.getValue(iAry, iRow, "model_class_key") + "'"
