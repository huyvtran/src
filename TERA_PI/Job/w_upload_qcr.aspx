<%@ Page Language="C#" MasterPageFile="~/Master/Page_7.master" AutoEventWireup="true"
    CodeFile="w_upload_qcr.aspx.cs" Inherits="Job_w_upload_qcr" Title="" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="objContentHead" runat="Server">
    ...
    <script src="js/w.upload.qcr.js" type="text/javascript"></script>
...
<asp:Content ID="Content6" ContentPlaceHolderID="objContentData" runat="Server">
    ...
    <div id="lyrServer" class="form_3">
        <dx:ASPxUploadControl ID="ctlUpload" runat="server" ClientInstanceName="ctlUpload"
            ...
            ShowProgressPanel="True" FileInputCount="5">
    ...
    <div style="margin-top: 10px; margin-left: 10px;">
        * 파일 크기는 15M Byte를 넘을 수 없습니다.<br />
        &nbsp;&nbsp;(15M Byte를 넘을 경우 장시간 로딩 후 에러가 발생할 수 있으니 꼭 확인하시기 바랍니다.)
    </div>
</asp:Content>
