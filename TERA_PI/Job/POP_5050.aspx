<%@ Page Title="" Language="C#" MasterPageFile="~/Master/Control_8.master" AutoEventWireup="true"
    CodeFile="POP_5050.aspx.cs" Inherits="JOB_POP_5050" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="objContentHead" runat="Server">
    ...
    <script src="js/POP.5050.js" type="text/javascript"></script>
...
<asp:Content ID="Content6" ContentPlaceHolderID="objContentControl_1" runat="Server">
    <div id="lyrChart_통계">
        <dxchartsui:WebChartControl ID="ctlChart_1" runat="server" Height="349px" Width="880px"
...
<asp:Content ID="Content9" ContentPlaceHolderID="objContentControl_2" runat="Server">
    <div id="lyrChart_상세통계">
        <dxchartsui:WebChartControl ID="ctlChart_2" runat="server" Height="349px" Width="880px"
