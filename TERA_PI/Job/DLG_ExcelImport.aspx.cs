    ...
    protected void ctlUpload_FileUploadComplete(object sender, DevExpress.Web.FileUploadCompleteEventArgs e)
    {
        ...
        try
        {
            ...
            try
            {
                ...
                if (bHeader)
                    strProvider = String.Format(@"Provider=Microsoft.ACE.OLEDB.12.0;Data Source={0};Extended Properties=""Excel 8.0;HDR=YES;IMEX=1;""", strSave);
                        //"Provider=Microsoft.Jet.OLEDB.4.0; Data Source=" + strSave + "; Extended Properties=\"Excel 8.0;IMEX=1;HDR=No;\"";
                else
                    strProvider = String.Format(@"Provider=Microsoft.ACE.OLEDB.12.0;Data Source={0};Extended Properties=""Excel 8.0;IMEX=1;""", strSave);
