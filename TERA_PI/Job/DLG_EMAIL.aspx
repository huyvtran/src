<%@ Page Language="C#" MasterPageFile="~/Master/Page_99.master" AutoEventWireup="true" CodeFile="DLG_EMAIL.aspx.cs" Inherits="Job_DLG_EMAIL" Title="" ValidateRequest="false" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="objContentHead" runat="Server">
    ...
    <script src="js/DLG.EMAIL.js" type="text/javascript"></script>
    <script type="text/javascript">
        ...
        $(function () {
            ...
            $(window).resize(function () {
                ctlHTML.SetHeight(window.innerHeight - 150);
            });
        });
    ...
    <form id="frmServer" runat="server">
        <div id="lyrControl">
            <dx:ASPxHtmlEditor ID="ASPxctlHTML" runat="server" Width="100%" ClientInstanceName="ctlHTML"
                ClientVisible="False" Height="450px" EnableTheming="True" Theme="Default" OnHtmlCorrecting="ASPxHtmlEditor1_HtmlCorrecting">
	...
	processInit({});
                ...
                <SettingsDialogs>
                    <InsertImageDialog ShowMoreOptionsButton="False">
                        <SettingsImageUpload UploadFolder="~/Files/EMAIL/images/" UploadImageFolder="~/Files/EMAIL/images/">
                        </SettingsImageUpload>
