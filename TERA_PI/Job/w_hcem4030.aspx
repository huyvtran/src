<%@ Page Title="" Language="C#" MasterPageFile="~/Master/Page_8.master" AutoEventWireup="true"
    CodeFile="w_hcem4030.aspx.cs" Inherits="Job_w_hcem4030" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="objContentHead" runat="Server">
    ...
    <script src="js/w.hcem4030.js" type="text/javascript"></script>
...
<asp:Content ID="Content4" ContentPlaceHolderID="objContentData_1" runat="Server">
    ...
    <div id="grdData_중분류" style="padding-top: 10px;">
    </div>
    <div id="grdData_소분류" style="padding-top: 10px;">
    </div>
</asp:Content>
<asp:Content ID="Content6" ContentPlaceHolderID="objContentData_2" runat="Server">
    <form id="frmServer" runat="server">
    <div id="lyrChart_대분류" align="center">
        <dxchartsui:WebChartControl ID="ctlChart_1" runat="server" Height="240px" Width="660px"
...
<Range SideMarginsEnabled="True"></Range>
    ...
    <div id="lyrChart_중분류" style="padding-top: 20px;">
        <dxchartsui:WebChartControl ID="ctlChart_2" runat="server" Height="240px" Width="670px"
...
<Range SideMarginsEnabled="True"></Range>
    ...
    <div id="lyrChart_소분류" style="padding-top: 20px;">
        <dxchartsui:WebChartControl ID="ctlChart_3" runat="server" Height="240px" Width="670px"
