...
public partial class Job_w_mrp3010 : System.Web.UI.Page
{
	...
	/*
            ...
            try
            {
                ...
                objUpdate.objCmd.Parameters.AddWithValue(
                    "@asOrdNo", HttpUtility.UrlDecode(DATA.getFirst().getFirst().getValue("ord_no")));
