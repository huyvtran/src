<%@ Page Title="" Language="C#" MasterPageFile="~/Master/Page_8.master" AutoEventWireup="true"
    CodeFile="w_hcem4010.aspx.cs" Inherits="Job_w_hcem4010" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="objContentHead" runat="Server">
    ...
    <script src="js/w.hcem4010.js" type="text/javascript"></script>
...
<asp:Content ID="Content6" ContentPlaceHolderID="objContentData_2" runat="Server">
    ...
    <div id="lyrChart_통계" align="center">
        <dxchartsui:WebChartControl ID="ctlChart_1" runat="server" Height="325px" Width="660px"
...
<Range SideMarginsEnabled="True"></Range>
    ...
    <div id="lyrChart_통계상세">
        <dxchartsui:WebChartControl ID="ctlChart_2" runat="server" Height="140px" Width="670px"
