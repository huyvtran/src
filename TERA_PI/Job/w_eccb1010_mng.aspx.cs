...
public partial class Job_w_eccb1010_mng : System.Web.UI.Page
{
    ...
    public static string Update(cSaveData DATA)
    {
        ...
        try
        {
            ...
            //---------------------------------------------------------------------------
            if (DATA.getFirst().getQuery() == "w_eccb1011_M_1"
                && DATA.getFirst().getFirst().getType() == typeQuery.INSERT)
            {
                ...
                try
                {
                    ...
                    objProcedure.objCmd.Parameters.AddWithValue("@KeyType", "ECR");
                ...
                for (int iAry = 0; iAry < DATA.getSize(); iAry++)
                {
                    ...
                    {
                        case "w_eccb1011_S_1":
                        case "w_eccb1011_S_2_1":
                        case "w_eccb1011_S_2_2":
                            DATA.getObject(iAry).setValues("root_no", strKey);
                            break;
                        default:
                            DATA.getObject(iAry).setValues("ecr_no", strKey);
                            break;
                    }
                }
            }
