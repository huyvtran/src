...
public partial class Job_w_qcm2020 : System.Web.UI.Page
{
    ...
    public static string Update(cSaveData DATA)
    {
        ...
        try
        {
            ...
            //---------------------------------------------------------------------------
            if (DATA.getFirst().getQuery() == "w_qcm2020_M_2"
                && DATA.getFirst().getFirst().getType() == typeQuery.INSERT)
            {
                ...
                try
                {
                    ...
                    objProcedure.objCmd.Parameters.AddWithValue("@KeyType", "POP");
        ...
        try
        {
            ...
            try
            {
                string strQuery = string.Format(@"
                    ...
                    FROM AS_ISSUE A
                    INNER JOIN V_PROD_MRP B ON B.prod_key = A.prod_key
                    WHERE A.issue_no = '{0}'
                    ",
                    arg_issue_no
                );
                ...
                strQuery = string.Format(@"
                    SELECT 
                          dbo.fn_getName('ZCODE','IPOP22',A.part_tp1) + ' : ' 
                          + dbo.fn_getName('ZCODE','IPOP32',A.part_tp2) AS part_tp
                        , dbo.fn_getName('ZCODE','IPOP23',A.reason_tp1) + ' : ' 
                          + dbo.fn_getName('ZCODE','IPOP33',A.reason_tp2) AS reason_tp
                    FROM AS_ISSUE_D A
                    WHERE A.issue_no = '{0}'
                    AND A.issue_seq = 1
                    ",
                ...
                if (objDr.Read())
                {
                    ...
                    objWorkSheet.Cells[12, 5] = objDr["part_tp"].ToString();
                    objWorkSheet.Cells[12, 12] = objDr["reason_tp"].ToString();
                ...
                objWorkSheet.Cells[13, 4] = strText;
                ...
                if (objDr.Read())
                {
                    ...
                    objWorkSheet.Cells[16, 3] = objDr["rmk_text"].ToString().Replace("\r\n", "\n");
