<%@ Page Title="" Language="C#" MasterPageFile="~/Master/Page_Chart_6H.master" AutoEventWireup="true"
    CodeFile="EOM_5170.aspx.cs" Inherits="JOB_EOM_5170" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="objContentHead" runat="Server">
    ...
    <script src="js/EOM.5170.js" type="text/javascript"></script>
...
<asp:Content ID="Content7" ContentPlaceHolderID="objContentControl_1" runat="Server">
    <div id="lyrChart_Main">
        <dxchartsui:WebChartControl ID="ctlChart_1" runat="server" Height="200px" Width="1125px"
...
<asp:Content ID="Content9" ContentPlaceHolderID="objContentControl_2" runat="Server">
    <div id="lyrChart_Sub">
        <dxchartsui:WebChartControl ID="ctlChart_2" runat="server" Height="200px" Width="1125px"
...
<asp:Content ID="Content11" ContentPlaceHolderID="objContentControl_3" runat="Server">
    <div id="lyrChart_3">
        <dxchartsui:WebChartControl ID="ctlChart_3" runat="server" Height="0px" Width="1100px"
...
<asp:Content ID="Content13" ContentPlaceHolderID="objContentControl_4" runat="Server">
    <div id="lyrChart_4">
        <dxchartsui:WebChartControl ID="ctlChart_4" runat="server" Height="0px" Width="1100px"
...
<asp:Content ID="Content15" ContentPlaceHolderID="objContentControl_5" runat="Server">
    <div id="lyrChart_5">
        <dxchartsui:WebChartControl ID="ctlChart_5" runat="server" Height="0px" Width="1160px"
...
<asp:Content ID="Content17" ContentPlaceHolderID="objContentControl_6" runat="Server">
    <div id="lyrChart_6">
        <dxchartsui:WebChartControl ID="ctlChart_6" runat="server" Height="0px" Width="1180px"
