<%@ Page Title="" Language="C#" MasterPageFile="~/Master/Page_14.master" AutoEventWireup="true"
    CodeFile="w_mrp3220.aspx.cs" Inherits="Job_w_mrp3220" %>

<asp:Content ID="Content1" ContentPlaceHolderID="objContentHead" runat="Server">
    <link id="style_theme" href="" rel="stylesheet" type="text/css" />
    <script src="js/w.mrp3220.js" type="text/javascript"></script>
...
<asp:Content ID="Content4" ContentPlaceHolderID="objContentData_2" runat="Server">
    <table border="0" cellpadding="0" cellspacing="0" style="margin: 0; padding: 0">
        ...
        <tr style="width: 100%" valign="top">
            <td style="width: 690px">
                <form id="grdData_D1" action="">
                </form>
            </td>
            <td style="width: 460px">
                <form id="grdData_D2" action="">
                </form>
            </td>
        </tr>
    </table>
    <div id="lyrMenu_Sub" align="center"></div>
