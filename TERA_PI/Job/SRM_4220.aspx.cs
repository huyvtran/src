...
public partial class JOB_SRM_4220 : System.Web.UI.Page
{
    ...
    public static string Update(cSaveData DATA)
    {
        ...
        try
        {
            ...
            //---------------------------------------------------------------------------
            if (DATA.getFirst().getQuery() == "SRM_4220_M_1" && DATA.getFirst().getFirst().getType() == typeQuery.INSERT)
            {
                ...
                try
                {
                    ...
                    objProcedure.objCmd.Parameters.AddWithValue("@KeyType", "SRM_CHK");
                ...
                DATA.setValues("chk_no", strKey);
                DATA.getFirst().setValue(0, "chk_date", DateTime.Now.ToString("yyyyMMdd"));
            }
            //---------------------------------------------------------------------------
                            ...
                            try
                            {
                                objUpdate.objDr = (new cDBQuery(
                                                        ...
                                                        "SELECT dbo.FN_CREATEKEY('" + strID + "','" +
                                                            DATA.getValue(iAry, iRow, "chk_no") + "')"
