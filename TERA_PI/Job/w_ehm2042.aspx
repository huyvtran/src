<%@ Page Title="" Language="C#" MasterPageFile="~/Master/Page_7.master" AutoEventWireup="true"
    CodeFile="w_ehm2042.aspx.cs" Inherits="Job_w_ehm2042" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="objContentHead" runat="Server">
    ...
    <script src="js/w.ehm2042.js" type="text/javascript"></script>
...
<asp:Content ID="Content4" ContentPlaceHolderID="objContentData" runat="Server">
    ...
    <div id="lyrChart_현황" align="center">
        <dxchartsui:WebChartControl ID="ctlChart_1" runat="server" Height="400px" Width="900px"
            ...
            <seriesserializable>
                <cc1:Series ArgumentDataMember="category" Name="Series 1" 
                    ValueDataMembersSerializable="value">
                    <viewserializable>
                        <cc1:LineSeriesView ColorEach="True">
                        </cc1:LineSeriesView>
                    </viewserializable>
                    <labelserializable>
            ...
            <legend alignmenthorizontal="Right" font="맑은 고딕, 9pt" visible="False"></legend>
            <fillstyle>
                <OptionsSerializable>
