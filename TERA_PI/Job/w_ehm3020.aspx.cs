...
public partial class Job_w_ehm3020 : System.Web.UI.Page
{
    ...
    public static string Update(cSaveData DATA)
    {
        ...
        try
        {
            ...
            //---------------------------------------------------------------------------
            if (DATA.getFirst().getQuery() == "w_ehm3020_M_1"
                && DATA.getFirst().getFirst().getType() == typeQuery.INSERT)
            {
                ...
                try
                {
                    ...
                    objProcedure.objCmd.Parameters.AddWithValue("@KeyType", "SU");
                ...
                DATA.setValues("setup_no", strKey);
            }
            //---------------------------------------------------------------------------
