    ...
    public static string Print(cRetrieveData DATA)
    {
        ...
        try
        {
            ...
            try
            {
                ...
                {
                    //objWorkSheet.PageSetup.TopMargin = 13;
                    //objWorkSheet.PageSetup.HeaderMargin = 0;
                    //objWorkSheet.PageSetup.LeftMargin = 4.6;
                    //objWorkSheet.PageSetup.RightMargin = 4.6;

                    int iRow = 1;
                    int iCell = 0;
                    int iCount = 0;
                    objWorkSheet2 = (Excel.Worksheet)objWorkBook.Sheets[2];     //Barcode Template Sheet
                    objWorkSheet.VPageBreaks.Add(objWorkSheet.get_Range("G1", "G1"));

                    while (objDr.Read())
                    {
                        iCount++;
                        iCell = (iCount % 2 == 0 ? 6 : 3);

                        objWorkSheet2.Cells[1, 3] = objDr["pur_no"].ToString();               //발주번호
                        objWorkSheet2.Cells[2, 3] = objDr["proj_nm"].ToString();              //프로젝트명
                        objWorkSheet2.Cells[3, 3] = objDr["item_cd"].ToString();              //품번
                        objWorkSheet2.Cells[4, 3] = objDr["item_nm"].ToString();              //품목명
                        objWorkSheet2.Cells[5, 3] = objDr["dlv_qty"].ToString();              //수량
                        objWorkSheet2.Cells[6, 3] = objDr["supp_nm"].ToString();              //업체명

                        objWorkSheet2.get_Range("A1", "C6").Copy(objWorkSheet.get_Range(objWorkSheet.Cells[iRow, iCell - 2], objWorkSheet.Cells[iRow + 6, iCell]));
                    ...
                    //                objWorkSheet2.Cells[1, iCell] = objDr["pur_no"].ToString();               //발주번호
                    //                objWorkSheet2.Cells[2, iCell] = objDr["proj_nm"].ToString();              //프로젝트명
                    //                objWorkSheet2.Cells[3, iCell] = objDr["item_cd"].ToString();              //품번
                    //                objWorkSheet2.Cells[4, iCell] = objDr["item_nm"].ToString();              //품목명
                    //                objWorkSheet2.Cells[5, iCell] = objDr["dlv_qty"].ToString();              //수량
                    //                objWorkSheet2.Cells[6, iCell] = objDr["supp_nm"].ToString();              //업체명
                    //            }
                    //        }
                    //    }
                    //    else
                    ...
                    //    if (iCount % 2 == 0)
                    //    {
                    //        objWorkSheet2.get_Range("A1", "A6").EntireRow.Copy(objWorkSheet.get_Range(objWorkSheet.Cells[iRow, 1], objWorkSheet.Cells[iRow + 6, 1]).EntireRow);
                    //        if (!bRead) break;
                    ...
                    //        objWorkSheet2.Cells[1, iCell + 3] = "";
                    //        objWorkSheet2.Cells[2, iCell + 3] = "";
                    //        objWorkSheet2.Cells[3, iCell + 3] = "";
                    //        objWorkSheet2.Cells[4, iCell + 3] = "";
                    //        objWorkSheet2.Cells[5, iCell + 3] = "";
                    //        objWorkSheet2.Cells[6, iCell + 3] = "";

                    //        objWorkSheet2.Cells[1, iCell + 6] = "";
                    //        objWorkSheet2.Cells[2, iCell + 6] = "";
                    //        objWorkSheet2.Cells[3, iCell + 6] = "";
                    //        objWorkSheet2.Cells[4, iCell + 6] = "";
                    //        objWorkSheet2.Cells[5, iCell + 6] = "";
                    //        objWorkSheet2.Cells[6, iCell + 6] = "";
