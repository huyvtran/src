<%@ Page Title="" Language="C#" MasterPageFile="~/Master/Page_7.master" AutoEventWireup="true"
    CodeFile="w_qcm5030_u.aspx.cs" Inherits="Job_w_qcm5030_u" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="objContentHead" runat="Server">
    ...
    <script src="js/w.qcm5030_u.js" type="text/javascript"></script>
...
<asp:Content ID="Content6" ContentPlaceHolderID="objContentData" runat="Server">
    ...
    <div id="lyrChart_발생통계" align="center">
        <dxchartsui:WebChartControl ID="ctlChart_1" runat="server" Height="600px" Width="1200px"
            ...
            <seriesserializable>
                <cc1:Series ArgumentDataMember="category" Name="Series 1" 
                    ...
                    <labelserializable>
                        <cc1:SideBySideBarSeriesLabel Font="굴림, 10pt" LineVisible="True">
                            <fillstyle>
                                <optionsserializable>
            ...
            <legend alignmenthorizontal="Right" font="굴림, 10pt" visible="False"></legend>
            <fillstyle>
                <OptionsSerializable>
