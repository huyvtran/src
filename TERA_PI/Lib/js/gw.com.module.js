...
var gw_com_module = {
            ...
            if (!this.data.empty) {
                ...
                if (this.data.unshift != undefined) {
                    $.each(this.data.unshift, function (j) {
                        if (this.title != undefined && this.value != undefined) {
                            if ($.browser.msie)
                                $(el)[0].add(new Option(this.title, this.value));
                            else
                                $(el)[0].add(new Option(this.title, this.value), null);
    ...
    chartCreate: function (args) {
        ...
        if ($("#navControl").length > 0 && (args.menu == undefined ? true : args.menu)) {
            var content =
                ...
                "<li class='chart'><a href='#8'>RadarArea</a></li>" +
    ...
    sendMail: function (args) {
        ...
        if (args.edit == true) {
            ...
            window.open("", "pop_email", "scrollbars=no,resizable=yes,menubar=no,toolbar=no,width=1000,height=590");
        ...
        if (args.cc != undefined) {
            $.each(args.cc, function () {
                request.DATA.CC.push(this.name + "<" + this.value + ">");
            });
        }
        var data = JSON.stringify(request);
